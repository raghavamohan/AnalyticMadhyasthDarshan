...
2. Follow [AGENTS.md](../../AGENTS.md) §4 (prose style) and §5 (Standpoint and scope).
   Reference implementations: `Studies/What-Is-Existence.md` (ontology, open problems);
   `Studies/Why-Humans-Are-Not-Just-Material.md` (comparative anthropology, critique closings).
