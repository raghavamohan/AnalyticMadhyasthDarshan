...
The important functional question is how the whole *jeevan* understands and fulfils the contents distributed across these loci. Faculty placement identifies a principal operation within the architecture. It need not assign exclusive ownership of a value or a social domain to that faculty. Appendix H preserves a further hypothesis: radial expansion may help interpret the increasing articulation of activity, and may have figured in how Nagraj apprehended or communicated the architecture. That possibility requires a different inquiry from the physical derivation of shell capacity.
...
The highest fulfilment is *paramanand*, realisation of coexistence and its continuity in *atma*. As the ultimate goal of human *jeevan*, it is expressed through the integrated activity of awakened living. Its continuity gives the account of value fulfilment a direction extending through humane participation and tradition (MVD, pp. 101, 327–328; MAD, reader p. 51).
...
```mermaid
flowchart LR
    A["Understanding<br/>and responsibility"] --> B["Contribution<br/>and consequences"]
    B --> C["Evaluation<br/>and correction"]
    C --> D["Social conditions<br/>and continuity"]
    C --> A
    D --> A
    D --> B
```
...
The revised parent model integrates the concentric architecture, intersecting value classifications, contextual justice, and a documentary account of maintained responsibilities. It represents five generic faculty pairs, distinguishes actual and recognised relation, and places subsequent evaluation after conduct and consequence. The present proposal elaborates its links to the defined contents of the 122 entries (parent study, §§7.3, 7.7–7.8, 8.3, 11; Appendices A.8–A.11 and C).

The parent assigns invariant constitution and faculty organisation to $\chi_j$ and persistent refinable dispositions to $z_{j,n}$ for every constitutionally complete *jeevan*, joined or unjoined. Its active human view $z^H_{\eta,n}$ is derived during human association. Occurrence annotations and assessment records refer to that state without becoming alternative writable versions of it; body separation ends the active interface while the *jeevan* and its dispositions persist (parent study, Appendix A.3).

The fixed inventory registry remains outside changing personal state. Each source position receives an identifier consisting of faculty, pair number, and column, together with its source name, definition, variants, and provenance. A second map links concepts and canonical value families to one or more positions. This permits *udarta* to have two value-family memberships without duplicating the underlying activity slot, and permits usefulness to be linked through definitions without inventing a missing headword. The richer registry here elaborates the catalogue and activity references in the parent's Appendix A.11.
...
These records make institutional failure more precise. A responsibility may be unassigned, assigned without means, performed ineffectively, mis-evaluated, or repeatedly left uncorrected. A change of organisation can be assessed by whether it preserves or improves the relevant contributions and correction, rather than by whether it reproduces the same institutional names. This elaborates the social account now integrated in the parent study's §§11.3–11.6 and Appendix A.11, with further questions of operation and scale retained in §12.7.
...
The concentric companion's §4.3 proves that stronger property for its defined optional annotation layer, since every parent trace admits empty annotations. A proposed condition that makes capability, responsibility, or maintenance constrain an occurrence belongs to a further extension and needs its own account of which traces remain admissible. Neither annotation result proves the substantive persistent-*jeevan* and constitutional-constructor revisions equivalent to an earlier parent specification.

## 9. Concrete revision agenda

The revised parent integrates the following connections while preserving its main architecture. The table records where this note's analysis now enters the shared account; the detailed records and research tests developed here remain available for further work.

| Location | Integrated connection | Reason |
|---|---|---|
| §§7.3, 12.1 | Explicit nucleus–orbit faculty correspondence, with particle-per-pair and quantum identification retained as questions | MVD p. 78 supports the faculty mapping |
| §§7.3–7.4 | Ordered source pairs and local pair meaning distinguished from the wider sixfold synthesis | A shared column does not establish a universal input–output mechanism |
| §7.8; Appendix A.11 | Value families and activity positions treated as intersecting classifications | Thirty places map through twenty-nine named mappings to twenty-eight distinct slots |
| §§7.7, 8.3; Appendix A.8 | Connected knowing–believing–recognising–fulfilling and contextual refinement without exclusive faculty assignment | Several definitions cross the proposed compartments |
| Appendices A.9, A.11 | Occurrence and evidence links to values, activity positions, contributions, means, and responsibilities | Makes the inventory useful in concrete episodes |
| Appendix C | Activity breadth, quality, continuity, and evidential sufficiency kept distinct | Neither counting entries nor self-report establishes complete functioning |
| §§8.5, 11.1–11.4, 12.5 | Actual provision, bodily suitability, and recipient evidence within the running example and interface inquiry | Supplies a bounded criterion while the physiological mechanism remains open |
| §§11.3–11.6, 12.7; Appendix A.11 | Responsibility records and person–episode–institution continuity with feedback from social conditions | Connects individual architecture to maintained social order |
...
## Appendix H. The radial hypothesis

### H.1 An organising image worth investigating

The additional synthesis proposes five connected explanations of the inventory: radial expansion, the relation of unity to diversity, functional placement, value symmetry, and the direction of awakening and expression. Its most promising suggestion is that a concentric architecture makes intelligible how one coherent understanding becomes articulated through many forms of participation. This appendix retains that suggestion as a research hypothesis, including the possibility that such an organisation figured in Nagraj's own apprehension or presentation of *jeevan*.

Three questions must remain distinguishable. What constitution does the darshan assert? What explanatory work can its concentric form perform? How did Nagraj arrive at or perceive that form? The nucleus–orbit assignments answer the first question explicitly. Their relation to the inventory and to interfaculty harmony supplies material for the second. An answer to the third requires testimony about the experience or reasoning concerned; structural agreement alone cannot establish the historical route (MVD, pp. 78, 327–348; AVD, pp. 91–94).

There is direct testimony relevant to the third question. Nagraj reports having seen *atma* as the nucleus, identifies the activities in the first and subsequent orbits, and separately reports having seen 122 conducts in *jeevan*. He explains the presentation of their faculty distribution as a means for learners to understand, attain realisation, and help others understand. In his account of the practice through which existence became evident to him, he expressly explains seeing as understanding (JV, printed pp. 12, 91–92, 165). These passages support attributing the constitutional and activity account to his reported apprehension, rather than treating that connection as our conjecture alone.

Calling the proposed reading an organising image does not reduce the darshan's constitutional claim to a metaphor. It identifies a possible role of that form in understanding and communication while leaving its ontological and physical assessment explicit. The first-person account does not establish optical observation or independently verify the asserted constitution. Nor does it tell us whether expanding surfaces, contact capacity, or a numerical derivation figured in that apprehension. The historical hypothesis should therefore concern this specific additional connection: Nagraj reports seeing the architecture and activities, but the surface-area rationale has not been located in the passages examined.

The hypothesis can therefore be stated positively: **radial differentiation may express the increasing particularity of how a common existential understanding is represented, assessed, and fulfilled in living.** The inward reading concerns integration and affirmation; the outward reading concerns articulation and expression. This offers an interpretation of the organisation without making a theory of radius the premise of every activity definition.

### H.2 What surface area would explain

The four orbital pair counts follow $P_n=2n^2$, with a separately specified central pair. A surface-area construction can reproduce the same numbers if additional assumptions are made. Suppose, purely for illustration, that the radius of orbit $n$ is $r_n=nr_0$, where $r_0>0$ and $n=1,\ldots,4$, and that each spherical surface carries a constant density $\rho$ of pair positions per unit area. Then:
...
Choosing $\rho=1/(2\pi r_0^2)$ gives $P_n=2n^2$. The quadratic dependence then comes from the assumed radius spacing and surface density; the coefficient two comes from the chosen normalisation. None of those assumptions is supplied by the inventory. The orbit number is not itself a measured radius, and no definition of a contact site or its density has been established. Circumference alone would scale linearly with radius. The central pair also remains a separate stipulation.

This conditional construction clarifies what the proposed analogy needs. Expanding surfaces can depict increasing differentiation, but they do not by themselves require exactly two, eight, eighteen, and thirty-two pairs. The conventional quantum-state enumeration in §1.2 is a different argument. Neither account currently identifies a named activity with an electron state, a unit of surface area, an independent degree of freedom, or an information-capacity measure.

There is nevertheless a useful qualitative reading: an outwardly elaborated architecture can express the variety of situations in which understanding becomes conduct. Its explanatory value would lie in the relationships it makes visible. A larger inventory count need not mean greater consciousness, greater worth, or a higher social position. Nor does one central pair mean that realisation has only one item of content. The central definition concerns nature saturated in *satta*, whose content includes the plurality and relationships of existence (MVD, p. 328).

### H.3 Reading the five dimensions together

The proposed dimensions become more useful when their supported structure and interpretive additions are kept connected.

| Dimension | What the synthesis usefully brings into view | Open question or interpretive limit |
|---|---|---|
| Radial differentiation | Explicit nucleus–orbit placement and increasing numbers of detailed pairs | No derivation from radius, area, particles, or contact capacity has been established |
| Unity and diversity | Integrated realisation can be related to differentiated representation, deliberation, and participation | This relation does not yet explain the exact counts or establish a fixed processing order |
| Functional placement | Principal operations help explain why a value or responsibility appears at a particular faculty | Exclusive jurisdictions conflict with the cross-faculty apprehension and fulfilment of values |
| Value symmetry | Nine relationship pairs divide three–three–three; four values concern adjacent-faculty harmony | A unique vertical pairing and a causal derivation of the equal sizes remain open |
| Direction of functioning | Study and affirmation can be read inwardly; realised understanding is expressed in conduct | A clocked cascade, dormant inventory mask, and measured inter-shell force are additional unsupported claims |

The unity–diversity reading has a direct functional anchor: affirmation of coexistential truth through study is described as acceptance in *mun*, qualitative deliberation in *vritti*, direct recognition in *chitta*, and enlightenment in *buddhi* (MVD, p. 126). Together with realisation and authenticity, this makes an integrated reading credible. It also shows why the faculties should be understood as different operations over connected content. The interpretation should not turn the plurality of existing units into an appearance dissolved by a non-dual centre.

Two numerical proposals need specific repair. The eight activities of visualisation—form, property, count, time, expanse, effort, motion, and result—are explicitly enumerated, but their correspondence with the eight detailed *chitta* pairs is not specified. Form and property occur among those pairs, whereas the inventory's named time position is in *vritti*. Equal counts therefore pose a mapping question; they do not answer it (MVD, pp. 327, 329–331, 338).

For *mun*, the final ten rows form an explicit sensory and work-organ block. One possible analytical grouping of the remaining rows gives ten role-bearing positions (5–7, 13–16, 20–22) and twelve other positions (1–4, 8–12, 17–19). Thus the proposed ten sensory, twelve role, ten disposition division does not match that row count. Even the corrected ten–ten–twelve grouping is our classification: its last group mixes values, orientations, acceptance, recognition, and happiness. The primary presentation explicitly separates the final ten from the preceding twenty-two; it does not thereby establish three equally defined functional families (MVD, pp. 339–348).

The functional interpretation also needs the account's full ontology. Space pervades the atom and its constituent particles; it is not in contact only with the nucleus (MVD, p. 78). *Atma* is a locus of *jeevan*, not another name for *satta*. Consequently, placing motherhood in *atma* would not make it a property of omnipresent space. The actual mother entry includes acceptance of bodily generation and complementarity towards awakening; its location in *mun* is intelligible through participation and responsibility (MVD, p. 347).

Likewise, *mun* can taste justice, *dharma*, truth, and all values. Its tasting of truth does not make truth whatever is pleasant (MSM, pp. 38, 43). Care and affection include awakening and just relationship, while love and guidance operate in concrete relationships (§2.2). The radial interpretation is therefore strongest as a differentiation of principal operations within integrated fulfilment. It loses support when the centre becomes exclusively cosmic, the middle exclusively social, and the outside exclusively bodily.

Directional language requires the same care. The four-and-a-half account concerns effective generic functioning under sensitivity, within an account that also states the continuous operation of all ten activities. It supplies neither a list of silent detailed positions nor a claim that only sensory rows operate in delusion (JV, pp. 72–74; §3.1). The proposed inward–outward reading can track the basis and expression of understanding without converting it into a sequence of switches.

### H.4 Implications for human organisation

The radial hypothesis suggests a useful question for the model: how does a general understanding remain coherent while its practical expression becomes increasingly particular? Care for another person, for example, becomes specific through an actual need, an assessed material, a quantity, a place and time, a contribution, and an observed consequence. Education, production, provision, and evaluation help carry that responsibility through. This is an analytical reading of the bridges already developed in §§4–6, not a derivation of institutions from geometry.

Social arrangements can maintain these connections across many people and repeated episodes. They preserve access to understanding, competence, means, evidence, and correction when fulfilment exceeds one person's immediate reach. The architecture then bears on society through the differentiated contributions of whole persons, while education, health, and material arrangements condition what those persons can subsequently undertake (MSM, pp. 64–65; MVD, pp. 55–56). The passage reporting 122 conducts itself connects understanding with helping others understand, health with helping others become healthy, and wealth with helping others become prosperous. This gives the social interpretation a direct primary anchor alongside its proposed formal reconstruction (JV, p. 165).

This suggests representing two connected movements in an episode dossier: specification from understood purpose to situated responsibility and contribution, and review from experienced consequences and counterpart evidence to corrected understanding and arrangements. These are directions of explanation and evaluation; the dossier must record the actual sequence rather than impose a faculty-by-faculty timetable. The occurrence, assessment, and responsibility records in §8 already provide places for the relevant evidence.

The institutional implication is a many-to-many correspondence between operations and contributions. A teacher, caregiver, worker, coordinator, or evaluator participates through the whole *jeevan*. No class of people becomes the social *atma*, and practical workers do not become another person's *mun*. A larger institution likewise does not possess a larger orbital radius. The hypothesis should help explain how understanding is sustained through differentiated participation, without converting a person's constitutional architecture into a hierarchy of persons.

### H.5 Questions to carry forward

The following questions preserve the proposal for further research and identify what would change its standing.

| Question | Present standing | Evidence or analysis that would advance it |
|---|---|---|
| Did Nagraj explicitly connect surface area or expanding contact with the activity counts? | Unresolved in the constitutional, inventory, and functional passages reviewed | A primary passage, manuscript diagram, or attributable recording making that connection; check original wording and context |
| How much of the radial account belongs to Nagraj's reported apprehension? | First-person testimony connects seeing with understanding, names the nucleus and orbits, and reports 122 conducts (JV, pp. 12, 91–92, 165) | Further testimony distinguishing the reported constitution from any subsequent area-based explanation; attribution and independent verification of the constitution remain separate questions |
| Does increasing particularity explain the distribution of named activities? | A plausible qualitative hypothesis with cross-faculty counterexamples to exclusive scopes | Definition-based comparison of all positions, including inner-faculty concrete content and outer-faculty universal content; assess explanatory fit without building the proposed grouping into the coding |
| Can the exact counts be derived? | Arithmetic correspondence established; derivation unresolved | Explicit counting objects, independent premises, and a rule recovering the complete distribution; deriving quantities must be distinguished from explaining why each named activity belongs there |
| Does the interpretation improve the social model? | A proposed aid to tracing purpose, contribution, and correction | Compare dossiers with and without the radial interpretation and identify distinctions it adds beyond the existing faculty, value, occurrence, and responsibility records |

For now, the counts and constitutional locations belong in the fixed source registry. The radial interpretation belongs in the model's explanatory discussion and hypothesis record. It can also be tested in a separately labelled model variant once its assumptions and consequences are explicit. Incorporating it into the parent model as an established constraint would require further support. In this form, the idea remains available for investigation while the model's claims continue to depend on the evidence appropriate to them.
...
- **AVD** — A. Nagraj, [*Adhyatmvad*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/AVD-Adhyatmvad.docx.pdf), working English translation by Sanjeev Chopra. The tabulated faculty, orbit, column, and activity assignments, pp. 91–94 (§§1–2, Appendix H and Editorial Notes).
- **MVD** — A. Nagraj, [*Madhyasth Darshan: Co-existentialism*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf), translated by Rakesh Gupta. Family and constitutional architecture, pp. 55–62, 78 (§§1, 5; Appendix H); profit and the six perspectives, pp. 58, 66–67, 310 (§3.1); believing and knowing, pp. 98–100 (§3); paramanand, the highest human goal, and continuity of realisation, pp. 101, 327–328 (§2.3); affirmation through study, p. 126 (Appendix H.3); the body–jeevan joint form, pp. 199–205 (§1.3); action and subsequent formation, p. 218 (§4); exchange and labour-value assessment, pp. 260, 268–269 (§5); receptivity, p. 284 (§4); justice, p. 311 (§§3, 6); interfaculty harmony and complete activity definitions, pp. 327–348 (§§1–6, 8–9; Appendix H). Page numbers are the printed pagination of this rendering.
- **MSM** — A. Nagraj, [*Manav Sanchetnavadi Manovigyan*](../../References/Madhyasth-Darshan/MSM-manav-sanchetnavaadi-manovigyan.pdf), Hindi, 2008 OCR edition. Value expression and purpose, p. 34; activity architecture and tasting values, pp. 37–43 (§§1–2; Appendix H.3); care, respect, affection, and regulation of the perspectives, pp. 48–51, 54 (§§2.2, 3.1); social functions and their dependencies, pp. 64–65 (§§4–5; Appendix H.4); nourishment, provision, and responsibility, pp. 101, 104–105 (§§4, 6); sensory definitions and hearing, pp. 107–109 (Editorial Notes); learning and expression, p. 117 (§§5–6); gratitude, glory, and trust, pp. 130, 135–136 (§2.2); the human-value sequence and love, p. 225; guidance and contemplation-led reverence, pp. 230–236; apprehension and complete representation of values, p. 243 (§2). Printed page plus twelve gives the one-based PDF position.
...
- **JV** — A. Nagraj, [*Jeevan Vidya: An Introduction*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf), translated by Rakesh Gupta. Seeing as understanding, p. 12; first-person nucleus–orbit account, pp. 91–92; reported 122 conducts and their educational and social purpose, p. 165 (Appendix H). Family and education, pp. 55–60; the ten activities and four-and-a-half effective account, pp. 72–74 (§3.1; Appendix H.3); relationships and social functions, pp. 108–110; the values of *jeevan* and dimensions of order, pp. 138–140 (§§2, 5). These are printed pages; in the cited body of this edition, the one-based PDF position is printed page plus one.
...
- Additional unpublished synthesis proposing five dimensions of the inventory's organisation—radial geometry, unity–diversity, functional scope, value symmetry, and direction—supplied on 11 September 2026, together with the suggestion that surface expansion may have figured in Nagraj's apprehension. Appendix H preserves and examines this hypothesis; the synthesis is not primary-text authority for Nagraj's reasoning.
