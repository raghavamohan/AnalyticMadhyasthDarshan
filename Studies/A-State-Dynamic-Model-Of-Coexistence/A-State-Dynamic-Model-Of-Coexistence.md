...
Form is the spatial configuration and boundary-framework of the active bearer. Shape, volume, and density or mass distinguish how it is presently formed and available for reflection. Reflection presents a real form to another unit; correct recognition relates that appearance to the reality whose form it is (MVD, pp. 42, 49–50; SB, pp. 249–250, 256–257; KD 3.9–3.10, pp. 94, 100–101).
...
```mermaid
flowchart TB
    MATERIAL["Material compositions"] --> CELLS["Pranic cells"]
    CELLS --> PLANT["Plant body"]
    CELLS --> ANBODY["Animal body"]
    CELLS --> HUMBODY["Human body"]
    ATOM["Developing atomic constitution"] -->|"constitutional completeness"| JEEVAN["Jeevan"]
    ANBODY --> ANIMAL["Animal being"]
    JEEVAN --> ANIMAL
    HUMBODY --> HUMAN["Human being: knowledge order"]
    JEEVAN --> HUMAN
```
...
```mermaid
flowchart TB
    WORLD["Actual relationships and natural conditions"] --> BODY["Human body: sensitivity and action"]
    BODY -->|"sensory presentation"| J["Jeevan: understanding, evaluation, and resolve"]
    J -->|"selection and expression"| BODY
    BODY --> CONSEQ["Bodily, relational, and natural consequences"]
    CONSEQ --> WORLD
    CONSEQ -->|"examined through later evaluation"| J
```
...
![The centre and four orbital faculties of one jeevan, with their integrated activities](jeevan-concentric-synthesis.svg)
...
Three orientations are visible through this architecture. In body-governed living, prevailing sensory hopes organise thought and imaging. In the realisation-oriented way of study, *anubhav-gami*, meaning accepted in *mun* opens to deliberation in *vritti*, direct recognition in *chitta*, enlightenment in *buddhi*, and realisation in *atma*. Study and practice thereby orient the faculties and bodily participation towards understanding coexistence (MVD, pp. 98–99, 126, 322; JV, printed p. 61; AVD, p. 161).

Realisation-based expression, *anubhav-moolak*, carries this understanding into living. Realisation of coexistence in *atma* grounds enlightenment and resolve in *buddhi*, contemplation and imaging in *chitta*, comparison and analysis in *vritti*, and tasting and selection in *mun*. Bodily conduct presents this orientation in relationships and work, where its consequences become available for renewed evaluation (MVD, pp. 99–100, 218, 276–277, 322–323).
...
Development has a direction of fulfilment. Nature saturated in the state-complete is continuously active and development-oriented; atomic development culminates in constitutional completeness and *jeevan*. Compatible bodies provide the medium for animal and human manifestation. Knowledge order brings the capacity to understand coexistence and evidence that understanding in living. The four orders, development, awakening, and awakened human tradition belong to *niyati-kram*, the developmental course of coexistence (MVD, pp. 8–9, 26–27; SB, pp. 60–62).

Human beings already belong to knowledge order while their understanding is developing. Constitution-, seed-, and species-conformance provide the characteristic orderliness of the preceding orders. Human imagination and freedom extend participation beyond species-conformant living: humans investigate, create means, organise relationships, and help others understand. This scope requires understanding adequate to the whole field of human participation (JV, printed pp. 46–47, 67–69, 160; SB, pp. 235–240).

When happiness is sought in bodily gratification, comfort, and accumulation alone, human activity lacks a settled understanding of sufficiency and purpose. Misunderstood purpose becomes actual damage through chosen conduct: over-consumption damages natural abundance, and exploitation generates social imbalance. Imagination and freedom therefore require the direction supplied by knowledge of their purpose. Their fulfilment lies in resolution, prosperity, fearlessness, and coexistence, through which material means serve bodily wellbeing and humane participation (JV, printed pp. 67–70; MVD, p. 189).

Conscious evaluation is necessary to this fulfilment. Humans must recognise relationships, fulfil their values, evaluate the results, and establish mutual satisfaction; their participation with the rest of nature must accord with law, regulation, and balance. Realisation provides coexistence as the comprehensive reference through which cognisance governs sensitivity. Awakening is therefore the necessary fulfilment of human existence: the search for restfulness finds its resolution in realisation, and development and awakening are the purpose of the whole universe (JV, printed p. 158; SB, pp. 234–237; MVD, pp. 104, 230).

*Satta* remains complete and pervasive throughout. Knowledge unfolds in the sentient unit that realises coexistence and consciously fulfils its participation. Awakening gives human freedom its fulfilled expression, and awakened tradition makes that understanding accessible through education, humane constitution, and sustained social practice (MVD, pp. 35–36; SB, pp. 239–240). The relation between this developmental direction and particular historical paths is examined in §12.
...
Self-governance, *svarajya*, is understanding expressed through responsible and independent living. Self-trust, respect for excellence, agreement between understanding and conduct, productive self-reliance, and social participation make this freedom effective in the five functions of human orderliness (JVD, PDF pp. 147–148). Family-based self-governance takes wise and benevolent participation as the basis of shared arrangements (JVD, PDF pp. 138–139).

Humane authority, *adhikar*, is the developed capacity to guide, refine, and nurture participation according to right understanding. Authority conferred in family, society, and orderliness has a defined scope and corresponding duties; its fulfilment calls for the competence appropriate to those duties (MVD, pp. 86–87, 190–191). Common human standing and the responsibility for everyone's inclusion remain the basis of this organisation (§11.3). Education develops the understanding and capability through which each person can participate and contribute.
...
The tradition sustains four mutually supporting aspects of humane life: culture, *sanskriti*; civilisation, *sabhyata*; humane code, *vidhi*; and orderliness, *vyavastha*. Culture carries work, behaviour, and shared expression toward completeness and undivided society. Civilisation makes that understanding evident in humane relationships and participation in universal orderliness. The humane code articulates the conduct to be fulfilled, while orderliness provides the arrangements through which people fulfil it together. Education enables each generation to understand and continue all four (MVD, pp. 107–108, 314–315; JVD, PDF pp. 168–170).
...
| Unit (*ikai*) | A bounded, countable, active reality that persists through change. Unit and activity are distinguishable in meaning and inseparable in existence; property (*guna*) always has an active bearer (*guni*). |
...
| *Sanskriti–sabhyata–vidhi–vyavastha* | Culture, civilisation, humane code, and orderliness: four mutually supporting aspects through which humane life is fulfilled and continued in tradition. |
| Self-governance (*svarajya*) | Responsible independence evidenced through resolved living, just conduct, productive self-reliance, and participation in the five functions. |
| Authority and rights (*adhikar*) | In the sense of humane authority, the developed capacity to guide and nurture right participation. Rights arising through relationships, conferral, and circumstances have their appropriate scope and corresponding duties. |
...
The developmental course in MVD pp. 8–9 includes the four orders, awakening, and awakened tradition. The language of goal and impulsion at p. 230, and the account of realisation and restfulness at p. 104, support the affirmative developmental account. At p. 104, the English renders “इसीलिए जागृति का अभाव नहीं है” as “Human awakening is inevitable,” connecting it with the unmet need for restfulness. §9.4 retains that necessity of fulfilment. Humans already belong to knowledge order; the present task is the awakening and social continuity of that order. Comprehensive human knowing and evaluation fulfil a sentient capacity without making actionless *satta* an incomplete subject. Animals already manifest sentience, and natural law, regulation, and balance are already present (MVD, pp. 26–27, 35–36; SB, pp. 235–236, 248–249).
...
### Self-governance, authority, and the continuity of humane life

Universal orderliness, *sarvabhaum vyavastha*, names the shared achievement. Self-governance, *svarajya*, and qualified authority, *adhikar*, describe how persons and institutions participate in it. The account of authority includes qualification to guide and nurture, together with rights and duties arising through relationships, conferral, and circumstances (MVD, pp. 86–87, 190–191). The contrast between family-based self-governance and power-centred rule belongs to the social proposal in JVD pp. 138–139; it is not a definition of every use of the word *shasan*.

The four complementary aspects enumerated at MVD pp. 107–108 are culture, civilisation, humane code, and orderliness. Culture includes work and behaviour toward completeness, and civilisation concerns humane behaviour through which universal orderliness is evidenced (MVD, pp. 314–315). These aspects work together across thought, behaviour, and work. Humane constitution articulates values, character, and ethics, together with ways of recognising humane conduct; it does not replace *vidhi* in this particular fourfold enumeration (JV, printed p. 126; JVD, PDF pp. 168–170).
...
- **MVD** — Nagraj, A. [*Madhyasth Darshan — Co-existentialism*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta; citations use PDF pages. Cited: coexistence, saturation, energy, active units, four aspects, and natural orderliness (pp. 11, 25–26, 32–51, 114–115, 124, 154–155, 174–175; §§1–5, 7.1, 9, 12.8); development, constitutional completeness, and hope-bondage (pp. 8–9, 13, 77–78, 91, 230; §§4, 6, 9.4, Appendix A); human commonality, purpose, relationship, and right-use (pp. 27–28, 55–62, 105, 183, 253, 260, 264, 268–269; §§3.3, 5, 7.8–7.9, 11); complete knowledge, study, faculty governance, and refinement (pp. 13, 58, 66–68, 78–83, 90, 94, 97–104, 125–126, 137, 155–156, 160, 203, 208, 218, 260, 276–277, 287–289, 300; §§7–10, Appendices A–C); evaluation errors and freedom from attraction (pp. 152–153, 306; §7.6); misuse and imbalance (p. 189; §9.4); authority, rights, and duties (pp. 86–87, 190–191; §11.5 and Editorial Notes); values, character, ethics, and justice (pp. 305–306, 311, 331–340; §§7.8–7.9, 8.3, 11.1); constitution and faculty activity inventory (pp. 78, 322–348; §§6.1, 7.3, 7.6–7.8, 10, 12.1, Appendix B); highest fulfilment and continuous realisation (pp. 101, 327–328; §§10–11, Conclusion); imagination, humane constitution, purpose, and awakened tradition (pp. 18–19, 94, 107–108, 161, 314–315, 319–321, 338–339; §§7.6, 9.4, 10.3, 11.3–11.6 and Editorial Notes). The Editorial Notes discuss the connected interpretation of these passages.
- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (*Resolution Centred Materialism*)](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta; citations use PDF pages. Cited: coexistence, saturation, pressure, continuous activity, and the effort–motion–result/four-aspect relation (pp. 48–62, 69, 99, 248–257; §§1–5, 9.1, Appendix A); active bearer and property (pp. 256–257; §§1.2, 3.1, Editorial Notes); atomic development, constitutional completeness, and composition (pp. 55, 58, 61, 75–76, 92, 144–145, 260; §§4, 6, 12.1); recognition, complementarity, and order-specific conduct (pp. 143–144, 179–180, 249–251; §§1, 3, 5–6, 9, 12.4); cognisance and sensitivity (pp. 63–64; §§6.4, 7.2); evaluation and delusion (pp. 91–92, 146; §7.6, Editorial Notes); human goals and natural orderliness (pp. 223, 231, 235–247; §§3.5, 7.4, 9, 11); imagination, inquiry, education, constitution, and tradition (pp. 19–20, 234–240, 283–284; §§7.6, 9.4, 10.3, 11.6); useful provision and participation (pp. 200–201, 237; §7.9).
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf). English translation by Rakesh Gupta. Citations use printed pages, one below the one-based PDF position. Cited: common human potential despite bodily differences (p. 33; §11.3); mutuality and saturation (pp. 43, 69–70, 149, 157–158; §§1, 5, 9, Editorial Notes); animal sensitivity, the four orders, bodily lineage, and human aspiration (pp. 38–39, 46–49, 59, 67–74, 160–161; §§3–7, 9.4, 12.4); humane conduct and human goals (pp. 54–61; §§7.8, 10–11); realisation following direct recognition and definitive understanding (p. 61; §§7.3, 7.5); the ten activities and four-and-a-half effective activities (pp. 72–74, 92–94; §§7.3, 7.6, 8.4, 10.2); dissatisfaction and fulfilment (pp. 73–74, 77; §§5.2, 8.4); justice and evaluation (pp. 97–98, 108–109, 137–139, 158; §§7.4, 7.8, 8.3, 9.4, 11.1–11.2); five functions, humane constitution, and orderliness (pp. 109–110, 121–126, 140; §§3.4, 11.3–11.6); usefulness, work, provision, and exchange (pp. 58, 122–123, 136–138; §§5.2, 7.9, 11.2–11.4); understanding and enabling others to understand (p. 165; §7.7).
- **AVD** — Nagraj, A. [*Adhyatmvad* (*Realisation Centred Spiritualism*)](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/AVD-Adhyatmvad.docx.pdf). English translation by Sanjeev Chopra, work in progress; citations use PDF pages. Cited: the 122 activity positions, state–motion columns, and faculty/value locations (pp. 91–94; §§7.3, 7.6, 7.8, Appendix B); conduct completeness and human tradition (p. 114; §§10.3, 11.6); realisation-oriented study and realisation-based expression (p. 161; §7.3); right-use and purposeful-use (p. 170; §7.9); continuous realised fulfilment (p. 262; §§10.1, 11.6).
...
- **JVD** — Nagraj, A. [*Janvad* (*Behaviour Centred Public Discourse*)](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JVD-Janvad.pdf). English translation by Sanjeev Chopra, work in progress; citations use PDF pages. Cited: family-based self-governance, responsible independence, and five-function participation (pp. 138–139, 147–148; §11.5); humane tradition, culture, civilisation, and constitution (pp. 168–170; §11.6 and Editorial Notes); family council, dialogue, agreement, representation, and tenure (pp. 237–238, 249–250, 255–256; §11.5); successive council tiers (pp. 281, 292, 298, 305, 315, 321, 327–328; §11.5); provision for representation from lower councils when principal state councils are unavailable (p. 328; §11.5). Operational questions are developed in §12.7.
...
- [*The Ontology of Coexistence*](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) — saturation, four orders, compositional versus atomic development, the three completeness distinctions, and *jeevan* (§§1.2, 1.5–1.8, 1.11); companion technical note [*Rūpa, Guṇa, Svabhāva, and Dharma in a State-Dynamic Unit*](../The-Ontology-of-Coexistence/Technical-Note-Roop-Guna-Svabhava-Dharma.pdf)
