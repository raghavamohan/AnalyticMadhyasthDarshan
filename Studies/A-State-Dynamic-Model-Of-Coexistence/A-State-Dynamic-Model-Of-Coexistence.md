...
Human living is evaluated through five value families (MVD, p. 305; JV, pp. 43, 137–139). The families answer different evaluative questions; they are not interchangeable magnitudes.
...
```mermaid
flowchart TB
    subgraph GROUND["Standing ontological ground"]
      SAT["Saturation<br/>energy-fullness · forcefulness<br/>natural responsiveness"]
      NK["Niyati-kram<br/>admissible order sequence"]
    end
    subgraph OCC["One complete occurrence"]
      REL["Actual mutuality + order-conformance"] --> ACT["Effort · motion · result<br/>dharma–svabhav · svabhav–guna · roop"]
      REL --> REC["Operative recognition<br/>definite in M / P / A · failable in H"]
      REC -.->|"conditions the expressed response"| ACT
      ACT --> NEXT["Realised result in the next situation"]
      ACT -.->|"when complementary participation succeeds"| FUL["Offering / acceptance / fulfilment<br/>evidence of complementarity"]
      MED["Mediative activity"] -.->|"regulates sam–visam"| ACT
      FUL -.->|"fulfilment evidence"| NEXT
      NEXT --> REL
    end
    subgraph HUMAN["Human reflexive participation"]
      REAL["Realised coexistence in atma"] --> FAC["Buddhi → chitta → vritti → mun<br/>resolve · imaging · comparison · selection"]
      EVAL["Later evaluation and possible revision"] --> FAC
    end
    SAT -.-> OCC
    NK -.-> OCC
    FAC -->|"orients the human occurrence"| ACT
    NEXT -.->|"retained human consequence"| EVAL
```
...
The human goals form a linked sequence: resolved individual, prosperous family, fearless society, and universal coexistence (JV, pp. 60–61; SB, pp. 246–247):
...
The most natural modern glosses replace the process with something else. A unit is neither a static property bundle nor a reduction of the unit to its relations: it is a closed activity whose aspects become evident in mutuality. Completeness is not an unbounded quantitative increase; object-usefulness is constant in the first three orders (JV, p. 123), and “more” is the diagnosed pathology of deluded human living (JV, p. 41). Assembly is complementarity, opposed to conflict and survival-of-the-fittest (JV, p. 157); decomposition is the loss of structure when relations go unfulfilled, not the designer of order. Capacities are provisioned in coexistence and become manifest at the right compositional tier (JV, p. 59); a purely emergentist reading drops *satta* and turns energisation into an unexplained surplus. Value is the content of fulfilment at every tier (SB, p. 50), not an epiphenomenon of preference or fitness; the human innovation is a fallible second-order judgement on definite mutual value, located in *jeevan*. Those refusals locate the reconstruction against familiar scientific glosses; they are not additional process rules.
...
| Closed activity | The running term for a persisting ontic or containing unit — atom, molecule, compound, cell, or body — whose motion-path has closed and which bears its own conduct and four aspects. A body–*jeevan* joint form is a typed association, not a third ontic unit. |
...
| Structural closure, joint association, and maintained relational order | Respectively: formation of a containing unit; association of body and *jeevan*; and a human relational or work arrangement maintained through understanding, value-fulfilment, regulation, and evaluation. These are three types, not three degrees of one closure. |
...
Fuller definitions follow in §B.2; model symbols are confined to Appendices A–C, with a notation table in §B.3.
...
| Unfolding (*gyan udghatan*) | Human study, direct recognition, complete enlightenment, truth-realisation, and practised evidence of already-present *K*<sup>*</sup>; not a transfer of energy or a third development line. |
...
| Closed activity | The running term for a persisting ontic or containing unit — atom, molecule, compound, cell, or body — whose motion-path has closed and which thereafter bears its own conduct and four aspects; a substitute for substance-suggesting words such as *bearer*, not a further entity. |
...
## Appendix D. Notion-level recovery audit

The essay and Appendix A already distinguish six claim-kinds and four registers. This appendix does not add process rules. It records, for each principal notion, which register it occupies, which claim-kind it carries, what it does in the model, and what the model does not prove by placing it there. Other studies may cite this table as an interpretive audit; they should not take the notation of Appendix A as a primary source.

| Notion | Register | Claim-kind | Role in the model | Does not prove |
|---|---|---|---|---|
| *Satta* (Omnipresence) | Standing ontological context | Direct textual claim | Actionless, state-complete ground of coexistence; not a unit, field, force, or event | Physical identification; that the symbol $\mathbb S$ exists independently of the texts |
| Saturation | Standing ontological context | Direct textual claim | Grounds energy-fullness, forcefulness, continuous activity, and order-relative natural responsiveness | A trigger, selected result, transmitted finite energy, or conscious knowledge |
| Closed activity (unit) | Bounded situation | Translation or register choice | Persisting ontic or containing whole whose state and motion are inseparable | A substance-and-attribute carrier underneath the activity |
| Occurrence | Complete occurrence | Analytical reconstruction | One complete effort–motion–result at a descriptive index $n$ | A natural pause, a clocked pipeline, or a rhythm in nature |
| Actual mutuality | Bounded situation and complete occurrence | Direct textual claim | Supplies the relation and conditions a unit faces | Correct operative recognition in a human; derivation of coupling from saturation alone |
| Complementarity | Complete occurrence | Direct textual claim | Evidenced in order-appropriate offering, acceptance, use, nourishment, and fulfilment | That human recognition or fulfilment must succeed |
| Mediative activity | Complete occurrence | Direct textual claim | Regulates generative and degenerative tendencies and maintains balance | A separate controller, scalar equilibrium, or action by *satta* |
| Structural closure | Bounded situation and $\Lambda$ events | Direct textual claim of composition; event as reconstruction | New containing unit whose constituents persist | That a family or organisation is such a unit; that T1 is a closure |
| Body–*jeevan* association ($j\bowtie_n(b,r)$) | Bounded situation | Direct textual claim of the joint form; relation as reconstruction | Association of a pranic body and constitutionally complete *jeevan*; not a third ontic unit | A physical transfer mechanism; a third public tetrad stored in $U_n$ |
| Derived joint form $\eta\in J_n$ | Bounded situation (derived) | Analytical reconstruction | Derived activity scope of an association; public animal or human reading | A third member of $U_n$; compound-closure semantics for “the animal” |
| Maintained relational order | Bounded situation and trace assessment | Analytical reconstruction | Family, work, or organisation among already-existing human joint forms | An institutional *jeevan*, faculty profile, or independent tetrad |
| T1 | Structural boundary | Direct textual claim | Kind-change to constitutionally complete *jeevan*; not a compositional closure | Physical identification of the atomic configuration; a selection predicate derived from the process |
| $\Lambda$ events | Structural boundary | Analytical reconstruction | Compatible structural or orientation events inspected on the candidate situation | A pause in nature between activity and result; an evolution law |
| $N_g$ / $E$ | Trace assessment | Analytical reconstruction | Separately typed natural conditions and human evidence, jointly constrained | That a verification record is a transition rule or a force |
| $T2^{*}$, $T3^{*}$ | Trace assessment | Proposed operational criterion | Proposed trace-level tests of activity and conduct completeness | Source-stated conjunctions; automatic proof of realisation |
| Occurrence index $n$, $\Delta t$ | Descriptive cut | Analytical reconstruction | Indexes continuous activity for description | A gap between occurrences; time as a container or cause |
| Order-*dharma* | Standing ontological context | Direct textual claim | Invariant orientation by which fulfilment is assessed | Data consumed by the occurrence or a transition rule |
| *Niyati-kram* | Standing ontological context | Direct textual claim | Restricts the admissible order sequence | An attractor or agency that pulls a unit forward |
| Realised Knowledge | Standing context and human occurrence | Direct textual claim | Orients truth, *dharma*, and justice through the faculties and conduct | An automatic outcome of physical regularity or a force added to the body |

The irreducible remainder stays named as data or open questions: order-specific manifestations, value kinds, faculty inventory, transmission carriers, completeness stages, human goals, the selection conditions for T1 and *jeevan*–body pairing, and the physical realisation of the body-expression interface. The process localises that remainder; it does not eliminate it.

Success in one access domain does not substitute for failure in another. Conduct-evidence is strongest for resolution, relationship, and humane participation; claims about physical process, the body–*jeevan* interface, or post-death continuity require domain-appropriate public tests (Appendix C).
...
### Structure of Appendices A, C, and D
...
Appendix C contains the operational proposals: activity and conduct completeness, access domains, four verification statuses, and sixfold evidence obligations. Separating them keeps a proposed test from becoming a hidden transition rule in Appendix A. Appendix D is a notion-level map of registers, claim-kinds, roles, and what the model does not prove; it is not a second process. Appendices A and C are analytical reconstructions. The sources provide the qualitative concepts and dependencies, not a state tuple, guard language, event set, invariant list, or operational equivalence.
