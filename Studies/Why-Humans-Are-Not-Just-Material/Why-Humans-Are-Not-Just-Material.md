...
**Edited on:** July 15, 2026, 5:23 AM IST
**Status:** Released
...
| ***Pramanikta*** | The realisation-bearing authenticity that becomes evident in conduct, teaching, and humane tradition ([Knowledge, Knower, and Known](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) §1.7). |
| ***Rahasyata*** | Mysteriousness — removable deficit in the knower's reflection, not a permanent opacity of nature ([Knowledge, Knower, and Known](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) §§1.9, 3.4). |
| **Sensitivity / comprehension** | Body- and sense-based responsiveness versus *jeevan*'s cognisance of relationship, value, and order ([Knowledge, Knower, and Known](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) §1.5). |
...
- [Knowledge, Knower, and Known](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) — evidence chain, active knower, *gyan udghatan*, joint-form knowing, sensitivity and comprehension, *rahasyata*, public testability, and physical causation (§§1.1, 1.4–1.9, 3.4, 7.2–7.4).
