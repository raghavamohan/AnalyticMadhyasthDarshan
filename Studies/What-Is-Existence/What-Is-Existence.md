...
SB summarises mutual dependence as a continuous identity-chain — a characteristic Madhyasth Darshan reasoning pattern in which each link is an identity ("itself is"), not an external push:
