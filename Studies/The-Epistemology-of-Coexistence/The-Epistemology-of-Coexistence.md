...
Complete knowledge comprises the holistic view of existence as coexistence, knowledge of *jeevan*, knowledge of humane conduct, and knowledge of participation in overall orderliness (KD §3.5, p. 69; KD §3.17, pp. 145–150; SB, p. 116). Knowledge is not factual representation. What exists, who knows it, how the knower conducts human life, and how that conduct enters the larger order belong together, and participation is the constituent in which the other three become evident.

*Gyan* also carries a wider ontological sense. Insentient and sentient nature saturated in Omnipresence is coexistence, called Realisation Knowledge (*anubhav jnan*), since every unit within it has form, properties, essential nature, and *dharma*, and has inherent orderliness while participating in overall orderliness (MVD, p. 11). The omnipresent ground within coexistence is itself Knowledge or Space, and law, regulation, balance, justice, *dharma*, and ultimate truth are evident within coexistence (MVD, pp. 32–33). Knowledge in this sense is actionless and non-transforming: neither an activity nor an agent performing activities, while serving as their ground and source of inspiration (MVD, p. 35). Units act; Omnipresence does not, and sentience is predicated of units rather than of the ground. Reality is thereby orderly, intelligible, and available for realisation.

The universal availability of knowledge follows from happiness as the *dharma* of the knowledge order: knowledge is its foundation, and what is absent cannot be attained, so knowledge must already be universally available (MVD, p. 115).

The activity of knowing belongs to *jeevan*. The universal presence of knowledge is distinct from its unfolding (*gyan udghatan*): knowledge is present throughout coexistence, while its unfolding occurs through awakened human beings and through the sentient aspect or thought (MVD, pp. 115–116, 289). Realisation in coexistence is complete knowledge; knowledge-unfolding is the awakened knower's expression of that realisation. *Jeevan* is the bearer of realisation, enlightenment, contemplation, deliberation, and selection. The human being is also the knower because evidence requires the joint form of *jeevan* and body: a human being speaks, works, behaves, evaluates, teaches, and participates in orderliness. *Jeevan* bears knowing; the embodied human presents its evidence.

The omnipresent ground is available to an awakened human as law in work, resolution in thought, bliss in realisation, and justice in behaviour (MVD, p. 33). Each term names a distinct register in which understanding becomes evident rather than a synonym for the others. Realised knowledge ends contradiction in the knower as comprehensive resolution and becomes evident through lawful work, just behaviour, and non-contradictory participation.

The known is existence as coexistence. It includes Omnipresence and the four orders; units with form, properties, essential nature, and *dharma*; their relationships and participation; and development through awakening. Measuring external properties is one mode of knowing rather than its completion. Physical, intellectual, and coexistential knowledge are distinguished, expressed through skill, proficiency, and scholarliness (KD, pp. 3–4). The scope extends into production and ecology: human freedom must protect and rightly use natural abundance rather than disrupt the complementarity of the other orders (SB, pp. 111, 121, 149).

The known becomes meaningful when awakening evidences human and *jeevan* aspiration through undivided society and universal orderliness (KD §3.17, p. 148). Coexistence is what is known; resolved, prosperous, fearless, and coexistential living shows that it has entered human meaning. The known is therefore neither an external object alone nor a desirable social result alone, and it does not lose its reality by being understood: the world is perpetual rather than an appearance cancelled by knowledge (MVD, p. 13).

The triad is stated against idealist and god-centred systems that collapse knowledge, knower, and known into mystery, and against materialism's derivation of differences in consciousness from composition without demonstrating the relation (KD §3.17, pp. 146–147). The objection to both is that they obscure the human bearer of evidence, which is why Madhyasth Darshan requires knowledge to be borne and evidenced by the human joint form. Whether that requirement meets the strongest Advaita and physicalist arguments is taken up in §§2–4 and §6.1.

Four parallel triads stand beside knowledge, knower, and known, and together they keep the account from becoming detached spectatorship. *Darshan–drish–drishya* assigns seeing to justice, *dharma*, and truth, the seer to human *jeevan*, and the seen to coexistence. *Dhyan–dhyata–dhyeya* names awakening, the human attender, and freedom from delusion together with the *jeevan* values. *Karan–karta–karya* gives the knowledge-state as cause, the human being as doer, and participation in universality as effect. *Sadhya–sadhak–sadhan* gives awakening as aim, the human being as seeker, and body together with *jeevan* as means (KD §3.17, pp. 145–150). A fifth triad names seer, doer, and enjoyer, where the seer is established seer-status (*drishta-pad*) (KD §3.18, pp. 151–152). Knowing therefore involves perspective, attention, purpose, embodiment, action, and consequence, and the knower is active without being reducible to action alone.

*Jeevan* is constitutionally complete and therefore persistent across bodily birth and death (JV, p. 20). That persistence follows from the indestructibility of a constitutionally complete sentient unit and from the conservation of what exists; the evidential standing of the proposition is examined in §7.4.
...
The immediate epistemic goal is freedom from delusion and comprehensive resolution. Delusion begins when the body is taken to be the self and sensory satisfaction is expected to fulfil *jeevan*. Resolution is not merely the cessation of anxious thought. It is understanding the relevant realities together with adequate answers to why and how in activity (MVD, pp. 33, 311). Awakening is the condition in which reflection reaches understanding and understanding consistently governs projection into thought, choice, work, behaviour, and communication.

The four *jeevan* values name the inward harmonies of this condition. They are stated as relations between the activity-centres of *jeevan* — *mun*, *vritti*, *chitta*, *buddhi*, and *atma*, set out in §1.3: happiness between *mun* and *vritti*, peace between *vritti* and *chitta*, contentment between *chitta* and *buddhi*, and bliss between *buddhi* and *atma* (MVD, pp. 207–208; JV, p. 138). They are relations among activities of *jeevan*, not quantities on one scale. Material success cannot compensate for unresolved understanding, and private calm cannot substitute for unjust relationship. Their realisation is mental well-being, and a further concurrence of *atma* with Omnipresence is ultimate bliss (MVD, pp. 208, 327).
...
Resolution bears happiness, resolution with prosperity bears peace, the addition of fearlessness bears contentment, and participation in coexistence bears bliss (KD, p. 112). The classical human ends are correspondingly reinterpreted through all-round resolution, realisation, and freedom from delusion (KD, pp. 3–4). The requirement throughout is that inward understanding, bodily sufficiency, just relationship, social confidence, and universal participation be mutually consistent, rather than attained in a fixed order.

Madhyasth Darshan distinguishes three functions within this movement. Knowledge (*gyan*) establishes realised understanding of coexistence, *jeevan*, and humane conduct. Wisdom (*vivek*) recognises the human goal. Science (*vigyan*) supplies direction for accomplishing material prosperity together with the human and *jeevan* goals (MVD, p. 170). Science in this sense is broader than modern natural science. Knowledge establishes what is real, wisdom identifies the human goal, and science determines how activity can move toward material sufficiency and those goals.
...
The active knower is *jeevan*, a constitutionally complete sentient unit whose ten activities are distributed across *atma*, *buddhi*, *chitta*, *vritti*, and *mun*: realisation and authenticity in *atma*; enlightenment and resolve in *buddhi*; contemplation and visualisation in *chitta*; deliberation and analysis in *vritti*; and taste and selection in *mun* (JV, pp. 72–73, 92–93). The receptive activity of *chitta* is direct recognition (*sakshatkar*) — the recognition and formation of meaning rather than bodily sensation alone.

The same ten activities divide again into force and power, and that division matters for evidence. Five are activities of state expressed as force — taste, comparison, contemplation, enlightenment, and realisation — and five are activities of motion expressed as power — selection, analysis, desire, resoluteness, and evidence (KD §3.6, pp. 70–71). Named from what becomes observable in a living person, the projected five are hope, thought, desire, resoluteness, and authenticity, which *jeevan* alone expresses, communicates, and manifests (KD §3.16, p. 145). The activities of *jeevan* are therefore legible in a person's hopes, thoughts, desires, resolves, and authenticity, and this is what connects the faculty account to the darshan's claims about behaviour.
...
The body is necessary to this evidence but is not the knower. The brain or *medhas* processes signals associated with hopes, thoughts, desires, resolves, and authenticity, while waves from the cognitive organs participate in knowledge-unfolding (MVD, pp. 83–84, 200). The body operates on the basis of *jeevan* and its understanding, not conversely (KD §3.16, pp. 141, 143). How that direction of dependence interacts with neural activity remains open (§7.3).

The distinction between sensitivity and cognisance specifies the two sides of the joint form. Sensitivity (*sanvedansheelta*) is embodied responsiveness through sound, touch, sight, taste, and smell. Cognisance (*sangyansheelta*) is the knowing-and-accepting capacity through which *jeevan* understands relationship, value, purpose, and orderliness. Sensory contact is required for bodily interaction but does not by repetition yield the continuous satisfaction sought by *jeevan*. The awakened human regulates sensitivity through cognisance while retaining both in balance, since recognising and fulfilling the insentient and sentient world proceeds through that balance (SB, p. 64).
...
Inspiration reaching *mun* from *vritti*, *chitta*, *buddhi*, and *atma* is higher-conformance, aligned with justice; pressure from vitality, senses, body, and established behaviour is lower-conformance (MVD, p. 208). The latter is necessary to bodily maintenance; error arises when it defines *jeevan*'s final purpose. The question is which perspective governs bodily signals, material outcomes, and the selection that follows.

The darshan's own name marks a further feature of this structure. *Atma* is mediative (*madhyasth*): by its centrality the mediative activity attains the touch of knowledge in every dimension, and its mediativeness becomes evident only through integrality of behaviour and thought (MVD, p. 211). Mediativeness is therefore neither neutrality between options nor compromise between doctrines. It names the central, non-partisan situation from which realisation is held to be possible at all, and its test is again coherence between what is understood and what is done.

### 1.4 From sensory activity to universal orderliness

Knowledge of humane conduct becomes operational across bodily, sensory, social, and higher-human activity. These are connected fields rather than equivalent sets of drives. The four *vishayas* identify bodily propensities; the five sensory modalities identify the body's interfaces with its surroundings; and *samadhan* with the three *eshanas* identifies intellectual and social fulfilment. Sensory satisfaction is temporary, intellectual satisfaction longer-lasting, and satisfaction in realisation non-transforming (MVD, pp. 64–65). *Upakar* belongs to a separate higher-human field of help and inspiration.

Within each field, the human being must understand what activity is occurring, what criteria should govern the decision, what law protects and regulates the activity, what balance it must sustain, and how its result participates in overall orderliness.

The four bodily *vishayas* are eating, sleeping, protection or defence, and mating (MVD, p. 58). They characterise animal living, and the human body retains rather than transcends its need for nourishment, rest, protection, and continuity. These propensities operate through the sensory fields of sound, touch, visible form, taste, and smell (MVD, p. 65). The four name which bodily propensity is being served; the five name the mode of bodily contact and information through which it is engaged.

Bodily propensities are not opposed to knowledge. Eating, for example, can be pleasant, health-supporting, and affordable while also being chosen with regard to justice, ecology, family need, and right use. The issue is governance, not suppression of bodily life.

The next field comprises resolution and the three *eshanas*. Satisfaction from *samadhan*, *vitteshana*, *putreshana*, and *lokeshana* is intellectual satisfaction, distinct from temporary sensory satisfaction and from non-transforming satisfaction in realisation (MVD, pp. 64–65). *Samadhan* orients the social motives so that they become fields of understood responsibility rather than desires merely pursued.
...
*Upakar* belongs to a higher-human level: help and inspiration for prosperity and awakening (MVD, p. 73). It is the use of resolved capacity to support another person's material sufficiency and understanding. Help should therefore increase capability and preserve mutuality; creating dependency or exploiting vulnerability defeats its ends.
...
The first three perspectives are relative to changing conditions. What tastes pleasant may damage the body; what improves bodily comfort may depend on an unjust exchange; what appears profitable to one family may externalise harm to another or to the natural orders. Pleasantness, health, and material gain therefore provide relevant information without supplying a universal criterion. The difference is one of permanence: the perspectives of pleasant, healthy, and profitable change, while those of justice, *dharma*, and truth do not (MVD, p. 212). This relativity (*sapekshata*) lies in differentiated seeing — in distinctions among perspective, the observed, and worldview (MVD, p. 210) — not in coexistence itself, which remains real while human perspective may be incomplete or deluded. The latter three perspectives ask whether the decision fulfils relationship, sustains resolution and orderliness, and accords with coexistence. Behaviour resting on *priya–hita–labha* is accordingly inhumane and behaviour resting on *nyaya–dharma–satya* humane (MVD, p. 67), and pleasure, health, and profit are to be dissolved into and governed by justice, *dharma*, and truth (JV, pp. 93–98, 139).

This distinction does not require awakened humans to ignore pleasure, health, or economic result. The body still requires nourishment, protection, and useful means. Their subordinate status means that they cannot finally authorise an activity that violates justice, produces contradiction, or depends on a false conception of coexistence. Humane deliberation considers all six dimensions while giving governing authority to justice, *dharma*, and truth. Deliberation through *nyaya–dharma–satya* is balanced; deliberation through *priya–hita–labha* is unbalanced (MVD, pp. 126–127). Bodily and material information remains necessary to practical judgment without acquiring authority over it.

Knowledge of activity also includes *niyam*, *niyantran*, and *santulan*. *Niyam* is law — the way an activity is protected and disciplined (MVD, p. 70). *Niyantran* is regulation according to law, not arbitrary external control. *Santulan* is the balance sustained when activity remains appropriately regulated in mutuality. These terms concern the inherent and practical order of activity: what the relevant law is, how the activity stays within it, and what complementarity or balance results.

A continuous sequence connects these terms. Omnipresence is knowledge; realisation in knowledge is understanding; understanding is evidenced as knowledge, wisdom, and science; knowledge is law; law is regulation; regulation is balance; balanced human living is justice; just living in universal orderliness is *dharma* or resolution; and realisation in coexistence is *dharma* and truth (MVD, p. 174). Human behaviour is regulated through justice, thought is disciplined through *dharma*, realisation occurs through truth, and regulation proceeds through law (MVD, p. 137). The relation between the two triads is a functional progression, not a term-by-term equation.
...
This practical organisation gives humane conduct its definite content. Humane conduct comprises value, character, and ethics. Value includes recognising relationship, fulfilling its values, evaluating the result, and attaining mutual satisfaction. Character includes fidelity and compassionate work and behaviour. Ethics includes the protection and right use of body, mind, and material wealth across personal, economic, and political participation (KD §3.4, p. 67). Humane behaviour has an essential nature of fortitude, courage, generosity, kindness, grace, and compassion; perspectives of justice, *dharma*, and truth; and behaviour bearing the three *eshanas* (MVD, p. 35). Humane conduct is thus neither a private disposition nor a list of prohibitions. It is the organisation of motive, deliberation, relationship, resources, and action under understood order.

The full movement begins from understood reality. *Jeevan* then deliberates through the applicable perspectives, decides what is to be done, recognises the relationship involved, and fulfils its value through embodied action. The result is evaluated for actual fulfilment and mutual satisfaction. Evaluation may confirm the original understanding, expose inadequate ability or resources, or reveal an error in conception, recognition, or choice. Corrected understanding then enters the next cycle. Knowledge is therefore active before, during, and after conduct: as understanding before decision, regulation during activity, and evaluation after result.

Across bodily propensities, sensory contact, the *eshanas*, relationship, production, and *upakar*, knowledge of the activity, its governing perspectives, relevant law and regulation, expected balance, and contribution to the human goal enables conscious participation in universal orderliness rather than the imposition of a human design upon nature.

### 1.5 Knowing, action, and evaluation

Knowledge in the human process is knowing together with believing or accepting (JV, p. 165) — a discipline stated as believing what is known and knowing what is believed (MVD, p. 12). Acceptance here is not assent without inquiry. It is the establishment of understood meaning as a basis for one's own activity. Knowing without acceptance remains verbally available but practically ineffective; acceptance without knowing remains inherited belief and can sustain delusion.

Activity together with aspiration is karma, and every karma has a result. Intentional activity is analysed through doer, cause, objective, result, and effect, so that desire, action, and consequence are examined together rather than good intention being treated as sufficient (KD Ch. 1). Bodily capacity, knowledge, skill, other persons, material means, and environmental conditions all mediate the result. An awakened decision does not guarantee control over every external event. It seeks non-contradiction between the accepted aim, the chosen means, the relationships involved, and the foreseeable result.
...
Over-evaluation, under-evaluation, and mis-evaluation are the characteristic failures. Over-evaluation attributes more value, capacity, or fulfilment than is present. Under-evaluation recognises less. Mis-evaluation applies the wrong value or criterion. Any of the three may distort the object, the accepted purpose, the relationship, one's own ability, the action, or the result. Repeated evaluation and action shape *sanskar*, which influences later projection without making human conduct mechanically fixed. The feedback movement is epistemic: consequence supplies material for corrected understanding.

False learning is more than an isolated false proposition: it is failure to understand a thing's form, properties, essential nature, and *dharma* as they are, and is connected with doubt and distorted evaluation (MVD, pp. 184, 263–264). Information, argumentative skill, or institutional authority may therefore coexist with unresolved desire and unjust conduct. Awakening requires coherence across knowing, accepting, recognising, fulfilling, and evaluating.

### 1.6 Evidence, study, and transmission

The evidence chain is stated directly:
...
Its practical sequence is realisation, behaviour, and experiment (MVD, p. 12). Realisation is the inward term; behaviour is its relational expression; experiment is the practical extension in which understanding encounters material and social result. Experiment includes productive and lived participation, not only controlled laboratory procedure.

This is a broader evidence regime than that of the natural sciences. Madhyasth Darshan requires first-person realisation, second-person conveyance, and publicly observable work, behaviour, and outcomes to cohere. What such coherence can and cannot establish is examined in §§7.2 and 7.6.
...
There is no guaranteed ladder from information to realisation. Language and an evidence-bearing teacher make meaning available for examination; knowing and accepting establish it as a serious possibility; *chitta* recognises it, *buddhi* receives enlightenment and resolve, and *atma* realises. Projection returns understanding as explanation, conduct, work, and experiment; result and evaluation return to reflection. Information is necessary to transmission but is not already knowledge, and correct terminology establishes none of the later activities by itself.

Transmission remains essential because knowledge claims to be universally accessible rather than a private revelation that must remain ineffable. Comprehension is tested by the capacity to convey it to others (JV, p. 26). Conveyance requires more than fluency. The learner must be able to explain, live, evaluate, and make the understanding available without contradiction. *Sanskar*, environment, study, endeavour, humaneness, and awakening support one another in this process (MVD, pp. 90, 290).

What blocks this movement is named directly. Incompleteness in understanding state and activity is mystery (*rahasyata*) — the incapacity to attain, evidence, or impart complete understanding — and holistic view removes it (MVD, p. 209). Intellectual mystery (*bauddhik rahasya*) lies in failed alignment among *mun*, *vritti*, *chitta*, *buddhi*, and *atma*, where reflection does not reach realisation or realisation does not project as evidence; delusion-less knowledge is knowing, understanding, and imparting realities as they are (MVD, p. 317). The commitment is to structural knowability and communicability: coexistence, its orders, *jeevan*, and humane conduct can be known without a remainder of ontological mystery. This is not a claim that an awakened person possesses every contingent fact or anticipates every scientific result, and whether such certitude can be distinguished from overconfidence is taken up in §7.1.

Exploration (*anushandhan*) and study through an awakened tradition are the two paths out of intellectual mystery, requiring delusion-less knowledge, just behaviour, resolved thought, and disciplined engagement with a realised teacher (MVD, pp. 273–285, 317). The resulting tradition joins guidance with the learner's examination of meaning, practice, consequence, and contradiction; the epistemic risks of dependence on teacher-evidence are examined in §7.5.
...
- The argument for the universal availability of knowledge (§1.1) moves from happiness as the knowledge order's attainable *dharma* to the prior presence of its ground, and needs further premises before that inference goes through.
...
| **Five forces / five powers** | The ten activities divided as force and power: five activities of state expressed as force and five of motion expressed as power, the projected five appearing as hope, thought, desire, resoluteness, and authenticity (KD §3.6, pp. 70–71; KD §3.16, p. 145; §1.3). |
...
| **Higher- / lower-conformance** | Governance of *mun* by inspiration from *vritti*, *chitta*, *buddhi*, and *atma*, against governance by pressure from *prana*, senses, body, and behaviour (MVD, p. 208; §1.3). |
...
| **Four *vishayas*** | Eating, sleeping, defending, and mating: bodily propensities retained in the human joint form and regulated rather than treated as the source of *jeevan*'s happiness (§1.4). |
...
| ***Ati-, av-, mithya-mulyankan*** | Over-evaluation, under-evaluation, and mis-evaluation of objects, relationships, fulfilment, or results (§1.5). |
...
| ***Pratyaksha–sakshatkar–bodh–anubhav*** | Direct accessibility; meaning-acceptance in *chitta*; enlightenment in *buddhi*; and realisation in *atma*. These are related but non-interchangeable (§1.6). |
| **Projection / reflection** | The evidencing and knowing directions of *jeevan*'s ten coordinated activities (§1.3). |
...
| ***Bauddhik rahasya* (Intellectual mystery)** | Failure of reflection and alignment among the faculties of *jeevan* (§1.6). |
...
| ***Jeevan* aspiration** | Happiness, peace, contentment, and bliss as harmonies of *jeevan* (§1.2). |
...
Complete knowledge is enumerated with four constituents at KD §3.5, p. 69 — the holistic view of existence as coexistence, *jeevan*, humane conduct, and participation in overall orderliness — and with three at KD, p. 30 and KD §3.17, p. 148, where participation is not listed separately. This study states the four and treats participation as the constituent in which the other three become evident, rather than as an independent object of knowledge. Nothing in the exposition of §1 depends on which enumeration is preferred.
...
### The receptive activity of *chitta*

The receptive activity of *chitta* appears both as contemplation and as direct recognition (*sakshatkar*). Both name the recognition and formation of meaning rather than bodily sensation, and this study uses "direct recognition" where the contrast with sensory contact is at issue (§1.3).
...
- **MVD** — Nagraj, A. [*Madhyasth Darshan – Co-existentialism*, Part 1: *Holistic View of Human Behaviour*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: all units in Omnipresence (p. 11; §1.1); the evidence chain, quoted in §1.6, and the knowing-and-believing discipline (p. 12; §§1.5–1.6); the world as perpetual (p. 13; §1.1); the four registers of the omnipresent ground and the definition of resolution (p. 33; §§1.1–1.2); Space as knowledge, knowledge as neither activity nor performing activity, and humane behaviour as essential nature, perspective, and motives (p. 35; §§1.1, 1.4, 1.6); four bodily propensities (p. 58; §1.4); sensory and intellectual satisfaction and the three *eshanas* (pp. 64–65; §1.4); six evaluative perspectives (pp. 66–67; §1.4); law and the activities of thought (pp. 70–71; §1.4); *upakar* as help and inspiration for prosperity and awakening (p. 73; §1.4); *medhas*, the *jeevan* activities, and *darshan-drishya-drishti* (pp. 83–84; §1.3); *sanskar* definition (p. 90; §1.6); the universality argument for knowledge and "Realisation in coexistence" (pp. 115–116; §1.1); balanced and unbalanced deliberation (pp. 126–127; §1.4); regulation through justice, *dharma*, truth, and law (p. 137; §1.4); *vivek* and *vigyan* definitions (p. 170; §1.2); the sequence from knowledge through law, regulation, balance, justice, *dharma*, and truth (p. 174; §1.4); false learning (p. 184; §1.5); the brain and cognitive-organ signal pathway (p. 200; §1.3); higher- and lower-conformance, the four *jeevan* values, and mental well-being (pp. 207–208; §§1.2–1.3); mystery and its removal by holistic view (p. 209; §1.6); relativity in differentiated seeing (p. 210; §1.4); mediativeness of *atma* (p. 211; §1.3); the permanence contrast between the two sets of perspectives (p. 212; §1.4); doubt and distorted evaluation (pp. 263–264; §1.5); Ch. 17 *Rahasy-mukti* — mystery, exploration, study, and an awakened tradition (pp. 273–301; §1.6); knowledge unfolding through *jeevan*/thought (p. 289; §1.1); the awakening–*sanskar* cycle (p. 290; §1.6); justice, mutual satisfaction, and resolution (pp. 310–311; §§1.2 and 1.5); *samvedana* usages (p. 313; Editorial Notes); delusion-less knowledge (p. 317; §1.6); and *atma*–Omnipresence concurrence and ultimate bliss (p. 327; §1.2).
- **KD** — Nagraj, A. *Manav Karm Darshan* (Madhyasth Darshan, Part 2). [Working English translation](../References/Madhyasth-Darshan/KD-Karm-Darshan-English/KD-Karm-Darshan-English.pdf); [Hindi–English review edition](../References/Madhyasth-Darshan/KD-Karm-Darshan-English/KD-Karm-Darshan-Hindi-English.pdf). Cited by paraphrase: autobiographical *Alternative* (points 1, 5, 10, and 11), including the founding questions on Brahma and the world and on what counts as evidence (§1.6); action, desire, result, and the reinterpreted human ends (Ch. 1, pp. 2–4; §§1.1–1.2 and 1.5); direct perception, inference, and testimony-activity (pp. 20–21; §1.6); the three-constituent statement of knowledge (p. 30; Editorial Notes); humane conduct as value, character, and ethics (§3.4, p. 67; §1.4); four contents of complete knowledge (§3.5, p. 69; §1.1 and Editorial Notes); five activities of state and five of motion as force and power (§3.6, pp. 70–71; §1.3); *jeevan* expressing hope, thought, desire, resoluteness, and evidence (p. 65; §1.3); the relation between the human goal and the *jeevan* values (p. 112; §1.2); projection–reflection (§§3.12, 3.16–3.17; §1.3); body–*jeevan* dependence and the projected activities in the *medhas* setting (§3.16, pp. 141, 143, 145; §1.3); the knowledge–knower–known argument, the known as awakened meaning, ten activities, and the knowledge, attention, cause, and aim triads (§3.17, pp. 145–150; §§1.1 and 1.3); and seer–doer–enjoyer (§3.18, pp. 151–152; §1.1). The English text is a working translation; quoted formulations should be checked against the Hindi.
- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (*Resolution Centred Materialism*)](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta. Cited: evidence through experimentation, behaviour, and experience (p. 44; §1.6); balance of cognisance and sensitivity (p. 64; §1.3); material and ecological complementarity and cyclic economic participation (pp. 111, 121, 149; §1.1); and threefold knowledge (p. 116; §1.1).
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf). English translation by Rakesh Gupta. Cited: birth, death, and *jeevan* continuity (p. 20; §1.1); proof by conveying understanding (p. 26; §1.6); recognition, fulfilment, evaluation, and mutual satisfaction in justice (p. 55; §1.5); the human goal (pp. 61, 165; §1.2); ten activities and the four-and-a-half activities effective in delusion (pp. 72–74, 92–93; §1.3); the root of delusion and the governance of pleasure, health, and profit by justice, *dharma*, and truth (pp. 93–98, 139; §1.4); the four *jeevan* values (p. 138; §1.2); and the definition of knowledge (p. 165; §1.5).
