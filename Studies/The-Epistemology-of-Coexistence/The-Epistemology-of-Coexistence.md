...
**Edited on:** July 29, 2026, 8:18 PM IST
**Status:** Released
...
The aim–seeker–means triad names seer-status or awakening as the aim, the human being as seeker, and body together with *jeevan* as means. KD later widens the effective means to imagination, freedom of action, and an evidence-bearing tradition. These related structures prevent epistemology from becoming detached spectatorship. Knowing includes perspective, attention, purpose, embodiment, action, developmental effect, and consequence.

### 1.4 *Jeevan* as the active knower

The knower is not an actionless witness. *Jeevan* is a constitutionally complete sentient unit whose ten coordinated activities are distributed across *atma*, *buddhi*, *chitta*, *vritti*, and *mun*. JV names realisation and authenticity in *atma*; enlightenment and resolve in *buddhi*; contemplation and visualisation in *chitta*; deliberation and analysis in *vritti*; and taste and selection in *mun* (JV, pp. 92–93). The working KD translation sometimes renders the receptive activity of *chitta* as direct recognition (*sakshatkar*); the common point is meaning-bearing recognition rather than sensation alone.
...
### 1.5 Knowing, regulating, recognising, fulfilling, and evaluating
...
### 1.6 Knowledge, wisdom, science, and completeness

Madhyasth Darshan repeatedly joins *gyan*, *vivek*, and *vigyan*, but the terms perform different functions. **Knowledge** (*gyan*) is realised understanding of coexistence, *jeevan*, and humane conduct. **Wisdom** (*vivek*) is the knowledge by which the human goal—resolution, prosperity, fearlessness, and coexistence—is recognised (MVD, p. 169). **Science** (*vigyan*) is directional knowledge for accomplishing material prosperity together with the human and *jeevan* goals (MVD, p. 169). MVD's definition of complete knowledge adds understanding of the law and process of activity and of the cause and law of thought (MVD, pp. 208–209). Science here is therefore broader than modern natural science: it includes reliable direction in production, health, work, behaviour, and social orderliness, while remaining answerable to the physical laws relevant to each activity.

These functions explain why knowledge is a prerequisite for happiness rather than one object of curiosity among others. MVD names happiness as the *dharma* inseparable from the human being and says every human seeks it (MVD, pp. 253–254). The four bodily propensities, five modes of sensitivity, and three *eshanas* supply fields of activity, but they do not by themselves specify their right use or yield the stable fulfilment sought by *jeevan*. Knowledge establishes what is real; wisdom identifies the humane and *jeevan* goals; science determines practicable direction. Together they allow bodily maintenance, sensory engagement, family life, production, and public participation to be governed by justice, *dharma*, and truth rather than by pleasure, health, and profit as final criteria.
...
The four *jeevan* values name harmonies among the faculties: happiness between *mun* and *vritti*, peace between *vritti* and *chitta*, contentment between *chitta* and *buddhi*, and bliss between *buddhi* and *atma* (MVD, pp. 207–208; JV, p. 138). The canonical second value is **peace**, not the relational term satisfaction. These values are not quantities on one scale; outward success cannot compensate for unresolved understanding, and private calm cannot substitute for failed relationships. When action proceeds from understood purpose, recognises relationships, fulfils their values within actual capacity, and is evaluated in mutuality, just behaviour yields mutual satisfaction and supports the internal harmonies in which the four *jeevan* values are realised. Correct intent is necessary but not sufficient: fulfilment and evaluation must confirm it.

The *jeevan* aspiration of happiness, peace, contentment, and bliss becomes meaningful together with the human aspiration of resolution in the person, prosperity in the family, fearlessness in society, and coexistence in universal orderliness (KD §3.17, p. 150; JV, pp. 61, 165). KD connects these levels still more tightly: resolution bears happiness, resolution with prosperity bears peace, the addition of fearlessness bears contentment, and participation in coexistence bears bliss (KD, p. 112). The mapping is not a mechanical causal ladder, but it shows why epistemic, relational, material, social, and universal fulfilment cannot be substituted for one another.
...
The root of delusion (*bhram*) is identifying *jeevan* with the body (JV, p. 93). Once the body is treated as the self, sensitivity supplies the governing reference points and believing separates from knowing. The resulting four-and-a-half-activity condition is an internal account of why sophisticated thought can coexist with unresolved desire, conflict, and mis-evaluation.

False learning is a related but distinct failure. MVD defines it as lack of awakening to understand a thing's form, properties, essential nature, and *dharma* as they are (MVD, p. 184), and elsewhere associates it with doubt, over-evaluation, under-evaluation, and mis-evaluation (MVD, pp. 263–264). One may possess information, arguments, or institutional authority while failing to recognise the object or relationship adequately. The error taxonomy in §1.5 shows why the defect cannot be located only at the final judgment: distorted acceptance, relationship-recognition, fulfilment, and result-assessment can each preserve or amplify false learning.
...
| **Chit (Consciousness)** | Self-revealing consciousness identical with Self and Brahman; empirical mind and objects are not independently conscious. | Omnipresence is pervasive knowledge or condition of intelligibility (§1.1), while active sentience (*chaitanya*) belongs to each *jeevan*. |
...
The primary texts support a richer epistemic structure than the simple formula “knowledge–knower–known” suggests: seeing, attention, action, and seeking; knowing, believing, recognising, fulfilling, and evaluating; cognisance regulating sensitivity; the four *vishayas* and three *eshanas* directed toward right use; projection and reflection; seer, doer, and enjoyer; karma, result, *upakar*, and transmission. In relationship, fulfilled values and evaluation yield mutual satisfaction; within *jeevan*, harmony among successive faculties is named happiness, peace, contentment, and bliss. Those relations should govern future revision and formal work. The unresolved questions do not erase the framework's coherence, but they mark where philosophical exposition must be joined by clearer tests, intersubjective safeguards, and dialogue with the sciences.
...
| ***Gyan–vivek–vigyan*** | Knowledge of coexistence, *jeevan*, and humane conduct; wisdom that recognises the human goal; and science that determines direction for material prosperity and the human and *jeevan* goals (§1.6). |
...
| ***Sanvedansheelta* / *sangyansheelta*** | Sensitivity through the body and five senses, and cognisance through *jeevan*'s knowing and believing. Cognisance regulates sensitivity; it is not another name for all meanings of *gyan* (§1.5). |
| **Four *vishayas*** | Eating, sleeping, defending, and mating: bodily propensities inherited from the animal order and regulated in the human joint form rather than treated as the source of *jeevan*'s happiness (§1.5). |
| **Three *eshanas*** | Progeny, wealth, and reputation or public-recognition motives; humane orientation directs them toward family and education, prosperity and right use, and accountable social participation (§1.5). |
| ***Nyaya* / *ubhay-trupti*** | Justice as relationship-recognition, value-fulfilment, evaluation, and mutual satisfaction. Mutual satisfaction is a relational outcome, not a fifth *jeevan* value (§1.5). |
| ***Ati-, av-, mithya-mulyankan*** | Over-evaluation, under-evaluation, and mis-evaluation of objects, relationships, fulfilment, or results (§§1.5 and 1.9). |
| ***Upakar* (Beneficence)** | Help and inspiration for prosperity and awakening; an outward expression within the evidence chain, not vague charity or the sole proof of knowledge (§1.7). |
...
| ***Pramanikta* (Authenticity)** | The realisation-bearing activity of *atma* that becomes publicly evident through conduct, teaching, and humane tradition (§1.7). |
| ***Pratyaksha–sakshatkar–bodh–anubhav*** | Direct accessibility; meaning-acceptance in *chitta*; enlightenment in *buddhi*; and realisation in *atma*. These are related but non-interchangeable (§1.8). |
...
| ***Bauddhik rahasya* (Intellectual mystery)** | Failure of reflection and alignment among the faculties of *jeevan* (§1.9). |
...
| **Human *dharma*** | Happiness as the inseparable human aspiration; knowledge is required to understand and live the law by which happiness is realised (§1.6). |
...
| ***Jeevan* aspiration** | Happiness, peace, contentment, and bliss as harmonies of *jeevan* (§1.6). |
...
| **Hard Problem** | Why physical brain processes are accompanied by subjective experience — a modern open question, not the same as Madhyasth Darshan's *rahasyata* (§1.9; §3.4). |
...
- **MVD** — Nagraj, A. [*Madhyasth Darshan – Co-existentialism*, Part 1: *Holistic View of Human Behaviour*](../References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: all units in Omnipresence (p. 11); evidence chain and "Believe what is known" (p. 12); deluded and awakened action (*Verity*, p. 14); "Only awakened humans" (p. 33); Space as knowledge (p. 35); four bodily propensities, the knowledge order, and humane *eshanas* (pp. 49–51); *upakar* as help and inspiration for prosperity and awakening (p. 72); *medhas* and activities of *jeevan* (p. 83); *darshan-drishya-drishti* (p. 84); *sanskar* definition (p. 90); knowledge unfolding by awakened humans (p. 115); "Realisation in coexistence" (p. 116); sensory activity and satisfaction through justice, *dharma*, and truth (p. 165); *vivek* and *vigyan* definitions (p. 169); false learning definition (p. 184); brain and cognitive-organ signal pathway (p. 200); four *jeevan* values and complete knowledge (pp. 207–209); human *dharma* as happiness (pp. 253–254); doubt and mis-evaluation (pp. 263–264); Ch. 17 *Rahasy-mukti* — mystery, intellectual mystery, paths, four supports, and liberation as bliss (pp. 273–301); knowledge unfolding through *jeevan*/thoughts (p. 289); awakening–*sanskar* cycle (p. 290); humane orientation of the three *eshanas* (p. 303); justice, mutual satisfaction, and resolution (pp. 310–311); "Realisation in knowledge" (p. 316); "delusion-less knowledge" (p. 317); "Brahma is truth, the world is perpetual" ("Fundamental Concepts," point 8, p. 13).
- **KD** — Nagraj, A. *Manav Karm Darshan* (Madhyasth Darshan, Part 2). [Working English translation](../References/Madhyasth-Darshan/KD-Karm-Darshan-English/KD-Karm-Darshan-English.pdf); [Hindi–English review edition](../References/Madhyasth-Darshan/KD-Karm-Darshan-English/KD-Karm-Darshan-Hindi-English.pdf). Cited by paraphrase: autobiographical *Alternative* (points 1, 5, and 11); fundamental concepts; action, desire, and result (Ch. 1); physical, intellectual, and coexistential knowledge (pp. 3–4); direct perception, inference, and testimony-activity (pp. 20–21); cognisance regulating sensitivity (pp. 66–67); human and *jeevan* value mapping (p. 112); realisation, resolution, and happiness (p. 134); projection–reflection (§§3.12, 3.16–3.17); human joint form (§3.16); ten activities and the knowledge, attention, cause, and aim triads (§3.17, pp. 145–150); seer–doer–enjoyer (§3.18). The English text is a working translation; quoted formulations should be checked against the Hindi.
...
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](../References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf). English translation by Rakesh Gupta. Cited: Proof by conveying understanding (p. 26); human body provisioned to evidence understanding (p. 59); birth, death, and *jeevan* continuity (p. 20); values and evaluation not bodily processes (p. 39); four-and-a-half activities in delusion (p. 73); *jeevan* evaluates without external instrument (p. 139); ten activities of *jeevan* (p. 92); root of delusion and belief-vs-knowledge (p. 93); definition of knowledge (p. 165); purview of sensitivity (p. 166).
