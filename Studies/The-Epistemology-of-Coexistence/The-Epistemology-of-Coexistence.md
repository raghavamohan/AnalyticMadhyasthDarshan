...
1. **Knowledge of Existence as Coexistence (*Astitva Darshan Gyan*)**: Understanding reality as the eternal coexistence of all-pervasive Omnipresence (*vyapak satta*) and countless active units of nature (*prakriti*).
2. **Knowledge of the Conscious Self (*Jeevan Gyan*)**: Understanding the constitution, faculties, ten activities, and potential for awakening of the conscious unit (*jeevan*).
3. **Knowledge of Humane Conduct (*Manaviyata Purna Acharan Gyan*)**: Understanding the values, character, ethics, and orderliness through which awakened human beings live and participate in existence.

Some primary passages enumerate four constituents by listing participation in overall orderliness beside these three (KD §3.5, p. 69). Participation is the living field in which the three become manifest, rather than a detached, separate reality. Knowledge is therefore not an abstract mental representation of an external world. What exists, who knows it, how the knower conducts human life, and how that conduct fulfills universal order belong together as a single, coherent whole.

The word *gyan* also names the ever-present, all-pervasive ground in which all units exist. In this use, Space, Omnipresence (*vyapak satta*), and Knowledge refer to the same actionless (*kriya-heen*), non-transforming (*aparinami*) reality. Units remain energy-full and active through their saturation in it; the ground does not perform their activities (MVD, pp. 34–35). Sentience belongs to *jeevan*, while insentient nature and the formless ground do not perform acts of knowing (MVD, pp. 11, 32–33).
...
An awakened human experiences the omnipresent ground across four aspects of living: as law (*niyam*) in work, resolution (*samadhan*) in thought, bliss (*anand*) in realization, and justice (*nyaya*) in behavior (MVD, p. 34). Each term identifies a definite dimension of life. Realized knowledge dissolves internal contradiction, establishing resolution in thought, lawful productive work, just relationships, and harmonious participation in the world.

The known (*gyeya*) is existence as coexistence. It encompasses nature across its four orders (material, plant, animal, and human knowledge order) saturated in Omnipresence. Madhyasth Darshan defines what is known across three aspects of Truth (*Satya*) (YAT; MVD, pp. 88, 97):

- **Inherent Truth (*Vastugat Satya*)**: The reality of each unit's bounded form (*roop*), relative properties (*guna*), natural usefulness or essential nature (*svabhav*), and inseparable innateness (*dharma*).
...
Knowledge is indispensable because human beings belong to the knowledge order (*gyan avastha*). Unlike material units that follow physical laws, plants that follow seed-conformance (*beej-anushangita*), and animals that follow breed-conformance (*vanshanushangita*), human conduct is governed by culture and understanding (*sanskar-anushangita*). Human beings possess imagination (*kalpanasheelta*) and freedom of action (*karm-swatantrata*). Their conduct is not biologically programmed. When humans choose and act without understanding, they adopt contradictory assumptions, generate conflict, and disrupt their natural environment. Knowledge is required to align human freedom with the harmony of coexistence.

The immediate epistemic goal is freedom from delusion (*bhram-mukti*) and comprehensive resolution (*samadhan*). Delusion begins when the perishable body is mistaken for the self, and continuous happiness is sought through temporary sensory gratification (*indriya-sukh*). Bodily needs for food, rest, protection, and procreation are legitimate and necessary for physical survival, but they are temporary and recurring; they cannot satisfy *jeevan*'s conscious yearning for continuous happiness. Resolution is comprehensive understanding that provides clear, unambiguous answers to "why and how" across all human activities (MVD, pp. 34, 312). Awakening (*jagriti*) is the state in which inward reflection reaches genuine understanding, and that understanding consistently governs thought, choice, speech, behavior, and work.

The four internal values of *jeevan* (*jeevan mulya*) describe the progressive harmony experienced in mental well-being (*manah-swasthata*): happiness (*sukh*), peace (*shanti*), contentment (*santosh*), and bliss (*anand*) (MVD, pp. 207–208; JV, p. 137). Each represents the internal satisfaction that arises when lower faculties are guided by higher ones (§1.3). Distinct from these four inter-faculty harmonies, **Supreme Bliss (*Paramanand*)** is experienced when *atma* abides in unbroken concurrence with all-pervasive Omnipresence upon realization (MVD, pp. 208, 327). Material wealth cannot substitute for unresolved understanding, nor can private emotional calm replace just relationships.

These internal harmonies become complete when joined with the fourfold Human Goal (*Manav Lakshya*) (KD §3.17, p. 150; JV, pp. 60, 165):

1. **Resolution (*Samadhan*) in every individual**: Intellectual clarity free from doubt and contradiction.
2. **Prosperity (*Samriddhi*) in every family**: The assured production and availability of physical goods in excess of genuine family needs, rooted in right use rather than endless accumulation.
3. **Fearlessness and Mutual Trust (*Abhay*) in society**: Social relationships governed by justice, trust, and mutual respect, free from exploitation and fear of aggression.
4. **Coexistence (*Saha-astitva*) in nature and universal order**: Harmonious, non-destructive participation in the ecological balance of nature and universal human order.

These goals form a cumulative account of fulfilment: resolution is experienced as happiness; resolution with prosperity as peace; both with fearlessness as contentment; and all three in coexistence as bliss (KD, p. 112). Epistemic clarity, material sufficiency, relational justice, and ecological balance are understood as mutually supporting aspects of complete fulfilment. How particular choices should meet them under limited resources remains a question for practical judgment (§7.7).

To achieve this movement, Madhyasth Darshan distinguishes three connected functions of understanding (MVD, p. 170):

- **Knowledge (*Gyan*)**: Realized understanding of coexistence, *jeevan*, and humane conduct.
- **Wisdom (*Vivek*)**: Discernment of the human goal and universal purpose, distinguishing perishable bodily needs from conscious needs of *jeevan*.
- **Science (*Vigyan*)**: Determines how material prosperity and the human and jeevan goals can be achieved in harmony with existence (MVD, p. 170).
...
- **Activity Completeness (*Kriya-purnata*)**: The awakening of all ten activities of *jeevan*, in which internal effort reaches restfulness (*shram ka vishram*) and understanding is no longer fragmented by delusion.
...
1. ***Atma* (Core / Center)**: Inward realization (*anubhav*) and outward authenticity (*pramanikta*). Situated at the center, it is inherently mediative (*madhyasth*), free from partisan attractions and repulsions (MVD, p. 211).
2. ***Buddhi* (Intellect)**: Inward comprehension (*bodh*) and outward resolve (*sankalpa*).
3. ***Chitta* (Contemplation and Visualisation)**: Inward contemplation (*chintan*) and outward visualisation (*chitran*). Its receptive activity is direct apprehension (*sakshatkar*) of reality and meaning.
4. ***Vritti* (Thought / Deliberation)**: Inward deliberation (*tulan*) and outward analysis (*vishleshan*).
5. ***Mun* (Mind / Sensory Interface)**: Inward tasting (*aswadan*) and outward selection (*chayan*).
...
- **Inward Reflection (*Pratyavartan*)**: The movement in which sensory impressions, behavior, thoughts, and desires are examined inward toward direct apprehension (*sakshatkar*), intellectual comprehension (*bodh*), and existential realization (*anubhav*).
- **Outward Projection (*Paravartan*)**: The movement in which realized understanding and resolve flow outward as harmonious desires, precise analysis, wholesome selection, speech, bodily action, behavior, and social participation (KD §§3.12, 3.16–3.17).

The physical body is essential for presenting evidence, but it is not the knower. The brain (*medhas*) is the physical organ that receives and processes signals transmitted by *jeevan*, translating thoughts, desires, and resolves into neural and motor actions (MVD, pp. 83, 200). The body functions under the direction of *jeevan*, not vice versa (KD §3.16, pp. 141, 143).

The interaction between *jeevan* and body is defined through the balance of sensitivity and cognisance:

- **Sensitivity (*Sanvedansheelta*)**: Physical responsiveness mediated by the senses (sound, touch, sight, taste, and smell). Sensory contact is vital for bodily survival, but sensations are fleeting and cannot satisfy *jeevan*'s yearning for continuous happiness.
- **Cognisance (*Sangyansheelta*)**: The conscious capacity of *jeevan* to understand relationships, values, purpose, justice, and existential order.

In an unawakened human, life is dominated by sensitivity: the person chases temporary sensory pleasures, confuses bodily comfort with happiness, and becomes reactive. In an awakened human, cognisance regulates sensitivity: the senses are kept healthy and purposeful, while understanding guides desires and actions (SB, p. 64).

All ten activities belong to *jeevan*. In deluded living, only four and a half are effective around bodily sensitivity (JV, pp. 72–74; KD §3.17, p. 147): selection and tasting in *mun* (2), analysis in *vritti* (1), visualisation in *chitta* (1), and half of deliberation in *vritti* (0.5). That "half" refers to deliberation restricted to sensory pleasure, bodily health, and material profit. The remaining activities lack the content of understanding needed to guide conduct coherently; justice, *dharma*, and truth are not yet the governing criteria.

Awakening does not add a new organ or abolish the senses; it activates the full depth of the faculties. Direction of guidance distinguishes the two states (MVD, pp. 207–208):

- **Higher-conformance (*Purvanukram*, पूर्वानुक्रम)**: Guidance flowing from the faculties antecedent to *mun* (*vritti, chitta, buddhi, atma*). Inspiration descends from realization in *atma* through *buddhi*, *chitta*, and *vritti* down to *mun*, ensuring that desires and selections are aligned with justice, *dharma*, and truth.
- **Lower-conformance (*Paranukram*, परानुक्रम)**: Pressure pushing inward from bodily sensations, sensory cravings, and social conditioning, subjecting *mun* to external compulsions and reducing *jeevan* to a servant of bodily impulses.
...
- **The Three Social Motives (*Eshanas*) and Resolution**: Intellectual and social satisfaction is fulfilled through resolution (*samadhan*) and three humane motives (MVD, pp. 64–65):
    - *Vitteshana* (Wealth / Prosperity motive): The desire for wealth acquired through righteous labor and justice, directed toward family sufficiency and right use, rather than blind accumulation.
    - *Putreshana* (Progeny motive): The dedication to nurturing, educating, and continuing future generations in family and social orderliness.
    - *Lokeshana* (Social Recognition motive): The aspiration to contribute meaningfully to undivided society and universal order, earning trust through service.
- **Beneficence (*Upakar*)**: Altruistic contribution (MVD, p. 73). Deploying one's physical, intellectual, and material resources to assist others in attaining prosperity and awakening, strengthening their autonomy rather than creating dependency.

Before acting, *jeevan* deliberates through six evaluative perspectives (*drishti*) within comparison (*tulan* in *vritti*) (MVD, pp. 66–67; JV, pp. 93–98, 139):

- **Pleasant / Unpleasant (*Priya–Apriya*)**: Evaluates immediate sensory comfort and taste.
- **Healthful / Harmful (*Hita–Ahita*)**: Evaluates bodily nutrition, protection, and physical well-being.
- **Profitable / Unprofitable (*Labha–Alabha*)**: Evaluates material exchange, resources, and gain.
- **Just / Unjust (*Nyaya–Anyaya*)**: Evaluates fairness, mutual fulfillment, and values in human relationships.
- **Orderly / Disorderly (*Dharma–Adharma*)**: Evaluates whether action sustains all-round resolution and participation in universal harmony.
- **True / Untrue (*Satya–Asatya*)**: Evaluates whether understanding accords with existential reality in coexistence.

The first three perspectives (*priya, hita, labha*) are relative and temporary (*anitya*). Pleasantness, health, and profit provide useful practical information, but they cannot serve as ultimate standards for living. The second three perspectives (*nyaya, dharma, satya*) are universal and unchanging (*nitya*) (MVD, p. 212). Awakened conduct is governed by *nyaya–dharma–satya*, where pleasure, bodily well-being, and material utility are guided and harmonized by justice, resolution, and truth.

Consider a family's decision about food. Taste, bodily health, and cost all matter. Understanding also asks whether the food was obtained fairly, whether family members' genuine needs are met, and whether its production damages the conditions of future life. After acting, the family checks the result. A meal may be pleasant yet insufficiently nourishing, or inexpensive because someone else's labor was undervalued. Evaluation reveals what needs correction in the next decision.

This moral order reflects the cosmic order of nature. In the physical and ecological world, nature operates through law (*niyam*), regulation (*niyantran*), and balance (*santulan*) (MVD, pp. 70–71). Units maintain dynamic balance in mutuality within the all-pervasive ground. Law regulates activity and sustains balance. In human life, balanced living is expressed as justice, and just participation in the larger order as *dharma* or resolution. Realization in coexistence completes this understanding in truth (MVD, pp. 137, 174).

Humane conduct (*manaviyata purna acharan*) is structured into three concrete pillars (KD §3.4, p. 67; MVD, p. 35):

1. **Values (*Mulya*)**: Recognizing relationships, fulfilling established values (such as trust, respect, affection, care, and gratitude), evaluating the outcome, and achieving mutual satisfaction (*ubhay-trupti*).
2. **Character (*Charitra*)**: Righteous wealth acquired through productive labor (*swadhana*), fidelity in marital relationships (*swadari / swapurusha*), and compassionate behavior and work (*dayapurna karya-vyavahar*).
3. **Ethics (*Neeti*)**: The protection and right use of body, mind, and material resources across personal ethics (*dharma neeti*), economic ethics (*artha neeti*), and social/political governance (*rajya neeti*).
...
1. **Knowing (*Janna*)**: Directly comprehending the reality of units—their form, properties, essential nature, *dharma*, and coexistence in Omnipresence.
2. **Accepting / Believing (*Maanna*)**: Integrating what is known into firm conviction and acceptance, establishing it as the unwavering basis for thought and life.
3. **Recognizing (*Pahachanna*)**: Accurately identifying relationships, values, and responsibilities in every encounter.
4. **Fulfilling (*Nirvaha Karna*)**: Carrying out those recognized relationships and values through tangible conduct, work, and care.

This progression clarifies the essential difference among the orders of nature:

- In the **material and plant orders**, units recognize (*pahachanna*) and fulfill (*nirvaha karna*) chemical affinities and biological growth with complete certainty, governed by inherent natural laws.
- In the **animal order**, animals recognize and fulfill their interactions guided by bodily instinct and breed-conformance (*vanshanushangita*).
- In the **unawakened human**, a critical breakdown occurs: humans possess imagination and freedom of action, but attempt to accept beliefs (*maanna*) without knowing reality (*janna*). Living by unexamined assumptions, dogmas, and sensory conditioning leads to faulty recognition of relationships, unfulfilling actions, conflict, and suffering.
- In the **awakened human**, the chain is restored to its natural order: knowing (*janna*) grounds accepting (*maanna*), which ensures right recognition (*pahachanna*) and right fulfillment (*nirvaha karna*). The discipline of awakening is therefore stated as believing what is known, and knowing what is believed (*jo jana hai use manna, jo mana hai use janna*) (MVD, p. 12).

A proposal presented for examination (*prastav*) is distinct from acceptance grounded in realization. A student provisionally entertains the proposal to test it in reflection and practice; only when verified does it become firm conviction grounded in knowledge.

Activity conjoined with aspiration is karma, and every action produces definite consequences. Intentional activity is analyzed through the doer (*karta*), cause (*karan*), objective (*uddeshya*), result (*phal*), and final effect (*parinam*) (KD Ch. 1, pp. 2–4). An unawakened human is free when choosing an action, but becomes bound by its ensuing consequences (*karm karne me swatantra, phal bhogne me partantra*). An awakened human, understanding the lawful order and purpose of coexistence, chooses actions whose intent, values, and relational effects accord with reality; such a person remains free both in action and in experiencing the fruit (*phal bhogne me bhi swatantra*).

Consequences return to the knower through evaluation (*mulyankan*). In human relationships, justice is realized through a four-phase cycle (MVD, pp. 310–311; JV, p. 54):

Justice proceeds through recognition of relationship, fulfilment of its values, and evaluation, culminating in mutual satisfaction (*ubhay-trupti*).
...
- **Over-evaluation (*Adhimulyan*)**: Attributing greater capacity, value, or fulfillment than is actually present.
- **Under-evaluation (*Avamulyan*)**: Attributing less value or capacity than is actually present.
- **Mis-evaluation (*Nirmulyan*)**: Taking something to be other than what it is, as when a rope is mistaken for a snake. In human evaluation, a wrong criterion can similarly obscure what is being assessed—for example, treating wealth as evidence of humane character.

Accurate evaluation shows where understanding, skill, or resources were insufficient, allowing the knower to correct mistakes. What is learned guides the next action. Repeated evaluation, practice, and reflection cultivate *sanskar*: acceptances, understanding, and tendencies directed toward completeness, which guide subsequent thought and living (MVD, pp. 90, 187, 290). The texts distinguish this cultivation (*susanskar*) from tendencies shaped by delusion (*kusanskar*) (MVD, p. 315). *Sanskar* is not formed in isolation; it develops through interaction with family, teachers, cultural environment, and reflective labor. When a learner is guided by teachers who embody humane values, lived relationships provide tangible models for right recognition. Through sustained personal reflection and behavioral practice, unexamined assumptions and sensory conditioning are gradually replaced by convictions grounded in existential reality. False learning (*avidya* or *agyan*) is the failure to understand a reality's form, properties, essential nature, and *dharma* as they truly are (MVD, pp. 184, 263–264). True awakening requires consistency across knowing, believing, recognizing, fulfilling, and evaluating.

### 1.6 Evidence, study, and transmission

Madhyasth Darshan formulates its evidence chain as a living continuity (MVD, pp. 11–12):

> **“Realisation – Behaviour – Experiment. Realisation itself is the ultimate evidence, Evidence itself is the understanding or knowledge, Understanding itself is manifest, The manifest itself is resolution, work and behaviour, Work and behaviour itself is evidence, Evidence itself is awakened tradition, Awakened tradition itself is coexistence.”**
> — MVD, p. 12

This evidence operates across three inseparable levels (*tri-vidha pramana*) (MVD, pp. 11–12; SB, p. 44):

1. **Experiential Evidence (*Anubhavatmak Pramana*)**: Inward verification in *jeevan*—the unshakeable realization of coexistence, freedom from doubt, and the stable presence of resolution and peace.
...
For learners, the transition from delusion to awakening proceeds through three broad phases: study (*adhyayan*), experiment and practice (*prayog* and *abhyas*), and realization with evidence (*anubhav-praman*) (MVD, p. 88). This process distinguishes two stages of understanding (MVD, pp. 98–99):

- **Realization-oriented comprehension (*Anubhav-gami bodh*)**: The learner's stage, in which teaching by a guide who embodies understanding enables the student to reflect, attain direct apprehension (*sakshatkar*) of reality in *chitta*, and accept justice, *dharma*, and truth in *buddhi*.
- **Realization-based comprehension (*Anubhav-mulak bodh*)**: The awakened stage, in which realization of coexistence in *atma* flows outward into continuous resolve, contemplation, thought, behavior, and social transmission.

The educational relationship connects the teacher's living expression with the student's reflective inquiry (KD, pp. 112–113). The proposal is received through attentive listening and reading (*shravan*), followed by reflective inquiry (*manan*). The human thirst for understanding gives this inquiry its starting point (MVD, p. 88). Natural Acceptance (*sahaj swikriti*) here names this aspiration to understand and live harmoniously. The learner examines the proposal through reasoning, practice, and verification in living.

Verification requires threefold practice (*abhyas*) (MVD, pp. 143–144):

- **Literature-practice (*Shastra-abhyas*)**: Systematically studying definitions, principles, and holistic concepts to clarify meaning.
- **Behavioral practice (*Vyavahara-abhyas*)**: Applying justice and values in daily family and social relationships to verify mutual satisfaction.
...
What prevents realization is mystery (*rahasyata*)—the inability to understand, explain, or demonstrate reality (MVD, p. 209). Primary texts specifically define **intellectual mystery (*bauddhik rahasyata*)** as the internal misalignment and contradiction among the faculties of *jeevan*—when *mun* does not find refuge in *vritti*, *vritti* in *chitta*, or *chitta* in *buddhi* (MVD, p. 279). Intellectual mystery is resolved through exploration (*anushandhan*)—the original, inventive inquiry accomplished by Nagraj—and through systematic study, emulation, and practice (*adhyayan, anukaran, abhyas*) within an awakened tradition (MVD, pp. 279–282).

The commitment of Madhyasth Darshan is to universal knowability (*sarva-gyeyata*): the fundamental structure of coexistence, the conscious self, and humane conduct can be fully known, understood, lived, and taught without ontological mystery (MVD, p. 317). Universal knowability affirms that reality is orderly and accessible to human understanding; it does not claim omniscience over every contingent physical detail or future event.

On this account, whatever is called knowledge must become intelligible within the knower, directive in practical action, verifiable in relationships and nature, communicable to fellow humans, and in perfect harmony with the coexistence it reveals.
...
Later Advaita manuals commonly describe cognition through a modification of the internal organ (*antahkarana-vritti*) that takes the form of an object and is illumined by consciousness reflected in the mind (*chidabhasa*). The actionless witness (*sakshin*) does not perform an epistemic operation alongside perception or inference. It is that by whose presence the changing cognitions of the empirical subject are manifest. The seer–seen discrimination makes this distinction vivid: whatever can itself be observed cannot be the final witness.

> **“The form1... is perceived and the eye... is its perceiver... It... is perceived and the mind... is its perceiver. The mind with... modifications is perceived and the Witness (the Self) is verily the perceiver... But... is not perceived...”**
> — DDV, p. 15
...
The five-sheath analysis associated with the *Taittiriya Upanishad* (TU, 2.1–2.5), and developed explicitly as a method of discrimination in later works such as the *Vivekachudamani* (VC, vv. 154–212), similarly refuses to identify the Self with food-body, vitality, mind, intellect, or causal bliss. Madhyasth Darshan uses *kosha* terminology for manifestations across nature's orders and human awakening: material atoms already manifest *annamaya* and *pranamaya*, plants add *manomaya*, and animal living and human awakening express further *koshas* (MVD, pp. 49–50). This classification is distinct from the five faculties within *jeevan*. Shared vocabulary therefore does not establish a one-to-one correspondence with Advaita's five-sheath discrimination ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §5.7.2).
...
| Absolute (*paramartha*) | Brahman, not as an object opposed to a subject | Knower–known plurality is sublated |

At *vyavahara*, the world is not unreal in the way a hallucination is. It is the common field in which evidence, error, causal order, duty, and instruction operate. Its dependence is disclosed only relative to Brahman. Madhyasth Darshan rejects this final sublation: error is removable misidentification within a fully real coexistence, not an epistemic condition whose removal cancels the ultimate independence of plurality (§1.5).
...
| Upanishadic *shabda* | Reveals the otherwise unavailable identity of Self and Brahman | Does not turn Brahman into a perceptible object |
...
Madhyasth Darshan's *gyan* does not map neatly onto any one of these categories. It includes understanding of coexistence and the human being, realization by the knower, and confirmation in conduct (§§1.1–1.6). Analytic epistemology can ask whether its claims are true, warranted, reliably formed, communicable, and socially responsible, but it will not ordinarily define humane conduct as part of what makes a proposition known. Scientific method, meanwhile, is an institutional way of producing and correcting empirical knowledge; it belongs to §4 rather than serving as the definition of knowledge in analytic epistemology.
...
|---|---|---|
| **Perception** (incl. instruments) | Data acquisition from world and body | Theory-laden; does not directly observe non-physical *jeevan* |
...
| **Measurement and experiment** | Controlled test of predictions | **Experiment** here means hypothesis-testing and replication — not Madhyasth Darshan's wider verification in production and lived orderliness (§1.6) |
...
Madhyasth Darshan's evidence chain and scientific replication therefore overlap only partly. Both require claims to face consequence and correction. Science privileges methodologically reproducible observations; Madhyasth Darshan additionally requires coherence among realisation, behaviour, work, relationship, and transmission (§1.6). The latter is broader, but breadth does not automatically supply the controls against suggestion, authority, and confirmation bias that science has developed.
...
|---|---|---|---|---|
| **Knowledge** | Realised understanding of coexistence, *jeevan*, and humane conduct, internally established as resolution and expressed through wisdom, science, and living | Valid empirical cognition at *vyavahara*; liberating knowledge of Self–Brahman identity | Propositional warrant, reliable competence, understanding, lived disclosure, or social achievement | Models and explanations supported by observation, prediction, experiment, and replication |
| **Knower** | *Jeevan* as active sentient bearer; human joint form as embodied evidence | Embodied *jiva* is empirical knower; *sakshin* illumines cognition; separate knower is sublated at *paramartha* | Organism, embodied subject, socially constituted person, or consciousness, depending on theory | Operationally, the organism and its measurable brain, behaviour, reports, and environment |
| **Known** | Coexistence as object; made meaningful through awakened human and *jeevan* aspirations | Empirical plurality at *vyavahara*; Brahman alone at *paramartha* | Mind-independent reality, experience, concepts, or socially mediated objects, depending on theory | Publicly investigable physical, biological, and behavioural processes |
| **Method** | Study, reflection, practice, behaviour, experiment, evaluation, and transmission | *Shravana*, *manana*, *nididhyasana*, and contemplative discrimination | Argument, phenomenological description, conceptual analysis, testimony, and epistemic practice | Measurement, modelling, controlled experiment, prediction, replication, and review |
| **Practical regulation** | Cognisance regulates sensitivity, the four bodily propensities, and the three *eshanas* through justice, *dharma*, truth, and right use | Sense-restraint, ethical qualification, duty, and renunciation prepare and express liberating inquiry | Accounts range from self-regulation and virtue to embodied, social, and political practice | Homeostasis, behavioural control, health, and environmental sustainability are investigated descriptively and interventionally |
| **Validation** | Realisation and authenticity made evident in behaviour, work, relationship, mutual satisfaction, *upakar*, and teachable tradition | Empirical *pramanas* in their domains; Upanishadic *shabda* removes ignorance of identity | Justification, reliability, virtue, coherence, safety, or perspectival adequacy | Reproducible evidence and successful prediction under public methods |
| **Error** | Body–*jeevan* identification, incomplete faculty activity, false learning, and mis-evaluation | Superimposition and *anirvacaniya* error, sublated by knowledge | False belief, unreliable process, conceptual confusion, or situated distortion | Measurement error, bias, failed prediction, confounding, and non-replication |
| **World status** | Real and perpetual | Empirically valid but ultimately *mithya* | Realist, idealist, pragmatist, and anti-realist positions compete | Investigated as a stable public order; final metaphysics is not fixed by method alone |
| **Conduct** | Humane conduct is content and evidence of knowledge; wisdom identifies goals and science determines practicable direction | Ethical discipline prepares and expresses realisation at *vyavahara* | Ethics and epistemic virtue are related but normally distinct from possessing knowledge | Ethical purpose is not derivable from descriptive results alone |
| **Persistence** | *Jeevan* persists across bodily death; asserted and inferred, not scientifically measured | Self is eternal Brahman; separate *jiva* is ultimately unreal | Substance, bodily, psychological, narrative, and reductionist accounts compete | Personal continuity is ordinarily tied to continuing brain and organism function |
| **Goal** | Happiness, peace, contentment, and bliss; resolution, prosperity, fearlessness, and coexistence | *Moksha* through knowledge of non-duality | Truth, rational agency, understanding, flourishing, or intellectual virtue | Explanation, prediction, intervention, and corrigible public knowledge |

### 5.1 Key contrasts

The deepest ontological contrast is between perpetual plurality and non-dual dependence. Madhyasth Darshan holds Space and every material and sentient unit to be real in coexistence: *Brahma satya hai, jagat satat hai* — Brahma is truth, the world is perpetual (§1.1). Advaita grants the world empirical validity but denies it independent absolute reality. Science investigates a stable public order without, by method alone, deciding between every realist and anti-realist interpretation; it offers no evidence that physical spacetime is omnipresent knowledge.
...
|---|---|---|
| **Sat (Being)** | Brahman is independent reality; names and forms have dependent empirical reality. | Beingness (*astitva*) is coexistence of formless Omnipresence and countless real units. |
| **Chit (Consciousness)** | Self-revealing consciousness identical with Self and Brahman; empirical mind and objects are not independently conscious. | Omnipresence is pervasive knowledge or condition of intelligibility (§1.1), while active sentience (*chaitanya*) belongs to each *jeevan*. The concurrence of *atma* with Omnipresence in ultimate bliss (§1.2) relates a unit to the ground; it does not dissolve the unit. |
| **Ananda (Fullness or bliss)** | Limitless fullness of Brahman, not a passing mental pleasure. | Harmony realized within awakened *jeevan* and expressed as humane conduct. |
...
- Its linked triads connect perspective, realization, action, result, and evaluation; conduct therefore has genuine epistemic weight (§1.1).
...
- The knowledge–wisdom–science differentiation connects truth, human purpose, and practical direction, extending that direction to productive and ecological complementarity.
...
- The argument for the universal availability of knowledge (§1.1) grounds knowability in the equal conscious capacity of all *jeevans*; however, an equal innate capacity to cognize does not by itself establish that existence is completely knowable without remainder, nor does it guarantee that learners will successfully bridge historical, cultural, or individual obstacles to realization.
- Its account of *vigyan* is broader than natural science, but the claims it makes about production, health, ecology, and material process (§§1.1–1.2) remain answerable to physical evidence and are not established by the philosophy itself.
...
Madhyasth Darshan holds that the structure of coexistence, *jeevan*, and humane conduct can be understood without ontological mystery (§1.6). It does not follow that an awakened person knows every contingent fact. The system needs a clearer account of which claims are held with final certitude, which remain open to empirical correction, and how mistaken certainty would be diagnosed from within the method.

### 7.2 Conduct-evidence and public testability

Realisation, authenticity, behaviour, experiment, and transmission form Madhyasth Darshan's evidence regime (§1.6). Science requires operational and reproducible discrimination among competing explanations. Public evaluation of *jeevan* would require at minimum:
...
Post-death continuity of *jeevan* is inferred from its constitutional completeness (*gathan-purnata*)—the stable atomic constitution that neither admits nor expels constituent particles, rendering it free from molecular decomposition and weight-bondage (§§1.1–1.2). While internally consistent, this continuity is an inferential deduction rather than a third-person empirical measurement. Showing that an atomic structure ceases to exchange particles does not by itself empirically demonstrate that individual conscious memory, desire, or agency persists without biological substrate. Madhyasth Darshan's account of freedom from weight-bondage (*bhaar-bandhan-mukti*) and molecular-bondage (*anu-bandhan-mukti*) must therefore carry the argument, remaining an open point of contact with physics, mereology, and neuroscience ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §6.2.2).

### 7.5 Teacher, tradition, and circular validation

Madhyasth Darshan requires guidance from a realised human and treats successful conveyance as evidence (§1.6). This creates a productive second-person discipline but also a circularity risk: the teacher may be recognised as realised through the doctrine, while the doctrine is trusted through the teacher. The tradition needs explicit safeguards for disagreement, failed transmission, authority error, and correction of a respected teacher.
...
| ***Gyan* (Knowledge)** | Names the actionless pervasive ground, coexistence as intelligible reality, and its realized understanding by *jeevan*, with the referent specified by context (§1.1). |
| ***Astitva Darshan Gyan*** | Knowledge of existence as coexistence of Omnipresence (*vyapak satta*) and units (*ikai*) across four orders (§1.1). |
| ***Jeevan Gyan*** | Knowledge of the conscious unit (*jeevan*), its faculties, ten activities, and potential for awakening (§1.1). |
| ***Manaviyata Purna Acharan Gyan*** | Knowledge of humane conduct, including values, character, ethics, and universal orderliness (§1.1). |
| ***Vastugat Satya*** | Objective / inherent truth: the reality of each unit's form (*roop*), properties (*guna*), essential nature (*svabhav*), and *dharma* (§1.1). |
| ***Vastu-sthiti Satya*** | Positional / relational truth: units in space, time, direction, orderliness, and mutual complementariness (§1.1). |
| ***Sthiti Satya*** | Existential truth: nature (sentient and insentient units) saturated in all-pervasive Omnipresence (*vyapak satta*), which is coexistence itself, unaffected by time (§1.1). |
| ***Anubhav jnan* (Realisation Knowledge)** | Saturated insentient and sentient nature, whose units have form, properties, essential nature, *dharma*, and orderliness (MVD, p. 11; §1.1). |
...
| ***Samadhan* (Resolution)** | Realised knowledge established as freedom from contradiction, with correct answers to why and how for activity; also grouped with the three *eshanas* in intellectual satisfaction (§§1.2 and 1.4). |
| ***Gyan–vivek–vigyan*** | Knowledge of coexistence, *jeevan*, and humane conduct; wisdom that recognises the human goal; and science that determines direction for material prosperity and the human and *jeevan* goals (§1.2). |
| **Knowledge–knower–known** | Knowledge of coexistence, *jeevan*, and humane conduct; *jeevan* as bearer of knowing; coexistence as object made meaningful in awakened living (§1.1). |
| ***Darshan–drish–drishya / drishti*** | *Darshan* is assigned to justice, *dharma*, and truth, *drish* to human *jeevan*, and *drishya* to coexistence; awakened *jeevan* is the seer and *darshan* the meaningful exposition. *Drishti* names perspective (KD §3.17, pp. 145–150; MVD, p. 84; §1.1). |
| ***Dhyan–dhyata–dhyeya*** | The attention structure: awakening, the human attender, and freedom from delusion together with the *jeevan* values and evidence of the human goal (KD §3.17, pp. 145–150; §1.1). |
| ***Karan–karta–karya*** | Cause–doer–effect at two levels: knowledge-state–human–universal participation, and coexistence–*jeevan*–awakened human status (KD §3.17, pp. 145–150; §1.1). |
| ***Sadhya–sadhak–sadhan*** | Awakening or seer-status as aim, the human being as seeker, and body together with *jeevan* as means; tradition, imagination, and freedom of action support those means (KD §3.17, pp. 145–150; §1.1). |
| ***Sapekshata* (Relativity)** | Differentiation among perspective, observed scene, and worldview; in this context, the changing relativity of sensory, bodily, and material criteria rather than unreality of coexistence (§1.4). |
| **Six evaluative perspectives** | *Priya–apriya* concerns sensory pleasantness, *hita–ahita* bodily well-being, *labha–alabha* material gain, *nyaya–anyaya* relationship and behaviour, *dharma–adharma* resolution and orderly participation, and *satya–asatya* realisation in existence (§1.4). |
| **Five forces / five powers** | Five activities of state and five of motion express the coordinated faculties. Hope, thought, desire, truth-resolve (*ritambhara*), and evidence (*praman*) are the characteristic powers; selection, analysis, visualisation, resolve, and authenticity are their outward activities (KD §3.6, pp. 70–71; KD §3.16, p. 145; SB, p. 63; §1.3). |
| ***Madhyasthata* (Mediativeness)** | The central, non-partisan situation of *atma* by which the mediative activity attains the touch of knowledge in every dimension, evidenced only through integrality of behaviour and thought (MVD, p. 211; §1.3). |
| ***Purvanukram* / *Paranukram*** | Higher-conformance (*purvanukram*, पूर्वानुक्रम): governance of *mun* by inspiration from *vritti*, *chitta*, *buddhi*, and *atma*, aligned with justice. Lower-conformance (*paranukram*, परानुक्रम): pressure from *prana*, senses, body, and conditioning (MVD, pp. 207–208; §1.3). |
| ***Manah-swasthata* (Mental well-being)** | The realisation of happiness, peace, contentment, and bliss in the state of higher-conformance (MVD, p. 208; §1.2). |
| ***Sanvedansheelta* / *sangyansheelta*** | Sensitivity through the body and senses, and cognisance through *jeevan*'s knowing and accepting. Cognisance regulates sensitivity (§1.3). |
| **Four *vishayas*** | Food, rest, defense, and procreation: bodily propensities retained in the human joint form and regulated rather than treated as the source of *jeevan*'s happiness (§1.4). |
| **Five sensory modalities** | Sound, touch, visible form, taste, and smell: bodily interfaces through which the four *vishayas* are engaged (§1.4; Editorial Notes). |
| **Three *eshanas*** | Progeny, wealth, and public-recognition motives, defined through family and society, prosperity and right use, and undivided society or universal orderliness (§1.4). |
| ***Niyam–niyantran–santulan*** | Law protecting and disciplining activity, regulation according to law, and the balance it sustains; connected to justice, *dharma*, and truth as a functional progression (§1.4; Editorial Notes). |
| ***Nyaya* / *ubhay-trupti*** | Justice as relationship-recognition, value-fulfilment, evaluation, and mutual satisfaction, of which mutual satisfaction is the relational outcome (§§1.4–1.5; Editorial Notes). |
| **Humane conduct (value, character, ethics)** | The third content of knowledge: relationship value with evaluation and mutual satisfaction; character as fidelity and compassionate conduct; ethics as protection and right use of body, mind, and wealth (KD §3.4, p. 67; MVD, p. 35; §§1.1 and 1.4). |
| ***Janna–maanna–pahachanna–nirvaha*** | The integrated fourfold cognitive-action progression: knowing, accepting, recognizing, and fulfilling (§1.5). |
| ***Adhimulyan, avamulyan, nirmulyan*** | Over-evaluation, under-evaluation, and mis-evaluation: attributing more, less, or a different identity than what is present (MVD, pp. 152, 306; §1.5). |
| ***Samyak-mulyankan*** | Right / accurate evaluation of capacity, relationship, and result as they truly are (§1.5). |
| ***Upakar* (Beneficence)** | Help and inspiration for prosperity and awakening, as the higher-human application of resolved capacity (§1.4; Editorial Notes). |
| ***Pramana*** | Means or proof of valid knowledge; in Madhyasth Darshan, realization (*anubhav*) evidenced in living conduct is the ultimate proof (§1.6). |
| ***Tri-vidha Pramana*** | Threefold evidence: experiential (*anubhavatmak*), behavioral (*vyavaharatmak*), and experimental/practical (*prayogatmak*) (§1.6). |
| ***Pramanikta* (Authenticity)** | The realisation-bearing activity of *atma* that becomes publicly evident through conduct, teaching, and humane tradition (§1.6). |
| ***Pratyaksha–anuman–agama*** | Apprehension through direct perception (realization of continuous proximity), inference (recognizing the possibility of continuity), and testimony-activity (*agama-kriya*, apprehending existence beyond immediate proximity) (KD, pp. 20–21; §1.6). |
| ***Adhyayan / Abhyas*** | Systematic study through proposal (*prastav*), hearing (*shravan*), reflection (*manan*), and threefold practice (*shastra-abhyas, vyavahara-abhyas, karma-abhyas*) (MVD, pp. 88, 143–144; §1.6). |
| ***Anubhav-gami / anubhav-mulak bodh*** | Realization-oriented comprehension (accepted in *buddhi* following direct apprehension in *chitta* through study) and realization-based comprehension (the awakened stage where realization in *atma* guides thought and living) (MVD, pp. 98–99; §1.6). |
| ***Sahaj Swikriti* (Natural Acceptance)** | Here, the aspiration toward understanding and harmonious living that motivates inquiry. The proposal is examined through reasoning, practice, and evidence (MVD, p. 88; §1.6 and Editorial Notes). |
| ***Pratyavartan / Paravartan*** | Inward reflection toward realization, and outward projection into thought, speech, behavior, and work (§1.3). |
| ***Gathan-, kriya-, acharan-purnata*** | The three completions: constitutional completeness (*jeevan*, non-decaying atomic constitution with no addition or loss of particles), activity completeness (awakening of all ten activities), and conduct completeness (living evidence in values, character, and ethics) (JV, p. 36; §1.2). |
| ***Ritambhara*** | Truth-bearing resolve (*sankalpa*) at *buddhi*, projecting existential understanding into living (§1.3). |
| **Seer–doer–enjoyer** | Understanding, action, and fruition unified in the awakened human joint form (KD §3.18, pp. 151–152; §1.1). |
| ***Bhram*** | Delusion — living by inherited belief rather than understanding, rooted in identifying *jeevan* with the body. |
| ***Rahasyata* (Mysteriousness)** | Incapacity to attain, evidence, or impart complete understanding (§1.6). |
| ***Bauddhik rahasyata* (Intellectual mystery)** | Internal misalignment and contradiction among the faculties of *jeevan* (*mun* not in refuge of *vritti*, *vritti* not in *chitta*, *chitta* not in *buddhi*), resolved through exploration and study (MVD, pp. 279–282; §1.6). |
| ***Anushandhan* (Exploration)** | Inventive comprehensive study from decline through development and awakening to Omnipresence (MVD, Ch. 17; §1.6). |
...
| ***Drishta-pad* (Seer status)** | The unique capacity of the human being in existence to observe, understand, and evaluate all orders of nature (§1.1). |
...
| ***Sanskar-anushangita*** | Conformance to understanding and sanskar, the distinctive law of the human knowledge order (§1.2). |
...
| ***Jeevan* aspiration** | Happiness, peace, contentment, and bliss as harmonies of *jeevan*; Supreme Bliss (*paramanand*) in concurrence with Omnipresence (MVD, pp. 208, 327; §1.2). |
...
| ***Pramatr–pramana–prameya–prama*** | Empirical knower, means of valid cognition, known object, and resulting valid cognition; this structure operates at *vyavahara* (§§2.1 and 2.6). |
...
| **Hard Problem** | Why physical brain processes are accompanied by subjective experience — a modern open question, not the same as Madhyasth Darshan's *rahasyata* (§1.6; §3.4). |
...
### The contents of complete knowledge

Complete knowledge is enumerated with four constituents at KD §3.5, p. 69 — existence as coexistence, *jeevan*, humane conduct, and participation in overall orderliness — and with three at KD, p. 30, KD §3.17, p. 148, and JV, p. 40, where participation is not listed separately. This study presents the three primary domains and treats participation as the living field in which all three are manifest and evidenced, rather than as an isolated fourth object of knowledge. Nothing in the exposition of §1 depends on which enumeration is preferred.

### The Threefold Truth (*Vastugat, Vastu-sthiti, Sthiti Satya*)

The definitions of the three truths follow the official Hindi compilation *Yatharthata, Vastavikta, Satyata* (YAT), under the headings “स्थिति सत्य,” “वस्तुगत सत्य,” and “वस्तु स्थिति सत्य.” The page attributes its excerpts to *Paribhasha Sanhita* and other writings. *Sthiti Satya* is existential reality unaffected by time: nature saturated in all-pervasive Omnipresence. *Vastugat Satya* is the inherent reality of each unit's form, properties, essential nature, and *dharma*. *Vastu-sthiti Satya* concerns direction, time, and place. The ecological and mutual-complementarity explanation in §1.1 places this positional definition within the account of coexistence (SB, pp. 111, 121, 149). MVD pp. 88 and 97 provide connected support for how these truths are studied, understood, and realized.

### The Study Methodology and Natural Acceptance

The transition from delusion to awakening is structured through three broad phases: study (*adhyayan*), experiment and practice (*prayog* and *abhyas*), and realization with evidence (*anubhav-praman*) (MVD, p. 88). Primary texts distinguish realization-oriented comprehension (*anubhav-gami bodh*), where a student reflects on the proposal, directly apprehends reality in *chitta*, and accepts it in *buddhi*, from realization-based comprehension (*anubhav-mulak bodh*), where realization in *atma* directs subsequent resolve, contemplation, thought, and conduct (MVD, pp. 98–99; KD, pp. 112–113). Practice is threefold: literature-practice (*shastra-abhyas*), behavior-practice (*vyavahara-abhyas*), and work-practice (*karma-abhyas*) (MVD, pp. 143–144). This study uses “Natural Acceptance” (*sahaj swikriti*) as an explanatory phrase for the human aspiration toward understanding and harmonious living, taking the universal thirst for understanding in MVD p. 88 as the starting point for inquiry. It does not introduce an additional source of proof alongside realization, behavior, and experiment; the learner examines the proposal through reasoning, practice, and evidence (§1.6).

### Fields of conduct and the contents of knowledge

The four *vishayas*, the five sensory modalities, the three *eshanas*, and *upakar* identify where knowledge of humane conduct becomes operational (§1.4). They are not further objects of knowledge on the level of coexistence and *jeevan*, and the four propensities and five modalities are not nine independent activities: the four name the propensity being served, the five the mode of bodily contact through which it is engaged. *Upakar* is likewise not a fourth *eshana*, and mutual satisfaction (*ubhay-trupti*) is the relational outcome of justice rather than a fifth *jeevan* value.

### "Five sensory modalities" rather than "five *samvedanas*"

*Samvedana* is used broadly in the sources for sensing, for knowledge of the cognitive and work organs, and for a tendency toward development (MVD, p. 313). No stable five-member category of *samvedanas* parallels the four *vishayas*, so this study uses "five sensory modalities" as its running term for sound, touch, visible form, taste, and smell (MVD, p. 65).

### *Niyam–niyantran–santulan* and *nyaya–dharma–satya*

The sequence at MVD, p. 174 runs from knowledge through law, regulation, and balance to justice, *dharma*, and truth, while MVD, p. 137 states that behaviour is regulated through justice, thought is disciplined through *dharma*, realisation occurs through truth, and regulation proceeds through law. This study reads the relation between the two triads as a functional progression, not as three term-by-term equations of *niyam* with *nyaya*, *niyantran* with *dharma*, and *santulan* with *satya* (§1.4).

### Seer in the two triads

*Drish* in *darshan–drish–drishya* (KD §3.17, pp. 145–150) names the seeing capacity of human *jeevan*; the seer in seer–doer–enjoyer (KD §3.18, pp. 151–152) names established seer-status (*drishta-pad*). The study keeps the two senses distinct (§1.1).

### Faculty activities and their translations

This study uses *visualisation* for *chitran*, the activity of *chitta*, and *reflection* for *pratyavartan*, the inward direction of knowing. *Imaging* translates *pratibimban*, the independent unit's presence in mutual facing, as explained in the ontology. These terms distinguish what becomes manifest from the knower's activities of apprehending and expressing its meaning (§1.3).

The receptive activity of *chitta* is contemplation (*chintan*), through which direct apprehension (*sakshatkar*) occurs. *Comprehension* is the running term for *bodh* at *buddhi*. MVD's English translation uses “direct recognition” and “enlightenment” for these terms at p. 126; quotations retain that wording. Ordinary *understanding* remains available for the broader achievement of knowing and living coherently.
...
- **YAT** — Nagraj, A. [“Yatharthata, Vastavikta, Satyata” (यथार्थता वास्तविकता सत्यता)](https://originals.madhyasth.org/avdharna/yatharth). *Madhyasth Darshan Authentic Site*, Divya Path Sansthan. Hindi compilation of excerpts attributed on the page to *Paribhasha Sanhita* and other writings. Cited: the definitions under “स्थिति सत्य,” “वस्तुगत सत्य,” and “वस्तु स्थिति सत्य” (§1.1 and Editorial Notes).
- **MVD** — Nagraj, A. [*Madhyasth Darshan – Co-existentialism*, Part 1: *Holistic View of Human Behaviour*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: all units in Omnipresence and Realisation Knowledge as saturated nature (p. 11; §1.1); the evidence chain, quoted in §1.6, and the knowing-and-believing discipline (pp. 11–12; §§1.5–1.6); the world as perpetual (pp. 12–13; §1.1); the four registers of the omnipresent ground and the definition of resolution (p. 34; §§1.1–1.2); Space as knowledge, knowledge as neither activity nor performing activity, and knowledge-unfolding (pp. 34–35; §§1.1, 1.4, 1.6); kosha manifestations across the orders and awakening (pp. 49–50; §2.1); four bodily propensities (p. 58; §1.4); relationship and fulfillment definitions (pp. 61–62; §1.5); sensory and intellectual satisfaction and the three *eshanas* (pp. 64–65; §1.4); six evaluative perspectives (pp. 66–67; §1.4); law and the activities of thought (pp. 70–71; §1.4); *upakar* as help and inspiration for prosperity and awakening (p. 73; §1.4); *medhas*, the *jeevan* activities, and signal transmission (p. 83; §1.3); reasoning in study, three broad phases, and three truths (p. 88; §§1.1, 1.6); *sanskar* definition (p. 90; §1.5); knowing reality as it is, coexistence as ultimate truth, and study of verity (p. 97; §§1.1, 1.6); practice, *anubhav-gami bodh*, *anubhav-mulak bodh*, teacher and learner (pp. 98–99; §1.6); the universality argument for knowledge and "Realisation in coexistence" (pp. 115–116; §1.1); balanced and unbalanced deliberation (pp. 126–127; §1.4), with the translation of *sakshatkar* and *bodh* (p. 126; Editorial Notes); regulation through justice, *dharma*, truth, and law (p. 137; §1.4); threefold practice of *shastra*, *vyavahara*, and *karma* (pp. 143–144; §1.6); over-, under-, and mis-evaluation (pp. 152, 306; §1.5 and Editorial Notes); *vivek* and *vigyan* definitions (p. 170; §1.2); the sequence from knowledge through law, regulation, balance, justice, *dharma*, and truth (p. 174; §1.4); false learning (p. 184; §1.5); *sanskar* and environment (p. 187; §1.5); the brain and cognitive-organ signal pathway (p. 200; §1.3); higher- and lower-conformance (*purvanukram* and *paranukram*), the four *jeevan* values, and mental well-being (pp. 207–208; §§1.2–1.3); mystery and its removal by holistic view (p. 209; §1.6); relativity in differentiated seeing (p. 210; §1.4); mediativeness of *atma* (p. 211; §1.3); the permanence contrast between the two sets of perspectives (p. 212; §1.4); doubt and distorted evaluation (pp. 263–264; §1.5); Ch. 17 *Rahasy-mukti* — mystery, intellectual mystery (*bauddhik rahasyata*), exploration, study, and an awakened tradition (pp. 273–285; §1.6); knowledge unfolding through *jeevan*/thought (p. 289; §1.1); the awakening–*sanskar* cycle (p. 290; §1.6); justice, mutual satisfaction, and resolution (pp. 310–311; §§1.2 and 1.5); definition of resolution (p. 312; §1.2); *samvedana* usages (p. 313; Editorial Notes); *susanskar* and *kusanskar* (p. 315; §1.5); knowability and absence of delusion (p. 317; §1.6); and *atma*–Omnipresence concurrence and ultimate bliss (p. 327; §1.2).
- **KD** — Nagraj, A. *Manav Karm Darshan* (Madhyasth Darshan, Part 2). [Working English translation](../References/Madhyasth-Darshan/KD-Karm-Darshan-English/KD-Karm-Darshan-English.pdf); [Hindi–English review edition](../References/Madhyasth-Darshan/KD-Karm-Darshan-English/KD-Karm-Darshan-Hindi-English.pdf). Cited by paraphrase: autobiographical *Alternative* (points 1, 5, 10, and 11), including the founding questions on Brahma and the world and on what counts as evidence (§1.6); action, desire, result, and the reinterpreted human ends (Ch. 1, pp. 2–4; §§1.1–1.2 and 1.5); direct perception, inference, and testimony-activity (*agama-kriya*) (pp. 20–21; §1.6); the three-constituent statement of knowledge (p. 30; Editorial Notes); humane conduct as value, character, and ethics (§3.4, p. 67; §1.4); four contents of complete knowledge (§3.5, p. 69; §1.1 and Editorial Notes); five activities of state and five of motion as force and power (§3.6, pp. 70–71; §1.3); *jeevan* expressing hope, thought, desire, resoluteness, and evidence (p. 65; §1.3); the relation between the human goal and the *jeevan* values (p. 112; §1.2); teacher's expression and student's reflection (pp. 112–113; §1.6); projection–reflection (§§3.12, 3.16–3.17; §1.3); body–*jeevan* dependence and the projected activities in the *medhas* setting (§3.16, pp. 141, 143, 145; §1.3); the knowledge–knower–known argument, the known as awakened meaning, ten activities, and the knowledge, attention, cause, and aim triads (§3.17, pp. 145–150; §§1.1 and 1.3); and seer–doer–enjoyer (§3.18, pp. 151–152; §1.1). The English text is a working translation; quoted formulations should be checked against the Hindi.
- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (*Resolution Centred Materialism*)](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta. Cited: evidence through experimentation, behaviour, and experience (p. 44; §1.6); faculties, their characteristic powers, and projection/reflection activities (p. 63; §1.3); balance of cognisance and sensitivity (p. 64; §1.3); material and ecological complementarity and cyclic economic participation (pp. 111, 121, 149; §1.1); and threefold knowledge (p. 116; §1.1).
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf). English translation by Rakesh Gupta. References cite original printed page numbers. Cited: birth, death, and *jeevan* continuity (p. 19; §1.1); proof by conveying understanding (p. 25; §1.6); equal potential and *jeevan* as basis of equality (pp. 33–34; §1.1); constitutional completeness as absence of addition or expulsion of particles (p. 36; §§1.1–1.2); three areas of understanding (p. 40; §1.1); equal capacity to understand existence and evidence coexistence (p. 44; §1.1); recognition, fulfilment, evaluation, and mutual satisfaction in justice (p. 54; §1.5); the human goal (pp. 60, 165; §1.2); ten activities and the four-and-a-half activities effective in delusion (pp. 72–74, 91, 92–93; §1.3); the root of delusion and the governance of pleasure, health, and profit by justice, *dharma*, and truth (pp. 93–98, 139; §1.4); the four *jeevan* values (p. 137; §1.2); and the fourfold cognitive progression (p. 165; §1.5).
...
- **Chalmers 1995** — Chalmers, D. ["Facing Up to the Problem of Consciousness."](../References/Science/Chalmers-1995-Facing-Up-to-the-Problem-of-Consciousness.pdf) *Journal of Consciousness Studies*, 2(3), 200–219. Cited: hard problem of experience (§3.4).
...
- **Fricker 2007** — Fricker, M. [*Epistemic Injustice: Power and the Ethics of Knowing*](https://academic.oup.com/book/32817). Oxford University Press. Cited: testimonial and social conditions of knowing (§3.1).
- **Gettier 1963** — Gettier, E. L. ["Is Justified True Belief Knowledge?"](https://doi.org/10.1093/analys/23.6.121) *Analysis*, 23(6), 121–123.
- **Goldman 1979** — Goldman, A. I. ["What Is Justified Belief?"](https://doi.org/10.2307/2025679) In G. Pappas (ed.), *Justification and Knowledge*, 1–23. Cited: process reliabilism (§3.1).
...
- **Limanowski and Blankenburg 2013** — Limanowski, J., and Blankenburg, F. ["Minimal self-models and the free energy principle."](https://analyticmadhyasthdarshan.org/References/Modern-Philosophy/Limanowski-Blankenburg-2013-Minimal-Self-Models-Free-Energy-Principle.pdf) *Frontiers in Human Neuroscience*, 7. https://doi.org/10.3389/fnhum.2013.00547
- **Massimi 2022** — Massimi, M. [*Perspectival Realism*.](https://global.oup.com/academic/product/perspectival-realism-9780197555620) Oxford University Press. Cited: science as view from somewhere (§3.7).
- **Melloni et al. 2025** — Melloni, L., et al. ["Adversarial testing of global neuronal workspace and integrated information theories of consciousness."](https://analyticmadhyasthdarshan.org/References/Modern-Philosophy/Melloni-et-al-2025-Adversarial-Testing-Consciousness-Theories.pdf) *Nature*. https://doi.org/10.1038/s41586-025-08888-1. Cited: IIT vs GNWT adversarial test (§4.3).
- **Nagel 1974** — Nagel, T. ["What Is It Like to Be a Bat?"](../References/Science/Nagel-1974-What-Is-It-Like-to-Be-a-Bat.pdf) *The Philosophical Review*, 83(4), 435–450. Cited: first-person experience as datum (§3.4).
- **Parfit 1984** — Parfit, D. [*Reasons and Persons*](https://global.oup.com/academic/product/reasons-and-persons-9780198249085). Oxford University Press. Cited: personal identity reductionism (§3.6).
...
- **Popper 1959** — Popper, K. [*The Logic of Scientific Discovery*](https://www.routledge.com/The-Logic-of-Scientific-Discovery/Popper/p/book/9780415278447). Hutchinson / Routledge. Cited: hypothesis-testing and public criticism (§4.1).
- **SEP Personal Identity** — Olson, E. ["Personal Identity."](https://plato.stanford.edu/entries/identity-personal/) *Stanford Encyclopedia of Philosophy*. Cited: Locke, Parfit, and substance views (§3.6).
- **SEP Phenomenology** — Smith, D. W. ["Phenomenology."](https://plato.stanford.edu/entries/phenomenology/) *Stanford Encyclopedia of Philosophy*. Cited: Husserl, intentionality, and embodied phenomenology (§3.7).
- **Sosa 2007** — Sosa, E. [*A Virtue Epistemology: Apt Belief and Reflective Knowledge, Volume I*](https://academic.oup.com/book/32531). Oxford University Press. Cited: knowledge as attributable intellectual success (§3.1).
- **Strawson 2006** — Strawson, G. ["Realistic Monism: Why Physicalism Entails Panpsychism."](../References/Science/Strawson-2006-Realistic-Monism-Panpsychism.pdf) *Journal of Consciousness Studies*, 13(10–11), 3–31. Cited: Russellian monism and panpsychism (§3.4).
- **Tufft et al. 2024** — Tufft, M. R. A., et al. ["Forgetting ourselves in flow: an active inference account of flow states and how we experience ourselves within them."](https://analyticmadhyasthdarshan.org/References/Modern-Philosophy/Tufft-et-al-2024-Flow-Active-Inference.pdf) *Frontiers in Psychology*, 15. https://doi.org/10.3389/fpsyg.2024.1354719
