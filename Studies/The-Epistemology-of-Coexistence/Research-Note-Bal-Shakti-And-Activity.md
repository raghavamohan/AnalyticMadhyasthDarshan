...
How the motion member stands to its state member is not uniform across the 61, and no consulted passage states a general rule. *Buddhi*'s two pairs set an acceptance against a readiness for projection, which is the relation the sources make explicit. Elsewhere the pair joins a capacity to what it bears, as *medha* bears *kala* (MVD, p. 324); an inner condition to its outward evidence, as satiation stands to its dissemination in human tradition (MVD, p. 339); an act to its object, as inspection stands to properties (MVD, pp. 330–331); a relationship to the value fulfilled in it, which covers ten of *mun*'s pairs from mother and nurturing to disciple and inquiry (MVD, pp. 341–347); and a received sensory quality to the bodily function it serves, which covers the remaining ten (MVD, pp. 347–348). Reading every pair as state followed by outward projection therefore describes *buddhi* and the evidencing pairs but misdescribes the relational and sensory groups, which are twenty of *mun*'s thirty-two. The relation is catalogued pair by pair in [*The Sixty-One Activity Pairs of Jeevan*](Research-Note-Activity-Pair-Inventory.md).
...
- **The relation within a pair is not one relation.** State followed by outward projection is explicit at *buddhi* and fits the evidencing pairs, but the relational and sensory groups of *mun* join a relationship to its value and a received quality to its bodily function instead (§9.2).
...
- [*Research Note: The Sixty-One Activity Pairs of Jeevan*](Research-Note-Activity-Pair-Inventory.md), the pair-by-pair inventory behind §9, with the *bal* and *shakti* member of each pair, the definitional evidence, and the relation families.
