...
**Edited on:** August 12, 2026, 9:42 PM IST
...
**Scope:** This note reads the activity architecture of *jeevan* as a qualitative, hierarchical, closed-loop control system. *Satta* is Knowledge rather than an acting controller. *Jeevan* is the sentient regulator; *bal* names its established state activities, *shakti* their motion and projection, and the body their temporary medium of expression and feedback.

The exposition follows the strata the primary texts themselves set out: *jeevan* as one constitutionally complete atom, its five faculties, the ten activities that pair a state with a motion in each faculty, the 122 detailed activities into which those ten are refined, and the six activities of the sentient aspect that cut across all of them. Where the control reading requires machinery the sources do not supply—typed spaces, composed operators, gating predicates, an inquiry protocol—that machinery is gathered in Appendix A rather than woven through the exposition. The body can be read without the appendix, and the appendix can be rejected without disturbing the body.

Two axes organise the model. *Bal* and *shakti* are state and motion within each faculty; state activities are strengths and motion activities powers (JV, pp. 40, 62; MVD, pp. 131, 323; SB, p. 139). Projection and reflection are directions in which the ordered faculties are traversed—outward from *atma* toward *mun* and the body, and inward from the body and *mun* toward *atma*. Their combined form is *avartan*, the awakened *jeevan* cycle (MVD, p. 275; §1). Strength and power are also used at a coarser grain, where the five faculties themselves are the strengths and hope, thought, desire, resoluteness, and evidence the powers; the two grains are given together in one place (AVD, pp. 91, 151), and the Editorial Notes set out how they fit.
...
The controlled objective is not the maximisation of any one value. Bliss, contentment, peace, and happiness are one immersion arising from realisation and named at four levels of *jeevan*. Where that immersion is absent, discord among the faculties produces frustration and the thirst for restfulness, and the pursuit of restfulness is what drives the loop (§3). *Saturation* is the ontological bond through which the Knowledge to be known is available to *atma*, while coupling with the body is carried by named activities: *prana* joins the gross body to the subtle and *chitta* the subtle to the causal (§2.1). This is an interpretive functional model. It does not reduce *jeevan* to a computer, the faculties to brain regions, *sanskar* to a database, or qualitative activity to numerical variables.
...
The solid boundary encloses *jeevan*: its five-faculty state established as *bal*, and its motion as *shakti*, which is set outward in projection and inward in *antarniyaman*. *Satta* supplies the reality-reference without acting on the controller. *Prana*, the heart, *medhas*, and the body belong to the temporary embodied interface, while body, relationship, work, society, and nature form the field in which projection produces consequences. Feedback crosses the interface, but it does not itself become internal content: it occasions the inquiry that is borne inward (§6.4).
...
*Shakti* holds no second state, but it does have a direction, and the direction is regulated rather than fixed. Set outward, it carries the established organisation into authenticity, resolve, image or plan, analysis, and selection. Set inward through *antarniyaman*, it produces in a faculty the capacity to receive the signal of the faculty inward of it—the ability to receive higher-conformance signals arises solely through the internal regulation of *jeevan*'s powers (MVD, p. 284). Where a unit's powers flow outward alone, decline is apparent; where they are turned inward, development is apparent, inward deployment being drawing conclusions through reflection, inspection, and examination in self, and then evidencing them (MVD, p. 91). This gives reflection a mechanism of its own rather than leaving it as projection reversed.
...
```mermaid
flowchart TD
    J1["Jeevan with carried sanskar"]
    B1["Coupling with body n<br/>medhas, senses, bodily capacities"]
    L1["Embodied projection and reflection<br/>behaviour, result, evaluation, learning"]
    D1["Death of body n<br/>bodily coupling and feedback end"]
    J2["The same jeevan remains<br/>with its carried organisation"]
    B2["Coupling with a later body<br/>a new embodied interface"]
    O2["Later behaviour<br/>manifests carried and present organisation"]

    J1 --> B1 --> L1 --> D1
    D1 -->|"jeevan and sanskar persist"| J2
    J2 --> B2 --> O2
```
...
![Intrinsic projection-reflection within jeevan and the conditional embodied branch](Figure-Jeevan-Intrinsic-And-Embodied-Loops.svg)

The diagram separates two coupled recurrences. The intrinsic loop, *avartan*, belongs to *jeevan*: projection and reflection continue among the five faculties, and recurrence without bodily execution is attested at its shallowest, where the union of *vritti* and *mun* alone yields dreams, "imaginations that do not become evident in work and behaviour" (MVD, p. 279; §8). The embodied branch begins when a selection is made available to *medhas* and the body; its consequences can then occasion further inquiry within the intrinsic reflective movement. *Jeevan* remains the persistent controller, while *medhas* and the body are the present interface. The twelve practical knowledge domains constitute governing content within *sanskar* rather than additional signal blocks, and the diagram in §4.3 places the embodied branch within the longer continuity across bodily couplings.

The two directions are not mirror images, and a control abstraction has to preserve the asymmetry. *Sanket*, signal, is the vocabulary of the inner-to-outer direction: each faculty develops completely by accepting the signals of the faculty inward of it. What moves outer-to-inner is named differently—inquiry, as *jigyasa*, *kautuhal*, or *prashna*—and its arrival at an inner faculty is described as effect and immersion rather than as signal reception. Treating reflection as projection run backwards, with the same content interpreted at each stage in reverse, would import a symmetry the sources do not have.

### 6.1 The six activities of the sentient aspect

Sensing, enquiring, protecting, enlightening, adhering, and reflecting are specialties of the sentient aspect that are not found in the insentient (MVD, p. 313). They belong to sentience as such rather than to any particular faculty, which is a different axis of classification from the faculty-indexed enumeration of §9.

| Activity | Definition (MVD, pp. 313–314) |
|---|---|
| *Samvedan*, sensing | Knowledge of the five cognitive organs and the five work organs; also the tendency for development |
| *Samvahan*, enquiring | The act of bearing inquiries for knowledge of completeness |
| *Sanrakshan*, protecting | Paving the way towards development |
| *Sambodhan*, enlightening | Imparting knowledge and understanding of reality |
| *Samvartan*, adhering | The act of following the received signals towards refinement and completeness |
| *Pratyavartan*, reflecting | Movement of awakening |

These six give the loop its content without recourse to a sensor-and-actuator scheme. What travels inward is an inquiry raised toward completeness, not a measurement; what travels outward is the understanding of reality, not a command. Adherence is the outer faculty's own activity upon what it has received, which is why receiving a signal and being changed by it are distinct events in this architecture. *Sanrakshan* has no directional content: it names the clearing of the way, and its absence is a failure mode the model should predict (§10). Appendix A.4 renders three of the six as a request-and-response protocol between adjoining faculties in order to formalise the inward movement; that reading belongs to the appendix and not to the sources.
...
**realisation/authenticity → definiteness/resolve → meaning/image → deliberation/analysis → valuation/selection**

This sequence completes the projective movement within *jeevan*. It can produce an image, plan, deliberation, expectation, or selected possibility that becomes material for further reflection without bodily execution. When the selection crosses the embodied interface, an additional chain follows:

**selection → *medhas* → body → speech, action, or work → result**

The dependency is not a conversion of one substance into another. *Pramanikta* does not literally become *sankalp*, and resolve does not literally become an image. Each faculty receives the governing orientation of the adjoining faculty and performs its own paired activity.

What passes outward is *sambodhan*, the imparting of the understanding of reality, and its reception is the condition of each faculty's own completion rather than the delivery of an instruction. The complete development of *atma* lies in realisation in coexistence; of *buddhi*, in accepting the signals of *atma*; of *chitta*, in creative visualisation according to the signals of *buddhi* in the presence of truth's realisation; of *vritti*, in accepting the signals of *chitta*, which is the ability to generate thoughts of *dharma*; and of *mun*, in acquiring receptivity for just behaviour on accepting the signals of *vritti* (MVD, p. 323). Projection is consequently developmental at every stage: a faculty that receives well is thereby completed, which is why the same chain appears in §8 as the description of awakening.

What passes outward is also named stage by stage, and the names are given at the couplings rather than at the faculties. Realisation of coexistence occurs in *atma* and its *bodh* in *buddhi*; in the union of *buddhi* and *chitta* the *pratiti* or awareness of realisation occurs, and this is itself the contemplation of realisation; in the union of *chitta* and *vritti* its *aabhas* or comprehension occurs, which is the deliberation activity in the form of justice, *dharma*, and truth; and in the union of *vritti* and *mun* its *bhas* or perception occurs, which becomes evident as the tasting of values and the selection of relationships (MVD, pp. 99–100). The reference is therefore neither delivered to *mun* as realisation nor degraded into something unrelated on the way out. At each coupling it takes the form the receiving pair is able to establish, and *pratiti*, *aabhas*, and *bhas* name those forms—which is why *chintan* is defined as the awareness of truth and resolved thought as its comprehension (MVD, p. 316).
...
This is where the inward movement gets a mechanism distinct from projection. *Antarniyaman* turns motion inward, and what it produces is not content but the capacity to receive—so a faculty can be signalled without being changed, and becoming capable of reception is a separate accomplishment from the signal's availability. Each level's reception is conditional in a specific way:
...
The inward movement can consequently be read as **embodied event and result → tasted hope or valuation → comparative thought → recognised meaning and desire → definiteness and resolve → realisation**, which corresponds to reflection as behaviour into thought, thought into desire, desire into resolve, and resolve into realisation (MVD, pp. 282–284). Each faculty performs its own establishing activity on what has become available to it; none relays identical data to the next. If a candidate meaning does not agree with reality, it remains unestablished rather than becoming incorrect *bodh*, and bodily feedback does not write a fallible conclusion into *atma*. A bodily signal does not arrive already labelled as justice, fulfilment, or truth; its meaning depends on the effective depth and criteria of reflection. Carried *sanskar* and memory are not additional external channels; they are part of the current internal state through which incoming signals are interpreted.
...
For every member of **D<sub>12</sub>**, adequate knowledge has a common structure: the **identity** of the activity or motive; the **purpose** it serves; the **procedure** by which it can be competently performed; the **means and interface** of body, senses, skills, relationships, and material resources it requires; the **rule** and governing criterion that preserve its rightful use; the **balance** among need, use, relationship, and available means; and the **evidence** that would show fulfilment or reveal error.
...
What the sources supply here is a decomposition, not a derivation. The positions are stated; no consulted passage argues them from anything more basic, and the general account of atomic constitution says only that each orbit holds one or more particles (MVD, p. 78; §§11.1, 11.2).
...
Two consequences follow for the reading adopted here. At the level of the individual activity the state–motion axis and the projection–reflection axis coincide, the *bal* activities being the reflective ones and the *shakti* activities the projective ones, which is the alignment Appendix A.3 and A.4 assume. And the two grains at which strength and power are used turn out to be one scheme at two levels, the faculty being the *bal* and the manifest orientation its *shakti* (Editorial Notes).
...
- **The twelvefold is not anchored in the printed sources.** It is given in oral exposition, and the individual groups are attested in print, but no consulted passage enumerates the twelve as a set or names the four sensory activities (Editorial Notes; §11.2).
...
### 11.2 Questions for further research

Where a search settled part of a question, the settled part now stands in the body or the Editorial Notes and only the residue is stated here.
...
5. Can each of the 61 pairs be expressed as a definite state–transition specification with content, governing criterion, adjoining interface, and evidential result, and how does practice refine them? The enumeration supplies a uniform two-slot form but not uniform fields: some dyads state a criterion or an evidential result and others a single clause, and the tabulated version has five columns with none of the three (MVD, pp. 328–348; AVD, pp. 91–94).
6. Capacity, ability, and receptivity are assigned to *chitta*, *vritti*, and *mun* at complete development (§4.1). What plays the corresponding role at *buddhi* and *atma*, for which the same passage names only the accepting of *atma*'s signals and realisation in coexistence (MVD, pp. 322–323)?
7. *Sakshatkar* is placed in *chitta* as the affirmation study reaches there (MVD, p. 126), the *sakshatkar* of enlightenment and resolve is called realisation-based contemplation (MVD, p. 99), and the recorded session treats *sakshatkar* as the one thing worked at, with *bodh*, *anubhav*, and *praman* following of themselves. Does *sakshatkar* name *chintan* at that locus, or the moment at which study succeeds (Editorial Notes)?
8. What observations could distinguish a loop governed by justice, *dharma*, and truth from one that merely reports those criteria while remaining governed by sensory or social reward?
9. How can mutual satisfaction be evaluated without reducing it to agreement, compliance, or self-report? Justice is defined as recognising relationships, fulfilling values, evaluating, and reaching mutual satisfaction (MVD, pp. 311, 336), which names the terminus without supplying a way of assessing it from outside the relationship.
10. *Prana* and *chitta* are named as the couplings among the three bodies, and vibration conveyed to *medhas* as the medium of the outermost stage. What account would make that signalling discriminating without reducing sentient activity to neural activity or leaving the interface causally indeterminate?
11. What activity, if any, refines or otherwise changes the organisation of *jeevan* while it is not coupled with a body? The sources assert continuity and later association without describing development in the interval; the nearest case of reduced coupling is the union of *vritti* and *mun* alone, which yields sleep or dream and is not evidenced in work and behaviour (MVD, p. 279).
12. What determines the association of a particular continuing *jeevan* with a particular developing body, and what role does saturation play beyond supplying the ontological condition of coupling? The division of determinants is stated—the body follows species-conformance and heredity while consciousness follows *sanskar*-conformance (MVD, pp. 90, 121; SB, p. 63)—and the coupling is timed from about the fourth or fifth month of pregnancy (JV, p. 94), but no consulted passage gives a pairing rule, and *prarabdh* is described as what remains to be undergone rather than as a matching principle (MVD, pp. 90–91).
13. What observations could distinguish the behavioural effect of carried *sanskar* from present bodily disposition, education, environment, and deliberate choice without reasoning circularly from the behaviour to its proposed origin? The sources cut against a hereditary reading of it—the *medhas* system is held equal in all humans, and the children of the learned turn out to be fools and the children of fools learned (KD, §3.16, p. 143)—which sharpens the question rather than answering it.
14. Can the model be related rigorously to contemporary control theory, predictive processing, or cognitive architecture while preserving the darshan's ontological distinctions?
15. What determines whether inquiry is raised at all? Every human is said to have a thirst for understanding, and that thirst is itself the evidence that receptivity is present in all humans (MVD, p. 88); *kautuhal* is placed in *mun* (MVD, p. 78); *samvahan* bears inquiries for knowledge of completeness (MVD, p. 314); frustration of effort issues in the thirst for restfulness (MVD, p. 91); and study is imparted according to the disciple's need and inquiry (MVD, p. 248). What no consulted passage supplies is why the standing thirst becomes an actual question in one case and not in another, which a loop stable at shallow depth needs (§10).
16. The inward movement reads as conditional gating with perturbed outward operation rather than as attenuated flow (§6.3). What observation in conduct would distinguish the two readings?
17. Do the four receptivity conditions—absence of crime, injustice, attachment, and ignorance—admit of degrees? They are stated privatively and their outcome as success or failure, while receptivity and ability are elsewhere matters of extent and of greater or lesser degree (MVD, pp. 142, 248). Can partial reception be defined without reasoning backwards from the conduct it was invoked to explain?
18. Three of the four receptivity conditions are met through orderliness, societal conduct, and study rather than through individual practice (§6.3). What does that imply for a control model of a single *jeevan*, whose loop is then not closed within the unit being modelled?
19. Each faculty is named as a *bal* and each manifest orientation as its *shakti*, while the same faculty's reflective activity is also called a *bal* (AVD, pp. 91, 151). Does that nesting hold throughout, and how does it stand to SB, p. 139, where a faculty's *bal* is recognised in the pair taken whole, and to SB, p. 80, where *manobal* manifests as hope-*shakti* and is identified with both of *mun*'s activities?
20. How does the directional sense of projection and reflection stand to the recognising-and-fulfilling sense and to the third use in which understanding is reflection and making-understood is projection (SB, pp. 63–64; KD, §3.12, p. 110)? Insentient nature is said to have projection only while sentient nature has both (SB, p. 60), so the pair also carries ontological work that the directional reading does not cover.
21. How do knowing, believing, recognising, and fulfilling stand to the paired activities and the six sentient activities? The fourfold divides across the cognisance–sensitivity axis, knowing and believing on the one side and recognising and carrying out on the other (KD, §3.4, p. 66), but no consulted passage assigns its members to faculties or to the six.
22. Is a deluded organisation *sanskar* or not? One formulation makes delusion under animal consciousness *kusanskar*; another holds that wrongs are never accepted and so never become *sanskar*. Which reading governs what re-embodiment carries (Editorial Notes)?
23. Visualisation formed without the enlightenment of truth necessarily carries the flaws of excess, deficiency, or omission (MVD, p. 286). Is that a further specification of the four and a half activities, or a separate account of deluded *chitran* alongside the jurisdictional restriction of *tulan* (§8)?
24. The total is decomposed as $2 \times (1 + 2 + 8 + 18 + 32)$, whose inner terms are positions in the nucleus and the four orbits (§9). The four orbital terms are the shell capacities $2n^2$ for $n = 1$ to $4$. Nothing in MVD, SB, JV, or AVD states that correspondence or argues the positions from anything more basic, the general account of atomic constitution saying only that each orbit holds one or more particles (MVD, p. 78). Is the correspondence intended?
25. Among *mun*'s thirty-two pairs the sensory ones cover touch, temperature, the six tastes, smell, and visible form, but sound appears only inside a definition and not as a pair of its own (MVD, pp. 343, 347–348). Does that omission follow from the enumeration's principle, and does it bear on naming the four sensory activities sought in question 1?
...
Everything in this appendix is the model's construction rather than the sources' statement. The body of the note states what the primary texts establish; the machinery below makes that reading definite enough to reason with, and in doing so commits to structure the sources neither assert nor exclude. Each section names the commitment it introduces. The appendix can be rejected in whole or in part without disturbing the body, and §11.2 keeps the corresponding questions open.
...
with $\mathcal{P}(a)=\textit{pramanikta}$, $\mathcal{P}(b)=\textit{sankalp}$, $\mathcal{P}(c)=\textit{chitran}$, $\mathcal{P}(v)=\textit{vishleshan}$, and $\mathcal{P}(m)=\textit{chayan}$.

The displayed composition is the full-depth cascade. More generally, let $\mathcal{F}^{\mathrm{eff}}(t)\subseteq\mathcal{F}$ be the faculties effectively participating in the present cycle; projection is composed only over that ordered subset. If *atma* and *buddhi* are not effectively governing:
...
### A.4 Inquiry, response, and state update

*Commitment: that samvahan, sambodhan, and samvartan operate as a request-and-response protocol between adjoining faculties, and that every embodied result is converted into an inquiry. No consulted passage assembles the six sentient activities this way (§6.1).*
...
The argument is the raised inquiry rather than the feedback itself, and each $\mathcal{R}(f)$ is the establishing *bal* activity of its level: $\mathcal{R}(m)=\textit{asvadan}$, $\mathcal{R}(v)=\textit{tulan}$, $\mathcal{R}(c)=\textit{chintan}$, $\mathcal{R}(b)=\textit{bodh}$, and $\mathcal{R}(a)=\textit{anubhav}$. In a shallower cycle, reflection terminates at the highest effectively participating faculty, so that for $\mathcal{F}^{\mathrm{eff}}(t)=\{c,v,m\}$ feedback can alter valuation, judgment, and representation without reaching definiteness or realisation.
...
Whether $\sqsubseteq$ can be strengthened to equality is left open, and question 23 in §11.2 bears on it: if a deluded organisation is not *sanskar* at all, the carried state contains less than $S(J)$ represents. Neither relation implies explicit autobiographical recall. Later behaviour is:
...
The note therefore uses *chintan* for the activity at that locus and introduces no separate *sakshatkar* stage. Whether *sakshatkar* names *chintan* under another aspect or the moment at which study succeeds is recorded at §11.2.
...
| *Samvedan* | Sensing: knowledge of the five cognitive and five work organs, and the tendency for development — one of the six activities of the sentient aspect (MVD, p. 313; §6.1) | *Samvedna*, a named detailed activity of *vritti* (MVD, p. 337) |
| *Samvahan* | Enquiring: the bearing of inquiries for knowledge of completeness (MVD, p. 314; §6.4) | *Samvahan* as bearability, a tactile property of objects under the activities of the cognitive and work organs (MVD, p. 347) |
| *Sanrakshan* | Protecting: paving the way towards development (MVD, p. 314; §6.1) | *Sanrakshan* as protection in the organ-level sense of removing obstacles for ease (MVD, p. 347) |
| Sensitivity as the pair-term of cognisance | The sense-rooted mode of governance contrasted with cognisance throughout §§3.2, 7.1, and 8 | The English gloss the source gives for *samvedna* at MVD p. 337, which is also "Sensitivity" |
