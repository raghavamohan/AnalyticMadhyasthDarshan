...
| **I** | Structural inference from stated claims |
...
| Code | Meaning |
|---|---|
| **N** | Necessary: effective operation or valid evidence is unintelligible or impossible without it |
| **S** | Strongly supportive: normally required for reliable development or continuity, though exceptions are possible |
...
Mark every topology that the activity actually requires. These are descriptive categories, not social institutions.

| Code | Field of operation or evidence |
|---|---|
| **J** | Intra-*jeevan*: the activity can occur inwardly, though its claim may still need outward evidence |
| **B** | Embodied personal: performance depends on the body, sense organs, learned skill, or material means |
| **D** | Dyadic or small-group: fulfilment requires another person in a direct relationship |
| **R** | Durable close or intergenerational relation: continuity, care, trust, or generation matters |
| **C** | Collective or public: affected persons, distributed roles, common procedures, or public evidence matter |
| **E** | Material or ecological: objects, natural processes, regeneration, or distributed consequences matter |
| **T** | Historical or intergenerational transmission: knowledge, competence, records, or *sanskar* must outlast present participants |

Codes are indexing aids, not conclusions. Explain every **N**, every disputed status, and every topology that is constitutive rather than merely helpful.
...
| *Bal* member | `[Hindi term - working English gloss]` |
| *Shakti* member | `[Hindi term - working English gloss]` |
...
### 1.2 Definitions and documentary limits

**Bal member - source-grounded paraphrase:**

`[Paraphrase only what the definition establishes.]`

**Shakti member - source-grounded paraphrase:**
...
`[State the narrowest defensible relation. If the text only establishes the paired position, say so. Do not assume that the shakti member is the outward performance of the bal member.]`

**Evidential status:** `[D / I / H / O]`

### 2.3 Why the members remain separate analytic units
...
## 3. Activity-member record A - *bal* member

### 3.1 Activity anatomy
...
|---|---|---|
| Inward faculty or activity | `[what must orient or inform it]` | `[D/I/H/O]` |
| Paired member | `[relation, if defensible]` | `[D/I/H/O]` |
| Other same-faculty activities | `[relevant coordination]` | `[D/I/H/O]` |
| Outer faculties | `[what must receive or carry it]` | `[D/I/H/O]` |

### 3.3 Participation topology

| Topology | Required? | Why, and at what stage? | Status |
|---|---:|---|---|
| Intra-*jeevan* | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |
| Embodied personal | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |
| Dyadic or small-group | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |
| Durable close or intergenerational relation | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |
| Collective or public | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |
| Material or ecological | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |
| Historical or intergenerational transmission | `[yes/no/conditional]` | `[reason]` | `[D/I/H/O]` |

### 3.4 Lifecycle conditions
...
|---|---|
| First-person evidence | `[resolution, definiteness, absence of contradiction, recognised fulfilment, other]` |
| Relational evidence | `[recognition, value-fulfilment, mutual satisfaction, protected voice, other]` |
| Practical or material evidence | `[competence, useful result, sufficiency, bodily outcome, other]` |
...
Complete this sentence without naming a family form or institution:

> For `[activity]` to function effectively, `[bearer and participants]` must be able to `[performance]` in relation to `[object or counterpart]`, under the criterion of `[criterion]`, with results evaluated through `[evidence]` and sustained or transmitted through `[conditions]`.

**Provisional sphere tags:** `[two to five content-first tags, such as realised evidence, direct relationship, material sufficiency, bodily conduciveness, public correction, transmission]`

## 4. Activity-member record B - *shakti* member

Repeat §§3.1-3.6 independently for the *shakti* member. Do not fill the record by reversing or extending the *bal* analysis.

### 4.1 Activity anatomy

`[Repeat the §3.1 table.]`

### 4.2 Dependencies within *jeevan*

`[Repeat the §3.2 table.]`

### 4.3 Participation topology

`[Repeat the §3.3 table.]`

### 4.4 Lifecycle conditions

`[Repeat the §3.4 table.]`

### 4.5 Evidence profile

`[Repeat the §3.5 table.]`

### 4.6 Micro-sphere statement

`[Complete the §3.6 statement and assign provisional content-first sphere tags.]`

## 5. Complete-functioning and pair-interface test

Assess both members without treating the rows as a mechanical sequence.

| Test | *Bal* member | *Shakti* member | Principal gap or uncertainty |
|---|---|---|---|
| Constitutionally present | `yes` | `yes, or identify non-activity entry form` | `[source issue if any]` |
...
| Open to evaluation and correction | `[analysis]` | `[analysis]` | `[gap]` |
...
**Interface between the two derived micro-spheres:** `[dependency, feedback loop, shared evidence, or no established interface]`

## 6. Bottom-up sphere derivation

### 6.1 Candidate recurring field

| Question | Analysis |
|---|---|
| Which bearer-object-counterpart configuration recurs? | `[answer]` |
| Which endpoint and criterion make it one field rather than a loose topic? | `[answer]` |
| Which lifecycle conditions are constitutive? | `[answer]` |
| Which conditions are only enabling or context-dependent? | `[answer]` |
| What evidence makes correct operation visible? | `[answer]` |
| Which other activity-members appear to share this field? | `[IDs or open]` |
| Provisional sphere name | `[content-first name; do not use an institution name]` |

### 6.2 Relational and structural invariants

`[State only what appears necessary: for example, direct reciprocal recognition, durable care, free inquiry, visible consequence, assured access to material means, independent correction, ecological regeneration, or intergenerational continuity.]`

### 6.3 Variable arrangements

`[List substantially different personal, relational, household, organisational, technological, or public arrangements that could satisfy the invariants.]`

### 6.4 Arrangements ruled out or constrained
...
|---|---|---|
| Person as *jeevan* | `[answer]` | `[answer]` |
| Person with body and material means | `[answer]` | `[answer]` |
| Direct relationship or small group | `[answer]` | `[answer]` |
| Durable close or intergenerational relation | `[answer]` | `[answer]` |
| Collective or public field | `[answer]` | `[answer]` |
| Wider material, ecological, or intergenerational field | `[answer]` | `[answer]` |

**Interfaces with other activity-members:**

`[Identify activities whose requirements, outputs, or evidence directly interact with this member or pair.]`

## 8. Claim ledger

| Claim | Status | Source or reasoning | What would weaken or revise it? |
|---|---|---|---|
| `[claim]` | `[D/I/H/O]` | `[citation or argument]` | `[counterevidence or unresolved issue]` |
| `[claim]` | `[D/I/H/O]` | `[citation or argument]` | `[counterevidence or unresolved issue]` |
| `[claim]` | `[D/I/H/O]` | `[citation or argument]` | `[counterevidence or unresolved issue]` |

## 9. Counterexample and residual tests

1. **Environment without awakening:** Could every proposed condition exist while the activity remains wrongly oriented? `[answer]`
2. **Awakening under adverse conditions:** Could the activity operate correctly despite absence of a proposed arrangement? `[answer]`
3. **Alternative topology:** Could the endpoint be fulfilled with fewer or different participants than coded? `[answer]`
4. **Alternative arrangement:** Could a substantially different social or material form support the same sphere? `[answer]`
5. **False evidence:** Could compliance, prosperity, efficiency, reputation, output, or reported satisfaction imitate fulfilment? `[answer]`
6. **Third-party consequence:** Could immediate participants appear fulfilled while harming other persons, nature, or future generations? `[answer]`
7. **Sphere residual:** Does a necessary lifecycle condition fall outside the provisional sphere or require an interface with another sphere? `[answer]`
8. **Universality:** Does the invariant arise from the common activity architecture, or from a particular culture, technology, or historical situation? `[answer]`

## 10. Dossier conclusion

### 10.1 Narrow derivation

`[State what conditions follow most strongly from the activity-members and why.]`

### 10.2 Sphere implication

`[Name the provisional micro-sphere or spheres, their invariants, and what remains variable. Do not assign an institution yet.]`
...
## 11. Master-matrix records

Copy one record for each member into the 122-member matrix. A vertical record is preferred over a very wide table so the generated PDF remains legible.
...
| Question | Analysis |
|---|---|
| Does the sphere require a durable structure beyond episodic personal action? | `[yes/no/conditional and why]` |
