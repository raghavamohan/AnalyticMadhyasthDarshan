...
- **AVD** — A. Nagraj, [*Adhyatmvad*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/AVD-Adhyatmvad.docx.pdf), tr. Sanjeev Chopra (work in progress). Cited: five faculties and orientations, activity-level *bal–shakti* columns, and the sixty-one-pair decomposition (pp. 91–94, 151–152; §§2, 7, 8, 12–13).
- **JV** — A. Nagraj, [*Jeevan Vidya: An Introduction*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf), tr. Rakesh Gupta. Cited: continuity across bodily death, later embodiment, state and motion, the four-and-a-half activities, continued understanding, and association during pregnancy (pp. 20, 40, 49–50, 55, 62, 73–77, 94; §§1, 7, 9, 12).
