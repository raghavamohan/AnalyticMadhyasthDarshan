...
- **AVD** - A. Nagraj, [*Adhyatmvad*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/AVD-Adhyatmvad.docx.pdf), tr. Sanjeev Chopra (work in progress). Cited: the sixty-one-pair table and 122 activity positions that remain the documentary basis of the member register (pp. 91-94; §§1-9).
- **JV** - A. Nagraj, [*Jeevan Vidya: An Introduction*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf), tr. Rakesh Gupta. Cited: value, character, family relations, and education-*sanskar* (pp. 55-60, 84, 108; §§3-8); the five dimensions of orderliness (pp. 109-110, 140; §§3-8); science in consonance with wisdom (pp. 151, 157-158; §7); and participation in production and right-use of surplus (pp. 152-153; §§3-8).
