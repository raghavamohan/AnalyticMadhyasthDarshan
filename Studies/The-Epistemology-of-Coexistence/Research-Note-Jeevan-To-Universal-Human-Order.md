...
| Open design and evidence | Household forms; public criteria for a wise family and mutual satisfaction; sensitivity of sphere results to unresolved-member treatments; the number and stability of bottom-up spheres; the exhaustiveness and uniqueness of the five-function partition; exact governance procedures; property and exchange mechanisms; division of labour; transition under unequal power; and empirical evaluation of institutional outcomes. |

The first-pass anatomy and second-pass lifecycle analysis of all 122 members are now complete in the [pilot dossiers](Research-Note-Jeevan-Activity-Environment-Pilot-Dossiers.md), [Pass-One register](Research-Note-Jeevan-Activity-Anatomy-Pass-One.md), and [Pass-Two register](Research-Note-Jeevan-Activity-Lifecycle-Pass-Two.md). The records include values, relationships, readiness for expression, acts, roles, objects, sensory qualities, bodily processes, criteria, and results. Pass Two normalizes field-level provenance; separates ontological locus, operation, consequence, and evidence; identifies internal dependencies; and codes entry-form-specific lifecycle requirements. The next stage clusters anonymized feature vectors before any institutional comparison.
