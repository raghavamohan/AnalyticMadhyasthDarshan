...
| Open design and evidence | Household forms; public criteria for a wise family and mutual satisfaction; robustness of sphere results under independent recoding, alternative similarity measures, and overlap thresholds; the exhaustiveness and uniqueness of the five-function partition; exact governance procedures; property and exchange mechanisms; division of labour; transition under unequal power; and empirical evaluation of institutional outcomes. |

The first three passes are now complete in the [pilot dossiers](Research-Note-Jeevan-Activity-Environment-Pilot-Dossiers.md), [Pass-One register](Research-Note-Jeevan-Activity-Anatomy-Pass-One.md), [Pass-Two lifecycle register](Research-Note-Jeevan-Activity-Lifecycle-Pass-Two.md), and [Pass-Three sphere derivation](Research-Note-Jeevan-Activity-Spheres-Pass-Three.md). Pass Three identifies three stable coarse domains and four stable middle cores, together with two bridge fields and two unresolved residual groupings. Faculty labels are nearly unrelated to the middle partition, while fifty-three members have overlapping membership. The next stage must test durable functional requirements and alternative institutional bundles against these results before comparing the family and five-function proposal.
