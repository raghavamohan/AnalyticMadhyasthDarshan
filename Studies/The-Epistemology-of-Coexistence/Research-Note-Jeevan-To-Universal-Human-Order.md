...
flowchart TB
    A["Realisation / understanding"] --> B["Meaning / deliberation / selection"]
    B --> C["Embodied conduct"]
    C --> D["Relational / material consequence"]
    D --> E["Evaluation / inquiry / sanskar"]
    E --> A
    F["Family<br/>relationship / care / education"] --- C
    G["Society<br/>justice / health / production / exchange"] --- D
    H["Nature<br/>provision / regenerative limits"] --- D
```
...
| Open design and evidence | Public criteria and thresholds for a fulfilled shared-life field; robustness under independent recoding, alternate channel and overlap thresholds, and additional bundle comparisons; numerical uniqueness and concrete organisational count; exact governance procedures; property and exchange mechanisms; division of labour; transition under unequal power; and empirical and longitudinal evaluation of institutional outcomes. |

All five analytical passes are now complete in the [pilot dossiers](Research-Note-Jeevan-Activity-Environment-Pilot-Dossiers.md), [Pass-One register](Research-Note-Jeevan-Activity-Anatomy-Pass-One.md), [Pass-Two lifecycle register](Research-Note-Jeevan-Activity-Lifecycle-Pass-Two.md), [Pass-Three sphere derivation](Research-Note-Jeevan-Activity-Spheres-Pass-Three.md), [Pass-Four durable-function analysis](Research-Note-Jeevan-Durable-Functions-Pass-Four.md), and [Pass-Five counterfactual validation](Research-Note-Jeevan-Counterfactual-Validation-Pass-Five.md). Pass Four finds five non-substitutable continuity objects across 185 memberships of the 122 activity rows. After source labels are restored, they align with education-*sanskar*, justice-security, health-restraint, production-work, and exchange-reserve. This basis alone among the five tested bundles combines complete coverage, no forced channel merger, no unsupported split, and structural availability of independent correction. Pass Five retains the five responsibilities across nineteen family-equivalence, boundary, adverse, universal-access, and false-positive cases while rejecting exactly five organisations and any unique kinship or residential form. Practical minimality remains relative to the selected grain and tested alternatives.
...
The architecture does not uniquely derive one concrete society. It derives universal functional and relational invariants that any adequate family, social, educational, productive, scientific, economic, and coordinative arrangement must satisfy. The five proposed institutional functions have bottom-up support as a sufficient and practically minimal functional basis at the selected grain and survive the specified counterfactual and adverse cases. That result concerns five responsibilities, not exactly five organisations. Biological kinship and co-residence are neither sufficient nor uniquely necessary for the family-like invariant; organisational form, numerical uniqueness, and empirical effectiveness remain open.
...
The derivation establishes a stable relational, intergenerational, caring, educative, productive, distributive, and evaluative field with outside protection and appeal. Pass Five shows analytically that non-kin and multi-local arrangements can satisfy this invariant and that a biological household can fail it. Particular kinship, residence, and household forms remain design variables to evaluate against the invariant.
...
- [*Pass-Two Lifecycle and Evidence Coding of All 122 Jeevan Members*](Research-Note-Jeevan-Activity-Lifecycle-Pass-Two.md) — the completed member-by-member internal-dependency, lifecycle, evidence, correction, continuity, and universality matrix.
