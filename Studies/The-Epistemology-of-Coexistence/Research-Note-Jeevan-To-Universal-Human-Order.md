...
| Open design and evidence | Household forms; public criteria for a wise family and mutual satisfaction; robustness under independent recoding, alternate channel and overlap thresholds, and additional bundle comparisons; numerical uniqueness and concrete organisational count; exact governance procedures; property and exchange mechanisms; division of labour; transition under unequal power; and empirical evaluation of institutional outcomes. |

The first four passes are now complete in the [pilot dossiers](Research-Note-Jeevan-Activity-Environment-Pilot-Dossiers.md), [Pass-One register](Research-Note-Jeevan-Activity-Anatomy-Pass-One.md), [Pass-Two lifecycle register](Research-Note-Jeevan-Activity-Lifecycle-Pass-Two.md), [Pass-Three sphere derivation](Research-Note-Jeevan-Activity-Spheres-Pass-Three.md), and [Pass-Four durable-function analysis](Research-Note-Jeevan-Durable-Functions-Pass-Four.md). Pass Four finds five non-substitutable continuity objects across 185 memberships of the 122 activity rows. After source labels are restored, they align with education-*sanskar*, justice-security, health-restraint, production-work, and exchange-reserve. This basis alone among the five tested bundles combines complete coverage, no forced channel merger, no unsupported split, and structural availability of independent correction. It establishes practical minimality at the selected grain while leaving numerical uniqueness and concrete organisation open.
