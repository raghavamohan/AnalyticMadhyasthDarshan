...
**Edited on:** July 6, 2026, 7:54 AM IST
**Status:** Released
...
Several claims the ontology depends on are argued fully elsewhere. The full-knowability thesis is developed in [*Knowledge, Knower, and Known*](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) §1.11. Post-death continuity and evidence are treated in §§1.8, 6.2.3, and §6.4. Ethics, society, spiritual practice, and the full *kaal* treatment belong in linked studies such as [*Nature of Time*](../Nature-Of-Time/Nature-Of-Time.pdf).
...
Regulation, law, and justice are treated ontologically in §§1.11–1.12. The default use of *gyan* in analytical prose is stated in Editorial Notes; other terms are introduced at first use in §1.

## 1. The Madhyasth Darshan Answer

*Terminology note: this section uses the English terms of Rakesh Gupta's translations throughout. Hindi terms are retained only where the translations themselves leave them untranslated (jeevan, mun, vritti, chitta, buddhi, atma, sanskar, dharma). Primary-text quotations and page references for each subsection are collected in ### References for Section 1 below, keyed by subsection, so that the logic of any paragraph can be checked against the texts.*
...
All quotations are from the English translations by Rakesh Gupta: *Madhyasth Darshan* (MVD), *Samadhanatmak Bhautikvad* (SB), *Jeevan Vidya – An Introduction* (JV), and *Adhyatmvad* (AVD). Entries are keyed by subsection; each lists the page citations supporting that subsection's claims and reproduces the quotations previously carried inline, so any paragraph's logic can be checked against the primary texts. Hindi terms are given here for traceability even where the body prose uses English only.
...
- **Limanowski and Blankenburg 2013** — Limanowski, J., and Blankenburg, F. ["Minimal self-models and the free energy principle."](../References/Modern-Philosophy/Limanowski-Blankenburg-2013-Minimal-Self-Models-Free-Energy-Principle.pdf) *Frontiers in Human Neuroscience*, 7. Cited: minimal selfhood as embodied self-modelling (§4.1).
...
- **Maturana and Varela 1980** — Maturana, H. R., and Varela, F. J. [*Autopoiesis and Cognition*](https://archive.org/details/autopoiesisandco0000matu). Reidel. Cited: self-producing living organisation (p. 78) (§4.2).
