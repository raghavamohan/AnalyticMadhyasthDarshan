...
**Edited on:** July 5, 2026, 3:58 PM IST
**Status:** Released
...
The three endowments are therefore not knowledge-neutral machinery to which an epistemology is added later. Recognition, activeness, and regulation are how *gyan* as ground is present on the unit side — the same law, regulation, balance, justice, and *dharma* named in the definition distributed across §§1.2, 1.11, and 1.12. Knowledge is the name of the bond whose unit-side faces are these three endowments; it is not a fourth endowment alongside them (§1.13; [Knowledge, Knower, and Known](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) §1.1).

*Satta*'s operative attributes map onto those endowments. Omnipotence is permeative in insentient and sentient nature, and transparent in mutuality (MVD, p. 32). Permeativeness provisions activeness — inherent energy and basic impulsion within each unit (JV, p. 150). Transparency in mutuality provisions recognition: units are recognisable in state-complete *satta*, and a provision for one unit to recognise another is manifest in existence — recognisability located in the transparent ground, not merely in the units taken alone:
...
The knowledge order (*gyan-avastha*) is named for the medium in which the completeness drive's remaining span runs through knowing — knowing → believing → recognising → fulfilling — where lower orders achieve definite conformance (§1.11).
...
T2 is the settlement of internal cognitive effort — restfulness of effort (*shram ka vishram*): *jeevan*'s seeking, visualising, and analysing resolving into direct realisation (*anubhav*) in coexistence, culminating in absolute resolution (*samadhan*) (SB, p. 61; MVD, p. 65). MVD titles its fifth chapter *nirbhramta hi vishram* — absence of delusion itself is restfulness (MVD, Ch. 5) — so T2's goal is stated epistemically in the primary text, not only as cognitive settlement. At the knowledge order the drive can stall epistemically rather than energetically: the transition from material to biological order occurred without confusion, but in the transition from animal to knowledge order humans find themselves deluded, with misunderstanding of the body as *jeevan* as root cause (SB, p. 91; §1.7). T2 is not the relational ease of insentient natural-state fulfilment in §1.3 — that reinstates *svabhav gati*, not *shram ka vishram*.
...
That inward circuit terminates when buddhi's reflection toward *atma* yields *atma-bodh* and realisation in coexistence simultaneously (MVD, p. 286). *Anubhav* is realisation in *satta* — the unit directly realising the permeativeness and transparency of its own ground (§1.6.2).

Projection (*paravartan*) is the evidencing direction — the realisation-based cascade from *anubhav* through *bodh*, resolve, and contemplation to taste and selection, evidenced as living proof (*pramanikta*) in conduct (MVD, pp. 98–99; §1.6.3). Reflection: ascent of understanding; projection: descent of evidence.
...
Complete knowledge (*paripoorna gyan*) encompasses knowledge of the self (*jeevan*), knowledge of existence as coexistence (*saha-astitva*), and knowledge of humane conduct (*manaviyata purna acharan*). Its ultimate test is lived evidence (*pramanikta*) in behaviour and experiment, not private intellectual assent.

The four senses above are not a static taxonomy but stations on one trajectory. *Gyan* as *satta* names the intelligibility-ground in which every unit is saturated; Realisation Knowledge is that ground enacted as the three endowments in every unit. At constitutional completeness (T1), latent permeative *gyan* is reflected as active sentience and the recognition endowment acquires the five-strength circuit (§1.6.1). On the delusional plane the faculty circuit can run body-upward — only four and a half of the ten activities operate (JV, pp. 73–74) — with believing severed from knowing; awakening statuses mark how far reflection reaches toward *atma* (MVD, p. 278). Study and reflection (*pratyavartan*) ascend through the faculties to *anubhav* in *satta* (T2; §1.7); projection (*paravartan*) then evidences the same content outward as *gyan udghatan* and *pramanikta* (T3). Realisation in coexistence is the telos at which the drive terminates (§1.6).

At the knowledge order the recognition endowment itself completes only through awakening:
...
| Chit (Consciousness) | Pure awareness, identical to the inner Self; the world of names/forms is inert. | Omnipresence is pervasive knowledge/condition-of-intelligibility (§1.13), but active sentience (*chaitanya*) belongs to the *jeevan* unit. |
...
| Knowledge sense (four) | Four meanings of *gyan* / knowledge the texts must not conflate — ontological given, intelligibility-ground in *satta*, telos of fulfilled relationships, and unfolding through awakened *jeevan* (§1.13). |
...
| Name | Tension |
|---|---|
| Knowledge / Consciousness | Implies cognition — yet *satta* is denied as knower (§1.13). |
