...
**Edited on:** September 19, 2026, 8:08 PM IST
**Status:** Released
...
This ontology connects what exists with how it becomes manifest and participates. Every unit is a definite, bounded bearer, manifest (*prakashman*) with its form, properties, essential nature, and dharma. Imaging provides a basis of mutual recognition, while the unit's relative powers exert effects. The unit exists as a whole with its environment, recognises and fulfils according to its order, and participates in orderliness. These four aspects are neither detachable attributes nor values assigned by an observer. Development occurs along two distinct but coordinated lines. Compositional progression builds atoms, molecules, cells, bodies, and environments. Development in the atom reaches constitutional completeness as *jeevan* and continues, through the human joint form, toward activity completeness and conduct completeness. The first line supplies bodies and conditions; the second supplies the sentient unit and its awakening. Keeping these lines distinct is necessary for understanding the four orders and the transition from insentient to sentient nature.

### 1.1 Coexistence: Omnipresence and units

Omnipresence is formless, all-pervasive, transparent, permeating, non-transforming, and immeasurable. Transparency, permeability, and pervasiveness together evidence it as one indivisible reality. It is permeating (*paragami*) in insentient and sentient units and transparent (*paradarshi*) in their mutuality (MVD p. 32). Permeation concerns the unit's saturation in the pervasive reality; transparency concerns the mutuality in which units are imaged and recognised. Because the pervasive reality passes through every unit rather than merely enclosing it, no division of a unit can place any fragment outside it (§1.2). It is described in the English translations by names including Omnipotence, Uniform Energy (*sam-urja*), Space, Knowledge, Consciousness, Omnipresence, and Absolute Energy. These names indicate one pervasive reality from different standpoints. Knowledge or Consciousness in this usage does not mean a universal mind performing acts of cognition. Knowing, believing, and realising are activities of *jeevan*; Omnipresence remains actionless and without motion, wave, or pressure.
...
Omnipresence is state-complete: it does not transform. Nature is state-dynamic: units remain active; material units and configurations combine and separate, developing atoms can attain constitutional completeness, and *jeevan* can awaken. Change therefore belongs to units and their configurations, not to the pervasive ground. What exists does not arise from non-being or pass into non-being; configurations change while coexistence remains perpetually present. Perpetuity applies to coexistence and the realities participating in transformation, not to the unchanging survival of every composite form (§1.14). That same architecture is the knowable field of the threefold knowledge stated in §1.13: coexistence as the existential ground, *jeevan* as the knower, and humane conduct as ordered participation.
...
Saturation holds because the pervasive reality is permeating. However often a unit is divided, every fragment remains in the same saturation; there is no division that yields a remainder standing outside the ground. Two consequences follow directly. A unit cannot be annihilated, since annihilation would require a fragment separated from what it is saturated in. And no unit is at any stage independent of the ground and later joined to it, which is why saturation names a condition rather than an event.

Soaked, submerged, and surrounded articulate inseparable aspects of saturation. Soakedness is evidenced as energy-fullness and forcefulness; submersion is expressed in activeness and mutual recognition; surroundedness is evidenced as regulation. Every unit is present in the same pervasive reality as the units with which it stands in mutuality, endowed with energy and regulated in definite relations (SB p. 57; PS p. 114). Read together on the unit side, saturation is evident as energy-fullness and forcefulness, and the primary texts state the resulting sequence as saturation, energy-fullness, forcefulness or magnetic-force endowment, recognition, and participation in orderliness. The relation between unithood (*ikaitva*) and energy-fullness is stated as a bare identity: a unit together with energy-fullness is activeness. Madhyasth Darshan presents this as an ontological entailment of saturated unithood, not as a temporal sequence or an explicitly described physical mechanism. Energy-fullness names the unit as never devoid of the energy evident in activity; forcefulness names it as the bearer of definite relative power; recognition and fulfilment are evidenced in mutuality according to constitution and order.
...
Structure is not a complete reduction of the four aspects. The actual *guna* is the definite effect that arises when units come together; *svabhav* names the essentiality or usefulness of that effect; and *dharma* names the unit's order-specific innateness and fulfilment. Definite composition can establish a new bounded unit and conduct, but the primary texts do not provide a quantitative derivation from a particular particle configuration to every higher-order *svabhav* or *dharma*. They give a progression from constitution to qualitative difference and from composition to new conduct, while the order-specific content of essential nature and *dharma* remains taught ontological content.
...
Each unit is a whole along with its environment. This does not erase its boundary: wholeness means that the unit's activity and conduct cannot be understood apart from the mutualities in which they occur. Each unit is orderliness with its own “ness” and participates in overall orderliness. Its “ness” is neither an empty relational node nor a context-free list of manifested values. It is the definite bearer, constitution, capacity, and order that remain identifiable while particular images, effects, and usefulness become evident in specific mutualities.

Truth of a unit is stated in three complementary aspects, not three worlds (YAT; MVD pp. 88, 97). Inherent truth (*vastugat satya*) is the unit's own form, properties, essential nature, and innateness. Positional truth (*vastu-sthiti satya*) is that same unit in place, time, and direction — its mutuality with other units. Existential truth (*sthiti satya*) is nature saturated in Omnipresence: coexistence as the standing condition that is not itself timed. These three do not replace one another. Knowing a unit completely means knowing what it is, how it stands among others, and that it exists in the pervasive ground.
...
|---|---|
| Form (*roop*) | The particular tree is a bounded biological composition with a definite organisation of roots, trunk, branches, leaves, fruit, and seeds. This constituted form is the *bimb*, imaged in mutual facing as *pratibimb*. Its form belongs to the tree. |
...
Value likewise has order-specific expression. In its universal ontological sense, value is essentiality (*maulikta*) and participation in orderliness (*vyavastha mein bhaagidari*): the definite conduct through which a unit complements others in coexistence (SB p. 50). Usefulness (*upyogita*) is that essentiality as it appears in objects; it does not exhaust value in *jeevan* or in human relationships. For human living the texts name value across *jeevan*, humane thought, relationship, and work. The classifications are distributed across discussions of production, relationship, *jeevan*, and humane conduct rather than supplied as one exhaustive taxonomy in a single passage.
...
| Established values | Trust, respect, affection, care, guidance, reverence, gratitude, glory, and love become evident when human relationships are recognised and fulfilled. |
...
Where each kind of value stands in existence is what keeps the account ontological. Object value is spread in units: usefulness belongs to the object and is recognised in mutuality. The named values of the other four families are borne by *jeevan* itself. The primary texts define them in the same place they define *jeevan*'s activities, setting each named value at one of the faculties of §1.7 and pairing what that faculty bears in state with the expression through which it is carried outward (MVD, pp. 328–348; AVD, pp. 91–94). A value in *jeevan* is accordingly an activity of a faculty, identified by what it does rather than by how it feels. Happiness, peace, contentment, and bliss are borne at *mun*, *vritti*, *chitta*, and *buddhi* (§1.8); the nine established values are borne three each at *chitta*, *vritti*, and *mun*, each paired with the expressed value that carries it outward; the humane essential natures are named at *vritti* and *mun*, some at positions of their own and some as the expression paired with another value. Family and faculty are two partitions of the same content — a value belongs to a family by the evaluative question it answers and to a faculty by what bears it — and neither is derived from the other (Editorial Notes).
...
The triad of effort, motion, and result is mapped to three developmental goals. The result is oriented toward immortality of constitution; effort toward restfulness; motion toward its destination. Constitutional completeness makes the result non-decomposable as *jeevan*. Activity completeness settles the internal effort of seeking through realisation and resolution. Conduct completeness settles outward motion as humane conduct and participation in universal orderliness.
...
T3 is therefore not a second name for T2. T2 concerns the settlement of *jeevan*'s internal activity in realisation and resolution. T3 concerns the continuity of that resolution as authentic conduct and living proof in human tradition. The human goals and social dimensions through which it is evidenced are developed in §1.15.
...
The primary texts describe five inseparable strengths or faculties in *jeevan*. Atma is the nucleus; buddhi, chitta, vritti, and mun are associated with the first through fourth orbits. Each has a power in projection (*paravartan*) and a corresponding activity in reflection (*pratyavartan*).
...
These are the ten activities of *jeevan*. The texts say that every *jeevan* operates through all ten, while distinguishing their presence from their effective organisation and evidence in living. Projection is the outward evidencing direction: understanding is expressed through resolve, thought, selection, work, and behaviour. Reflection (*pratyavartan*) is the inward knowing direction: experience and study are accepted, compared, directly apprehended, comprehended, and realised. Here reflection names *jeevan*'s activity of understanding the manifest world; imaging (*pratibimban*, §1.3) names the unit's presence in mutual facing. The same faculties are described as force in state and power in motion; these are not additional faculties.

The ten are also enumerated in finer grain as named positions at each faculty, whose two members are again what the faculty bears in state and what carries it outward (MVD, pp. 328–348; AVD, pp. 91–94). The named values of §1.4 belong to that enumeration. It supplies content for the ten rather than a further set of faculties, and this study draws on it only for the placement recorded in §1.4 and §1.8.

Study proceeds inward by the reflection circuit. Truth in the form of coexistence is accepted through tasting in *mun*, deliberated in *vritti*, directly apprehended (*sakshatkar*) through contemplation in *chitta*, and intellectually comprehended (*bodh*) in *buddhi*. Buddhi's accordance with atma culminates in realisation. Projection then expresses realisation through authenticity, resolve, visualisation, analysis, and selection into living conduct. Reflection is the ascent of understanding; projection is the descent of evidence.
...
The human body supplies the developed medium required for the full circuit, but bodily provision does not itself produce awakening. In deluded human living, *jeevan* identifies itself with the body and organises only four and a half activities effectively around bodily sensitivity: selection, taste, analysis, visualisation, and deliberation restricted to pleasant–unpleasant, healthy–unhealthy, and profit–loss. The source calls this restricted deliberation a *half* activity because it does not extend to the perspectives of justice, dharma, and truth; it is not a claim that vritti operates for half the time or that half a faculty is missing. The remaining activities are likewise present in *jeevan* but lack the content and coherent direction of understanding in conduct. The human recognises and fulfils sensory aims without joining them to complete knowing and believing.
...
Awakening is staged by the direction from which the faculties are regulated. Higher-conformance (*purvanukram*) is guidance descending from *atma* through *buddhi*, *chitta*, and *vritti* to *mun*; lower-conformance (*paranukram*) is sensory drive pushing inward from the body (MVD pp. 207–208). Cognisance regulates sensitivity when the higher direction holds; when the lower direction holds, sensitivity organises the faculties around the body. In the partially awakened condition, mun and vritti are driven by chitta. In the half-awakened condition, mun, vritti, and chitta are guided by buddhi, while resolve remains without self-realisation. In awakening, atma regulates and disciplines buddhi, chitta, vritti, and mun; knowing, believing, recognising, and fulfilling become one coherent activity. Study supplies the content of understanding, while practice evidences and stabilises that understanding in behaviour. Practice does not manufacture dormant faculties; projection, reflection, study, practice, and karma describe how the activities already present in *jeevan* become coherently effective and publicly evident.
...
Each is at the same time one of the named activities of §1.7, borne by the outer faculty of its pair: happiness at *mun*, peace at *vritti*, contentment at *chitta*, and bliss at *buddhi* (MVD, pp. 328–346). The two descriptions do not compete. Peace is defined at *vritti* as the absence of resistance between desire and thought, which are the orientations of *chitta* and *vritti*, so naming the harmony of a pair and naming what the outer faculty bears give one account twice. A harmony is accordingly established in a faculty rather than delivered to it, and its failure is a failure of concurrence between the paired faculties rather than a shortage passed down from above. Realisation in coexistence at *atma* is ultimate bliss (*paramanand*), whose effect reaches the remaining faculties (MVD, pp. 100–101); it is the ground of the four rather than a fifth value beside them.
...
| Contentment | chitta | chitta–buddhi | Orderly living and fearlessness in society |
| Bliss | buddhi | buddhi–atma | Evidencing understanding and coexistence |
...
*Jeevan* does not cease when the body sleeps, and MD states that it does not cease when the body dies. Because its constitution is complete and no longer subject to particle increase or decrease, it continues after separation from a body. JV also describes its subsequent association with another body. These are claims of the primary texts grounded in the doctrine of constitutional completeness; their relation to public evidence is considered in §6.2.
...
| Knowledge (human; *gyan-avastha*) | Sanskar-conformance (*sanskar-anushangita*) | Achieved through knowing, believing, recognising, and fulfilling |

Animal conduct includes inherited species-patterns accepted from gestation and followed after birth. Human bodily composition also remains species-conformant, but human conduct is principally *jeevan*-based and sanskar-conformant. Education and tradition can therefore reproduce delusion or support awakening.
...
The texts connect the evaluative domains in a widening chain: law becomes evident as justice; justice as dharma; dharma as truth; truth as abundance or coexistence; and realisation in coexistence as bliss. This is not a literal transformation or identity among the terms. It widens the field of evaluation: definite regulation is completed humanly as justice in behaviour, justice is grounded in resolved thought as dharma, dharma is assessed against truth, and truth is realised as coexistence. Evaluation therefore belongs within the ontology: it is the knowledge-order way in which coexistence is knowingly recognised and fulfilled.

### 1.13 Realisation in coexistence

The goal of development is stated as nature saturated in Omnipresence being realised in Omnipresence. Realisation is an activity of *jeevan*, not an act of Omnipresence and not the merger of a unit into a universal knower. Through realisation, *jeevan* knows existence as coexistence, knows itself as the knower, and expresses that understanding as authenticity.
...
These goals correspond to the *jeevan* values of §1.8. Resolution is evidenced as happiness. Peace becomes evident with resolution and prosperity in family living. Contentment becomes evident through orderly participation in society. Bliss becomes evident in the course of living and communicating understanding.
...
Within its own framework, the darshan presents an integrated ontology of coexistence, development, *jeevan*, awakening, relationship, and humane orderliness. Living proof (*pramanikta*) is its final practical evidence because understanding is complete in projection only when it regulates action and produces mutual fulfilment. This does not make every ontological claim a measurement already established by contemporary physics. It states the darshan's evidence standard and identifies where comparison with public scientific methods must be made carefully.
...
Advaita reads Brahman as *sat*, *chit*, and *ananda* — being, consciousness, and bliss — three names for one substantive, not three compounded realities. The Taittiriya Upanishad states the formula Advaita takes as canonical:

> **"Brahman is Truth, Knowledge, and Infinity."**
> - TU 2.1.1

Shankara treats each word as a separate predicate of that one Brahman — *satyam brahma*, *jnanam brahma*, *anantam brahma*. Truth (*satyam*) marks what does not change the nature ascertained as its own, and so marks Brahman off from mutable things. Knowledge (*jnanam*) is consciousness itself — Brahman's nature, not an agent that knows and thereby becomes limited. Infinity (*anantam*) is what is not bounded by time, space, or object — the fullness in which nothing else stands over against Brahman (TU 2.1.1, Shankara's commentary). The *anandamaya* passage (TU 2.5) cannot by itself identify Brahman with bliss, because the bliss sheath remains a covering to be discriminated from the Self. The stronger passage is TU 2.7: Brahman is *rasa*, the essence or fullness through whose attainment one becomes blissful. Advaita therefore uses *ananda* for limitless completeness rather than a passing affect. TU 2.5 explains why experiential pleasure is not the final referent; TU 2.7 supplies the positive identification of Brahman as the source and fullness of bliss.
...
The stock error of mistaking a rope for a snake illustrates Advaita's later theory of error as *anirvacaniya-khyati*: the object of error is indescribable as either real or unreal. The snake is neither real (it vanishes on knowledge) nor utterly unreal (it was genuinely experienced), but a projection on a real substrate — the same structure Maya writ large applies to the world until Brahman is known. In Madhyasth Darshan, the corresponding error is evaluative: the rope remains a definite unit with form and properties; there is no third ontological status of “indescribable appearance.” Delusion (*bhram*) is *jeevan*'s misidentification of the body as self, not a fabrication of the body itself.
...
Jivatman (*jiva*) is the individual embodied soul — the true Self (*Atman*) conditioned by *upadhis* (limiting adjuncts), appearing as separate until realisation. Classical Advaita accounts for apparent plurality of jivas without making each an ultimate second: reflection (*pratibimba*) and limitation (*avaccheda*) name two standard ways the one Self appears many under adjuncts; this study need not decide between later school elaborations. The empirical person is further stacked as three bodies — gross (*sthula*), subtle (*sukshma*), and causal (*karana*) — and as five sheaths (*pancha kosha*: food, vital, mental, intellect, and bliss). Those layers are real equipment at *vyavahara*; they are not discarded as hallucination, yet they do not survive as separate individuality at *paramartha*. Shared Upanishadic sheath vocabulary with Madhyasth Darshan must not be read as a one-to-one ontological match (§5.7.2).
...
Liberation (*moksha*) is not dissolution or merger of a real individual into Brahman. The jiva was never a separate entity; realisation is recognition of pre-existing identity with Brahman, in which the illusion of separate individuality is dispelled. The classical identity formula is *tat tvam asi* — "That thou art" (CU 6.8.7, with Śaṅkara's bhāṣya); BS 1.1.2 treats the same doctrine systematically. The *Vivekachudamani* compresses the point: at the ultimate truth there is neither death nor birth, neither a bound nor a struggling soul, neither a seeker after liberation nor a liberated one (VC, v. 574) — for the Supreme Brahman is, like the sky, pure, absolute, infinite, motionless, and changeless, without interior or exterior: the one Existence, without a second, and one's own Self (VC, v. 393).
...
Realisation evidences identity with Brahman — the dispelled illusion of separate individuality. The enlightened still act for world-welfare at *vyavahara*; what changes at *paramartha* is ontological status, not the possibility of ethical living.
...
Advaita establishes a rigorous non-dual ontology and a disciplined first-person method for discriminating seer from seen. Whether the world's robustness at *vyavahara* settles its status at the highest truth is the comparative question carried forward in §6.3.
...
Aristotelian–Thomistic hylomorphism maps form (*forma*) onto matter (*materia*) so that a substance is the compound of both — not mere aggregation. Aquinas treats the rational soul as the form of the living body (*anima forma corporis*), yet also as a subsistent form (*forma subsistens*) capable of surviving the body's death. The joint living of soul and body therefore has a limited parallel with Madhyasth Darshan's *jeevan*–*shareer* joint form, but *jeevan* is not the form of the physical body. It is an independent, constitutionally complete sentient atom that associates with, directs, and dissociates from a pranic body. The parallel does not extend to treating form, properties, essential nature, and *dharma* as an intrinsic substantial signature: Madhyasth Darshan retains a definite bearer while making property-effects and usefulness evident in mutuality (§1.3). *Gathanpurnata* resembles substantial completion insofar as it establishes a definite constitution whose sentient activities can be expressed through a suitable body. The divergences are sharp: Madhyasth Darshan's plural, immortal *jeevan* units, beginningless coexistence with *satta*, and saturation are not Aristotelian prime matter plus a single rational soul per body; yet the soul-as-form debate is a nearer cousin than process philosophy on individual persistence (SEP Form and Matter; Aquinas ST I, q. 75–76).
...
Nor is *satta* a physical field. Dynamical fields carry energy-momentum, interact, and vary; *satta* is described as formless, actionless, and non-transforming (§1.2). In quantum field theory the vacuum state has physical properties: fluctuations, non-zero vacuum expectation values, spontaneous symmetry breaking, and the Casimir force. It carries a stress-energy tensor and participates in dynamical curvature. A quantum vacuum is therefore a physical state with determinate structure and observable consequences, not an equivalent of actionless Omnipresence. Physical analogies can clarify contrasts but cannot supply the missing identity.
...
Classical Samkhya also affirms two ultimates: plural passive conscious witnesses (*purusha*) and one active material cause (*prakriti*) transforming through twenty-four principles. Madhyasth Darshan likewise affirms plural conscious units and real transforming nature. Unlike Samkhya's final disengagement (*kaivalya*), it holds both under saturation in Omnipresence: matter and sentience participate in orderly coexistence, and awakening is fulfilled living rather than isolation of the witness (IEP Sankhya).
...
Madhyasth Darshan therefore occupies neither pole of a simple substance–relation opposition. Units are not empty nodes exhausted by their relational profiles: boundary, constitution, capacity, order, and *dharma* remain attributable to them. Yet manifested *guna*, the usefulness named by *svabhav*, and value cannot be read from an isolated bearer. Insentient mutuality remains definite; the possibility of mis-evaluation arises only with *jeevan* and, in human living, from delusion rather than from indeterminacy in the related objects.
...
Advaita's Sat-Chit-Ananda and Madhyasth Darshan's coexistence can sound alike — both speak of being, consciousness, and fulfilment. The contrast is over what those words name and whether the world survives them, expanding the Cosmic Ground and Individual Self rows of §5.5.1 (see also §§5.3.1–5.3.3).
...
Five-layer (*kosha*) language from the Upanishads is shared terminologically, not ontologically. Madhyasth Darshan carries two five-fold structures that do not match Advaita's sheaths one-to-one: five inseparable faculties within *jeevan* and developmental planes (animal and deluded humans at four koshas; awakened humans at five including *vigyanmaya*; MVD, pp. 49–50; §§1.7, 1.9). Advaita peels sheaths away to reveal the Self beneath (VC, vv. 210, 639); Madhyasth Darshan affirms layered human equipment to be harmonised in awakened living. Listing koshas among structural analogues would overstate the parallel.
...
| How do the levels relate? | Higher knowledge sublates the lower | The three aspects complete one another |
| Status of the unit and world | Dependent appearance, withdrawn at *paramartha* | Real unit, real mutuality, real saturation |
| What realisation does | Removes the world's independent being | Reveals coexistence without cancelling units |
...
Advaita seeks *moksha*: recognition of the ever-established identity of Atman and Brahman, in which separate individuality is known never to have been absolute (*tat tvam asi*, CU 6.8.7; BS 1.1.2; VC, vv. 244, 574). Madhyasth Darshan holds that individual *jeevan* units remain eternally distinct; its goal is awakened coexistence (*jagriti*) expressed through fulfilled relationships with other humans and the natural orders.
...
The comparison therefore yields limited alignments rather than stable alliances. Madhyasth Darshan and Advaita reject reductive accounts of the knower but disagree over one and many; MD and scientific realism affirm mind-independent nature but differ over perpetuity and *satta*; Advaita and standard scientific accounts both decline to affirm an eternal separate person, but for fundamentally different reasons. Open problems and critical review follow in §6.

## 6. Critical Review

Comparison in §5 named the forks. This section asks what still holds under pressure: whether Madhyasth Darshan coheres on its own terms, which problems remain open inside it, and what Advaita and modern approaches gain and lose against that picture.

### 6.1 Internal coherence of the Madhyasth Darshan position

Judged on its own definitions — not as proof against rivals — the ontology hangs together. Coexistence, real units, and beginninglessness form one picture without separate doctrines for each question (§§5.2–5.3). Affirming the world's enduring reality rather than declaring it an illusion preserves the weight of nature, society, relationship, and ethical responsibility; consciousness, value, and selfhood are not treated as mere byproducts of body-chemistry.

If existence is coexistence, human fulfilment must be evidenced as coexistence in behaviour, not merely believed. "Nothing existent is annihilated" gives internal coherence to *vastu* persisting through *roop*-change and bodily death as configuration-shift — though post-death continuity of *this* *jeevan* is a further metaphysical commitment, not a theorem of quantity conservation alone (§1.14, §6.2.3).
...
Since *jeevan* is described as an atom rather than a Cartesian non-physical substance, the issue should not be prejudged as an injection of energy from outside nature. Yet the texts do not translate transmission between *jeevan* and the nervous system into measurements that distinguish *jeevan*-mediated activity from a brain-only account. The productive question is thus the missing operational bridge between the primary-text description and neuroscience, including how bodily impairment constrains expression and what observation could count for or against post-death continuity.

#### 6.2.3 Evidence standards and evolutionary scope

Madhyasth Darshan does not limit evidence to assertion or private conviction. Its method moves through study, self-examination, practice, realisation, and evidence in conduct; understanding is expected to become intersubjectively visible as resolution, justice, mutual fulfilment, and participation in orderliness (MVD, pp. 88, 115; SB, p. 44; §§1.13, 5.3.5). This is a substantial practical evidence standard. It is not, by itself, a physical detection procedure for constitutional completeness, a persisting atomic *jeevan*, or post-death reassociation. The paper should therefore keep logical grounding, first-person verification, conduct evidence, and instrument-based scientific confirmation distinct. Comparisons with physics are appropriately described as parallels or tensions unless a shared operational criterion has been established.
...
- Its ontology is parsimonious: one partless Brahman, without a second ground or plural immortal substances. Ethics, *loka-sangraha*, and beginningless *vyavahara* (§2.10) make the empirical world robust for living; that defence should not be dismissed in a sentence.

**Weaknesses.**

- Making the world *mithya* at *paramartha* makes it harder to ground the final ontological weight of relationships, nature, society, and conduct (§2.4; §§5.6–5.7). Liberation as *jiva-brahma-aikya* dispels separate individuality (§§2.6, 5.3.3), whereas Madhyasth Darshan requires distinct immortal *jeevan* for relational realism and post-death continuity (§§1.7–1.8).
- *Maya*, *adhyasa*, *mithya*, and Brahman as *chit* do not map onto saturation, *jagat satat*, and *gyan* as intelligibility-ground (§§5.6–5.7.5). Nagraj presses the origination tension directly:
...
That question meets the classical problem of the locus of avidya (*ashrayanupapatti*). The Vivarana school places avidya in Brahman as both its locus and its object; the Bhamati school places it in the individual *jiva*, while treating *jiva*-hood itself as beginninglessly bound up with avidya. If Brahman is self-luminous knowledge, avidya cannot reside there as darkness in the sun; if it resides in the *jiva*, the *jiva* already presupposes avidya. Nagraj's objection therefore engages that crux rather than mistaking Advaita for a naive claim that a second real world was manufactured and then declared false.

Advaita's reply — effect–cause non-difference, empirical causal teaching, and later *vivarta* (§§2.4–2.6, 5.4) — is coherent within its own standpoint structure. It does not assert that a second real world was temporally manufactured from Brahman and then became illusory; it asserts that name-form never had independent being apart from Brahman. Madhyasth Darshan denies that this sublation is the last word. Beginningless *vyavahara* does not settle final ontological status: *satat* names a world that retains full weight at the highest realisation (§5.7). Advaita achieves ontological parsimony and a disciplined account of liberation at the cost, from MD's standpoint, of subordinating world-plurality at the highest truth; MD preserves that plurality at the cost of the ontological complexity Advaita refuses.
...
- Causal closure (§3.1), organismal and psychological persistence theories (§3.4), and the irreversible loss of measurable personal function at brain death (§4.5) are genuine pressures on immortal *jeevan* (§6.2.2). Public science would require operational criteria for constitutional completeness, reproducible markers distinguishing *jeevan*–body operation from a brain-only account, and independent evidence for post-death continuity. Until then, immortal *jeevan* remains unconfirmed by current public science.
...
Madhyasth Darshan's distinctive claim is coexistence: formless Omnipresence (*satta*) and countless real units (*ikai*), beginningless and neither made from the other, with the world retaining final weight.

> **"Brahma is truth, the world is perpetual."**
> - MVD, p. 13

Across the ten criteria developed in §5, Madhyasth Darshan retains a distinctive two-term ontology. Omnipresence and units are co-eternal; change belongs to units and their configurations; *jeevan* remains a distinct sentient unit; and relationships, values (*mulya*), and the natural world retain full ontological weight. Its units are real bearers rather than products of observation, while their imaged form, relative effects, usefulness, and fulfilment become evident through definite mutualities. Error is not inserted into insentient nature by this relationality. It arises in *jeevan* when the human bodily provision for understanding is organised under delusion rather than awakening. The account therefore differs from both world-subordinating non-dualism and matter-only reduction, while also resisting their assimilation into a single opposing camp. The comparisons yield limited, question-specific alignments — with scientific realism on mind-independent nature, with Advaita on resistance to reductive accounts of the knower, and with several modern alternatives on the insufficiency of a simple substance picture — but no stable alliance across all ten criteria. MD's further commitment is relational realism tied to conduct: understanding is fulfilled when coexistence becomes evident in humane living.

What remains open is not the comparison map but the bridge between Madhyasth Darshan's internally articulated account and other methods of inquiry: public identification of constitutional completeness (§6.2.1), independent evidence for *jeevan*'s persistence and joint operation with the body (§6.2.2), and a careful separation of conduct evidence from physical measurement together with a clearer mapping to evolutionary explanation (§6.2.3). Those are the points at which further work must press, not where this study claims settlement.
...
| Established values | The nine relationship values—trust, respect, affection, care, guidance, reverence, gratitude, glory, and love—borne at *chitta*, *vritti*, and *mun* and flowing when relationships are recognised (JV pp. 108, 138; §1.4). |
...
MVD p. 305 and JV p. 43 name five value families, with civic values as the English rendering of *shishta-mulya*. *Paribhasha Samhita* pp. 151 and 154 enumerates thirty values as four *jeevan*, six human, nine established, nine expressed, and two object values. This study adopts that thirty-count and treats *shishta-mulya* as the nine expressed relationship values paired with the established values, matching [*Axiology: Value Theory*](../Axiology-Value-Theory/Axiology-Value-Theory.pdf) §1.3. “Civic values” is retained only as Gupta's translation, not as a family of right-use of body, mind, and wealth. The nine established values are named at JV p. 108 with the phrase "such as", so the set is presented by example rather than declared exhaustive. The same value names are separately defined in the appendix of *jeevan*'s activities, where each occupies a position at a faculty beside the term through which it is expressed (MVD, pp. 328–348; AVD, pp. 91–94). This study reads family and position as two partitions of one content rather than deriving either from the other, and it treats the appendix as fixing where a named value is borne, not as fixing how its fulfilment is evaluated. The pairing semantics vary across the appendix and are not uniform; that material is left to the inventory note cited in §1.4. Object value stands outside this placement, being spread in units rather than borne by a faculty.

### Three truths (*teen satya*)

The three-aspect statement in §1.3 follows the definitions collected in YAT and the related passages at MVD pp. 88 and 97. The study states them as complementary aspects of one unit in coexistence. It does not treat them as Advaita's three tiers, and it does not map them onto a separate *yatharthata / vastavikta / satyata* ladder in the exposition.
...
In analytical prose, ***gyan*** names coexistence as the complete intelligible content — nature saturated in *satta* (§1.2) — not a mind that knows, and not a property of a reified bond between ground and units. *Satta* is actionless; projection (*paravartan*) and reflection (*pratyavartan*) name *jeevan*'s faculty activities (§1.7), and sentience is predicated of the constitutionally complete atom, never of the ground (§1.6.1). Where the texts use a distinct compound or order name, this study keeps it explicit: Realisation Knowledge (*anubhav jnan*) for orderliness evident in every unit (§1.1); *gyan udghatan* for knowledge unfolding through awakened *jeevan* (§1.7); knowledge order (*gyan-avastha*) for the fourth order of nature, named for human knowing, not for Omnipresence-as-knower (§1.5).
...
The source texts reuse words — *gyan*, *nyaya*, law — at more than one level of meaning. Conflating those levels is a common source of misreading. The default use of *gyan* is stated above; domain names conduct, thought, and realisation — and regulation, justice, and statute — in §1.12; mode or level marks a qualitative threshold (sentience, emergence) where the darshan requires it. Register is reserved for ordinary English (*registers as happiness*, *activity registers on another*) and for quoted source usage — not as a standalone analytical label. Where the study names the completeness drive's **termination condition** (development bound until realisation in *satta*) or an **epistemic gradient** (from being-in-knowledge toward knowing), those are analytical glosses on SB and MVD phrasing in §§1.2 and 1.6 — not separate doctrines.
...
The *mithya* doctrine and Advaita's three-tier framework (*pratibhasika*, *vyavahara*, *paramartha*) are related but distinct tools; §2 keeps them apart. The compound *sad-asad-anirvacaniya* is a post-Shankara systematic term (Vimuktatman, Vivarana school); Shankara uses "neither sat nor asat" language without that compound. §2.5 names the later error-theory as *anirvacaniya-khyati* and keeps Shankara's *Adhyasa Bhashya* definition distinct from that compound. The locus-of-avidya contrast in §6.3 (Vivarana and Bhamati) is later-school apparatus used to locate Nagraj's question; it is not attributed to Shankara as a single settled doctrine.
...
- **§1.16.** Summary table draws on the references above; lived verification through humane conduct (*pramanikta*) as final proof derived from karma's enactment principle (§1.7.1): §§1.6.3, 1.7.1, 1.13 references.
...
- **BS** — [*Brahma Sutra Bhashya*](https://analyticmadhyasthdarshan.org/References/Advaita-Vedanta/BSB-Brahma-Sutra-Bhashya-Gambhirananda.pdf) (Shankara; Swami Gambhirananda). Cited: §§2.5, 2.9 (Adhyasa Bhashya preamble; BS 2.1.14, 1.1.2).
...
- **§2.8.** Beginninglessness of Brahman: VC, v. 393. *Srishti–sthiti–laya* as beginningless empirical cycles. Fuller *trikaal* / *kaal* comparison in *Nature of Time*.
- **§2.9.** *Tat tvam asi*: CU 6.8.7, with Śaṅkara's bhāṣya; BS 1.1.2. Ultimate truth: "There is neither death nor birth, neither a bound nor a struggling soul, neither a seeker after Liberation nor a liberated one – this is the ultimate truth." (VC, v. 574). Nature of Brahman: "The Supreme Brahman is, like the sky, pure, absolute, infinite, motionless and changeless, devoid of interior or exterior, the One Existence, without a second, and one's own Self." (VC, v. 393). *Jivanmukti* / *videhamukti*; *adhyaropa–apavada*; *pramana* and the threefold path (*shravana*, *manana*, *nididhyasana*): classical Advaita epistemology, developed further in [*The Epistemology of Coexistence*](../The-Epistemology-of-Coexistence/The-Epistemology-of-Coexistence.pdf) §2. Ethical discipline as prerequisite to knowledge: VC, vv. 17–19.
...
- **Dennett 1991** — Dennett, D. C. [*Consciousness Explained*](https://www.penguinrandomhouse.com/books/311069/consciousness-explained-by-daniel-c-dennett/). Little, Brown. Cited: §3.3 (functional and heterophenomenological account).
- **Churchland 1986** — Churchland, P. S. [*Neurophilosophy: Toward a Unified Science of the Mind-Brain*](https://mitpress.mit.edu/9780262530853/neurophilosophy/). MIT Press. Cited: §3.3 (eliminative materialism about folk psychology).
...
- **Baker 2000** — Baker, L. R. [*Persons and Bodies: A Constitution View*](https://www.cambridge.org/core/books/persons-and-bodies/4AE67903C84F0D11993A71D89703C9E9). Cambridge University Press. Cited: §3.4 (constitution view).
...
- **SEP Form and Matter** — Robinson, H. ["Hylomorphism."](https://plato.stanford.edu/entries/form-matter/) *Stanford Encyclopedia of Philosophy*. Cited: §3.6.1.
- **IEP Sankhya** — Ruzsa, F. ["Sankhya."](https://iep.utm.edu/sankhya/) *Internet Encyclopedia of Philosophy*. Cited: §5.4 (*purusha*, *prakriti*, *kaivalya*).
- **Aquinas ST** — Aquinas, T. [*Summa Theologiae* I, qq. 75–76](https://www.newadvent.org/summa/1075.htm). Cited: §3.6.1 (*anima forma corporis*).
- **Spinoza Ethics** — Spinoza, B. [*Ethics*](https://www.gutenberg.org/ebooks/3800), trans. R. H. M. Elwes. Cited: §3.6.2 (Part I, Props. 14–15; Part II, Def. 3).
- **Leibniz Monadology** — Leibniz, G. W. [*Monadology*](https://www.gutenberg.org/ebooks/43758), trans. R. Latta. Cited: §3.6.3 (§§1–14, 78–81).
- **Whitehead 1929** — Whitehead, A. N. [*Process and Reality*](https://analyticmadhyasthdarshan.org/References/Modern-Philosophy/Whitehead-1929-Process-and-Reality.pdf) (1929 ed.). Cited: §3.6.4 (pp. 28, 44).
- **Russell 1921** — Russell, B. [*The Analysis of Mind*](https://analyticmadhyasthdarshan.org/References/Modern-Philosophy/Russell-1921-The-Analysis-of-Mind.pdf). Cited: §3.6.5 (Lecture I).
- **Mach 1914** — Mach, E. [*The Analysis of Sensations*](https://analyticmadhyasthdarshan.org/References/Modern-Philosophy/Mach-1914-The-Analysis-of-Sensations.pdf), trans. C. M. Williams and S. Waterlow. Cited: §3.6.5 (Ch. XIV).
...
- **Penrose 2010** — Penrose, R. [*Cycles of Time: An Extraordinary New View of the Universe*](https://www.penguinrandomhouse.com/books/311068/cycles-of-time-by-roger-penrose/). Bodley Head. Cited: §4.2.
...
- **Weinberg 1995** — Weinberg, S. [*The Quantum Theory of Fields*, Vol. 1: *Foundations*](https://www.cambridge.org/core/books/quantum-theory-of-fields/7A7637CB756DAC56A978B5E4EBD9788F). Cambridge University Press. Cited: §4.3.
...
- **Seth 2021** — Seth, A. [*Being You: A New Science of Consciousness*](https://www.penguinrandomhouse.com/books/623057/being-you-by-anil-seth/). Faber & Faber. Cited: §4.5.
...
- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (*Resolution Centred Materialism*)](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta. Also at https://www.youtube.com/playlist?list=PL69PCoz1OQW0dhshZ0Xv3KtZ7ajJOIpgv (bilingual Hindi and English). Cited: §§6.2.1–6.2.3 (pp. 44, 55, 59, 91–92, 114).
- **MVD** — Nagraj, A. [*Madhyasth Darshan — Co-existentialism*](https://analyticmadhyasthdarshan.org/References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: §§6.2.1–6.2.3, 6.3 (*The Alternative*; pp. 88, 91, 115, 288–289). The locus-of-avidya contrast in §6.3 is later-school apparatus (Vivarana, Bhamati), not a further MVD page.
