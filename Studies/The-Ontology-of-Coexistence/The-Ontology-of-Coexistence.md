...
**Edited on:** July 5, 2026, 5:15 PM IST
**Status:** Released
...
Because saturation itself is knowledge (§1.2), the drive runs from being-in-knowledge — every unit soaked in intelligibility from eternity — toward knowing: the saturated unit realising the ground in which it is saturated. SB names this bound explicitly: until nature imbued in Omnipotence is realised within Omnipotence, it is bound for development — an "existential truth" applying to both insentient and sentient nature (SB, p. 91). Realisation in coexistence (§1.13) is not an extra telos appended to a physical drive; it is the drive's own termination condition, stated in the same passages that define development and awakening.
...
In the evolving insentient atom (*jada parmanu*), the triad drives hungry and overfull exchange toward constitutional completeness (*gathanpurnata* / T1). In the constitutionally complete *jeevan* atom, the triad works through projection and reflection (SB, p. 60) toward activity completeness (*kriyapurnata* / T2) and conduct completeness (*vyavaharpurnata* / T3).
...
That inward circuit terminates when buddhi's reflection toward *atma* yields *atma-bodh* and realisation in coexistence simultaneously (MVD, pp. 285–286). *Anubhav* is realisation in *satta* — the unit directly realising the permeativeness and transparency of its own ground (§1.6.2).

Projection (*paravartan*) is the evidencing direction — the realisation-based cascade from *anubhav* through *bodh*, resolve, and contemplation to taste and selection, evidenced as living proof (*pramanikta*) in conduct (MVD, pp. 98–99; §1.6.3). *Gyan udghatan* — knowledge unfolding — names that outward evidencing activity; it belongs to awakened *jeevan*, not to *satta*. Reflection: ascent of understanding; projection: descent of evidence.
...
Awakening is accordingly staged by how far up the circuit discipline reaches. MVD marks three statuses of *buddhi* in the knowledge order: partially awakened, where *mun* and *vritti* are driven by *chitta*; half awakened, where *mun*, *vritti*, and *chitta* are driven by *buddhi* whose resolve is still devoid of *atma-bodh*; and awakened, where desire, thought, and hope rest on resolve with *atma-bodh*, and *mun*, *vritti*, *chitta*, and *buddhi* are regulated and disciplined by *atma* (MVD, pp. 277–278). These statuses give, in faculty terms, the ascent that the human-type ladder of §1.9.2 names typologically and that the plane shifts at T2 and T3 mark developmentally (§1.6) — without a forced one-to-one alignment between three statuses and five human types.
...
| Destination of motion (*gati ka gantavya*) | The teleological goal of motion (*gati*) at conduct completeness (T3 / *vyavaharpurnata*) — external behavioural participation aligned with universal orderliness (§1.6). |
