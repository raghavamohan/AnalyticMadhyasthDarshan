...
**Edited on:** July 21, 2026, 9:38 PM IST
**Status:** Released
...
Omnipresence is formless, all-pervasive, non-transforming, and immeasurable. It is described in the English translations by names including Omnipotence, Uniform Energy, Space, Knowledge, Consciousness, Omnipresence, and Absolute Energy. These names indicate one pervasive reality from different standpoints. Knowledge or Consciousness in this usage does not mean a universal mind performing acts of cognition. Knowing, believing, and realising are activities of *jeevan*; Omnipresence remains actionless and without motion, wave, or pressure.
...
At the root of physical, chemical, and *jeevan* activity is the atom, constituted by a nucleus and particles in orbits. Atoms combine as molecules and larger compositions. A molecule, cell, body, planet, or other organised whole may itself be studied as a unit when it exhibits a definite constitution and conduct; this does not make every aggregate equivalent. A compound establishes a new bounded unit whose constitution supports a new pattern of relative effects and order-specific conduct, whereas the constituents of a mixture retain their respective conducts.

Omnipresence is state-complete: it does not transform. Nature is state-dynamic: units act, combine, separate, develop, and awaken. Change therefore belongs to units and their configurations, not to the pervasive ground. What exists does not arise from non-being or pass into non-being; configurations change while coexistence remains perpetually present.

### 1.2 Saturation: the ground–unit bond

The texts name the inseparability of Omnipresence and nature *saturation* (*sampriktata*): every unit is soaked, submerged, and surrounded in the pervasive reality. Saturation is not a transfer of substance from a finite store and not an action performed by Omnipresence upon otherwise independent matter. It names the way every unit exists. Omnipresence does not act as an external efficient cause; activities and transformations are performed by units in mutuality.

Saturation is evident on the unit side as energy-fullness and forcefulness. Because units are saturated in Omnipresence, they are active and capable of recognising other units. The primary texts state the sequence as saturation, energy-fullness, forcefulness or magnetic-force endowment, recognition, and participation in orderliness. This is not a sequence in time. It is an account of how one inseparable condition is expressed through a unit.
...
The natural state is the condition in which a unit's activity accords with its innateness and definite conduct. The excited state arises under pressure and carries the possibility of decline. In physicochemical exchange, units give and take and then reinstate natural-state motion. A unit moves toward development in its natural state and toward decline in its excited state. This movement must not be confused with the claim that every particle will become *jeevan*: units participate in development according to their constitution and order, while constitutional completeness is attained only by some developing atoms.

The peepal tree illustrates definite conduct at the biological order. Its roots, leaves, fruit, and seeds express the form, properties, essential nature, and dharma of that composition and transmit its composition method. The same vegetation can be recognised as vitalising or devitalising through its definite effect on a particular body; the relation supplies the context, not an arbitrary judgment. At the human order, definite bodily composition is not sufficient for humane conduct; knowing and believing must guide recognition, evaluation, and fulfilment.
...
The primary texts distinguish relationship from association. A relationship is a mutuality whose expectations are inherent in the sense of completeness; an association is a mutuality whose expectations are voluntary. Parent and child exemplify a relationship whose values require recognition and fulfilment. Neighbours sharing a wall may have an association whose terms they choose. Both occur in coexistence, but only the former carries the full relational expectation named in the human value account.

Value likewise has order-specific expression. Essentiality in every order and plane is value in the broad ontological sense: the usefulness through which a unit is complementary to others. Utility and art values arise in human production and exchange. Human relationship values—such as trust, respect, affection, care, guidance, reverence, gratitude, and love—are fulfilled in behaviour. *Jeevan* values—happiness, peace, contentment, and bliss—name harmony within the sentient unit (§1.8). These uses are connected by complementarity but should not be treated as interchangeable.

Recognition and fulfilment are definite below the knowledge order according to structural, seed, and species conformance. Animals do not fail to perform a human evaluation; their *jeevan* is expressed through a bodily medium that does not provide for the full evidence of understanding. The human body supplies that provision, yet human evaluation can succeed or fail because freedom of action operates while knowing and believing may remain disconnected from recognition and fulfilment. Capacity, ability, and receptivity are evidenced through naturalness, environment, study, understanding, and practice. A seed germinates under conducive conditions; a human's possibility of awakening likewise requires both inherent capacity and an environment in which understanding can be studied and evidenced.
...
The material and bio orders are insentient. The animal and knowledge orders are joint expressions of insentient body and sentient *jeevan*. Hope to live is the animal-order dharma and is expressed through *mun* in *jeevan*. Animal bodies provide a brain and sensory medium adequate for hope-bound, species-conformant living but not for evidencing complete understanding. The fully enriched nervous system of the human body provides the medium through which imagination, freedom of action, knowing, believing, and the full possibility of awakening can be expressed. Happiness is the human dharma because the human seeks not merely continued living but resolution and the continuity of happiness.

Two developmental lines meet in the animal and human joint forms. Compositional progression begins with atoms and molecules and proceeds through chemical compositions, biological cells, vegetation, animal bodies, and the human body. Development in the atom proceeds from constitution-oriented atoms to a constitutionally complete atom, *jeevan*. A living animal or human is not a body that has itself become sentient solely through compositional complexity; it is the joint form of a body supplied by compositional progression and a *jeevan* supplied by development in the atom.

Existential progression names the definite order in which the orders become manifest under conducive conditions: material, pranic, animal, and knowledge. The way of existence names the conformance by which each order maintains definite conduct: result- or structure-conformance, seed-conformance, species-conformance, and sanskar-conformance. This fixed order does not imply that every instance advances to the next order. Biological compositions return to material constituents after disintegration, and most atoms remain engaged in physical and chemical constitution rather than attaining constitutional completeness.
...
The table is an analytical consolidation of statements distributed across MVD, SB, and KD. It does not mean that effort, motion, and result can be separated or that the stages unfold mechanically. Each activity bears the triad; the named goal indicates what becomes complete at each transition.
...
Constitutional completeness is an irreversible transition. The particle constitution is closed: qualitative activity continues, but particles no longer increase or decrease. The atom is liberated from molecular-bondage and weight-bondage and becomes established in hope-bondage. It is then a sentient unit, *jeevan*, with inexhaustible force and power expressed as hope, thought, desire, resolve, and evidence. The texts present this as the transition of an insentient constitution-oriented atom into the sentient status, not as the growth of a body or brain into *jeevan*.
...
Activity completeness is restfulness of effort. The texts define restfulness as the absence of delusion. Delusion is not absence of activity: *jeevan* continues hoping, thinking, desiring, acting, and undergoing results while mistaking the body for the self. The unresolved effort is epistemic and practical—the continual search for happiness without knowledge of *jeevan*, coexistence, and humane conduct.
...
Time is the duration of activity. It is reckoned from recurrent activities and is not an independently acting container alongside Omnipresence and units. Omnipresence, being without transformation, is not temporal in the sense in which unit-activity is measured. Units and their configurations act and change; time is recognised through the duration of those activities.

Omnipresence is called supreme cause in the sustaining sense: no activity exists apart from nature saturated in it. It is not an efficient agent that initiates particular transformations. The causal work of composition, decomposition, development, and conduct belongs to units in mutuality. This distinction prevents “ground” from being read as an external creator or intervening ruler.

### 1.7 Jeevan: structure and faculties

*Jeevan* is the constitutionally complete sentient atom. It is distinct from the physical body and is expressed through an appropriate body in the animal and human orders. In the human joint form, *jeevan* is the knower and the body is its medium. The body supplies sense organs, brain, and capacities for physical expression; *jeevan* supplies hope, thought, desire, resolve, enlightenment, authenticity, and realisation. These two contributions must not be collapsed: a bodily limitation restricts expression through that body, whereas delusion concerns how *jeevan* identifies, understands, and organises its own activity.

The primary texts describe five inseparable strengths or faculties in *jeevan*. Atma is the nucleus; buddhi, chitta, vritti, and mun are associated with the first through fourth orbits. Each has a power in projection and a corresponding activity in reflection.
...
Study proceeds inward by the reflection circuit. Truth in the form of coexistence is accepted in *mun*, qualitatively deliberated in *vritti*, directly recognised in *chitta*, and enlightened in *buddhi*. Buddhi's accordance with atma culminates in realisation. Projection then expresses realisation through authenticity, enlightenment, resolve, contemplation, deliberation, taste, and selection as conduct. Reflection is the ascent of understanding; projection is the descent of evidence.
...
The human body supplies the developed medium required for the full circuit, but bodily provision does not itself produce awakening. In deluded human living, *jeevan* identifies itself with the body and organises only four and a half activities effectively around bodily sensitivity: selection, taste, analysis, visualisation, and half of deliberation, limited chiefly to pleasant–unpleasant, healthy–unhealthy, and profit–loss. The remaining activities are not absent from *jeevan*; they lack the content and coherent direction of understanding in conduct. The human recognises and fulfils sensory aims without joining them to complete knowing and believing.

Awakening is staged by the direction from which the faculties are regulated. In the partially awakened condition, mun and vritti are driven by chitta. In the half-awakened condition, mun, vritti, and chitta are guided by buddhi, while resolve remains without self-realisation. In awakening, atma regulates and disciplines buddhi, chitta, vritti, and mun; knowing, believing, recognising, and fulfilling become one coherent activity. Study supplies the content of understanding, while practice evidences and stabilises that understanding in behaviour. Practice does not manufacture dormant faculties; projection, reflection, study, practice, and karma describe how the activities already present in *jeevan* become coherently effective and publicly evident.

### 1.7.1 Karma: desire, activity, and result

Effort–motion–result is the structure of activity throughout nature. In the sentient unit it is expressed through projection and reflection. When the human intends and acts through the body, the same structure is studied as desire, karma, and result.

KD states that activity together with aspiration is karma, and motion together with awareness is complete activity. Every karma has a result. Five limbs are contained in karma: doer, cause, objective, result, and effect. Their distinction allows an action to be evaluated without confusing the actor, motive, intended aim, attained result, and wider consequence. The balance of desire, karma, and result is accomplishment of the desire.

Karma is therefore not an external ledger added to coexistence. It is the human expression of activity under freedom of action. Deluded humans are independent while performing actions but dependent while undergoing their results. Awakened humans are independent in both because understanding precedes action and the result is accepted within resolution. Living proof requires understanding to become conduct; insight that does not regulate action has not completed the projection–reflection cycle.
...
Existential progression and the way of existence describe the order scale. Development progression and awakening progression distinguish the atomic and sentient path. At the animal-order junction, compositional progression supplies the animal body and development in the atom supplies constitutionally complete *jeevan*. In the knowledge order, the enriched human body becomes the medium for the full awakening progression.
...
Orders and planes are therefore not interchangeable. Material and pranic orders remain on the physicochemical plane. Animal-order *jeevan* is classed before awakening and operates under species-conformance through a body that cannot evidence complete understanding. This bodily limitation should not be confused with the specifically human form of delusion in which *jeevan* takes the body to be the self. The knowledge order ranges from that body-centred delusion through deific to divine planes according to awakening.

The texts further distinguish five human types: animalistic-human and demonic-human on the delusional plane; humane or discerning human as awakening becomes established; deific-human at activity completeness; and divine-human at conduct completeness. These types classify modes of human consciousness and conduct, not biological species or fixed social classes.
...
Regulation is inherent in nature saturated in Omnipresence. Omnipresence is mediative rather than directive: it is not a ruler issuing commands. In atoms, the mediative nucleus regulates generative and degenerative activities and conserves relative powers. At larger scales, units maintain definite conduct through the conformance appropriate to their order.
...
The texts connect the evaluative domains in a widening chain: law becomes evident as justice; justice as dharma; dharma as truth; truth as abundance or coexistence; and realisation in coexistence as bliss. Human behaviour is regulated through justice, thought through dharma, and realisation through truth. Evaluation therefore belongs within the ontology: it is the knowledge-order way in which coexistence is knowingly recognised and fulfilled.
...
Madhyasth Darshan makes two related but distinct claims. First, existence is perpetual. Omnipresence and units do not arise from non-being or pass into non-being; form and association change while the realities participating in change remain. “Brahma is truth, the world is perpetual” affirms both the pervasive ground and the final reality of the world.
...
At the social scale, awakened living develops from family to undivided society and universal orderliness. Five dimensions support its continuity: education–sanskar, justice–preservation, health–restraint, production–work, and exchange–storage. These are not external institutions added to an otherwise private realisation. They are the public structures through which right understanding is transmitted, relationships fulfilled, bodies supported, needs met, and social participation sustained.
...
Madhyasth Darshan presents its method as study, experiment and practice, followed by realisation and evidence in conduct. These forms of evidence should be distinguished. Logical exposition tests whether the definitions and relations form a coherent account. Study and self-examination test whether the meanings can be recognised in oneself and existence. Practice tests whether understanding can regulate work and behaviour. Conduct-evidence tests whether relationships, values, mutual satisfaction, resolution, and participation become publicly evident.
...
Brahman at *paramartha* is *nirguna* — pure, actionless awareness. Ishvara (*saguna* Brahman) is Brahman associated with Maya and taught as the intelligent and material cause of name-form manifestation, not a creator *ex nihilo*. Ishvara and *jiva* are not two absolutes alongside Brahman. Their distinction is valid within *vyavahara* and is resolved, rather than annihilated as two independently existing things, when non-dual identity is known (VC, v. 244).
...
Nor is *satta* a physical field. Dynamical fields carry energy-momentum, interact, and vary; *satta* is described as formless, actionless, and non-transforming (§1.2). A quantum vacuum is a physical state with determinate structure and observable consequences, not an equivalent of Omnipresence. Physical analogies can clarify contrasts but cannot supply the missing identity.
...
| *Dharma* (unit innateness) | What is inseparable from a unit and fulfilled through its order: existence in every unit, with growth, hope to live, and happiness cumulatively stated in higher orders. Distinct from the human *dharma–adharma* evaluative perspective (§1.12). |
...
| Supreme cause (*mahakaran*) | *Satta* as the non-transforming sustaining condition of all unit-activity — not an efficient maker, planner, or material that becomes the units (§1.6.4; §5.4). |
...
- **Paribhasha** — Nagraj, A. [*Paribhasha Samhita*](https://www.madhyasth.org/browse-texts/browse-topics/definitions). Hindi, ed. 2008. English selection of definitions at madhyasth.org. Cited: Standpoint; §1.5 (*niyati-kram*, *niyati-vidhi*).
...
- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (*Resolution Centred Materialism*)](../References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta. Cited: §3 (pp. 48, 8, 44).
...
- **Whitehead 1929** — Whitehead, A. N. [*Process and Reality*](../References/Modern-Philosophy/Whitehead-1929-Process-and-Reality.pdf) (1929 ed.). Cited: §3.6.4 (pp. 28, 44).
- **Russell 1921** — Russell, B. [*The Analysis of Mind*](../References/Modern-Philosophy/Russell-1921-The-Analysis-of-Mind.pdf). Cited: §3.6.5 (Lecture I).
- **Mach 1914** — Mach, E. [*The Analysis of Sensations*](../References/Modern-Philosophy/Mach-1914-The-Analysis-of-Sensations.pdf), trans. C. M. Williams and S. Waterlow. Cited: §3.6.5 (Ch. XIV).

### Physics and natural sciences (§4)

- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (*Resolution Centred Materialism*)](../References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta. Cited: §§4, 4.2 (pp. 44, 65, 251).
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](../References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf). English translation by Rakesh Gupta. Cited: §§4, 4.7 (pp. 59, 77).
- **MVD** — Nagraj, A. [*Madhyasth Darshan — Co-existentialism*](../References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: §§4.2, 4.7 (pp. 34, 195, 56–57, 324).
...
- **Carroll 2010** — Carroll, S. ["Energy Is Not Conserved."](../References/Science/Carroll-2010-Energy-Is-Not-Conserved.html) *Preposterous Universe* (blog), 2010. Cited: §4.3 (energy conservation in GR).
...
- **Limanowski and Blankenburg 2013** — Limanowski, J., and Blankenburg, F. ["Minimal self-models and the free energy principle."](../References/Modern-Philosophy/Limanowski-Blankenburg-2013-Minimal-Self-Models-Free-Energy-Principle.pdf) *Frontiers in Human Neuroscience*, 7. Cited: §4.5.
...
- **MVD** — Nagraj, A. [*Madhyasth Darshan — Co-existentialism*](../References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: §§5.3.2, 5.3.5, 5.7 (pp. 13, 88, 115, 12, 49–50).
...
- **MVD** — Nagraj, A. [*Madhyasth Darshan — Co-existentialism*](../References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: §§6.2.1–6.2.3, 6.3 (*The Alternative*; pp. 88, 91, 115, 288–289).
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](../References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf). English translation by Rakesh Gupta. Cited: §6.2.2 (pp. 20, 54).
...
- **MVD** — Nagraj, A. [*Madhyasth Darshan — Co-existentialism*](../References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English translation by Rakesh Gupta. Cited: §7 (*Brahma is truth, the world is perpetual*, p. 13).
