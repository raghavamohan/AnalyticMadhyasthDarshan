...
3. Every unit is **saturated** in the medium — pervasive co-location in which inherent energy and regulation belong to the unit through saturation (soaked, surrounded, submerged); not physical drawing from *O*. No unit exists, or can be separated out, independently.
...
7. Units whose needs and surpluses are complementary **compose** into a larger unit. The larger unit is itself a unit (clause 2 applies to it), so composition iterates: particles → atoms → molecules → structures; cells → organs → organisms; individuals → families → communities → universal order. **Composition is not development** ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §1.5): larger assemblies do not exceed constituent *-ness*, and ontological order plateaus cross only at constitutional completeness (*gathanpurnata*), not by mere enlargement.
...
Compound assemblies inherit a new sig(·) at each tier (D8); the four-aspect template iterates with every genuine new unit ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §1.5).
...
| Order | Capabilities | Regulation regime |
|-------|--------------|-------------------|
| Material | recognising, fulfilling | constitution-conformance (*rachna/gathan*) |
| Biological | + selection (of nutrients, season) | seed-conformance (*beej*) |
| Animal | + sensation, hope (living instinct) | species/lineage-conformance (*vansh*) |
| Knowledge | + knowing, believing, evaluation, choice | *sanskar*-conformance (achieved, not given) |
...
Only compound-mode composition creates a new tier of the hierarchy; mixture and large assemblies alone do not substitute for order transition — composition is not development (SB pp. 75–76; [What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §1.5). **Development Progression** (*vikas-kram*) in the atom is the canonical compound path to constitutional completeness (*gathanpurnata*) — hungry and overfull atoms bonding until a sentient threshold is reached (MVD p. 8; SB pp. 55, 59). **Awakening Progression** (*jagriti-kram*) runs in *jeevan* already constitutionally complete toward activity and conduct completeness (MVD pp. 13–14, 27) — a distinct progression, not to be conflated with κ at the material tier ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §§1.5, 1.8–1.9).
...
**A1 (Saturation).** Every unit is saturated in O — pervasive co-location: "all of nature is submerged, soaked, and surrounded by Omnipotence" (JV p. 3; MVD p. 32). Moreover this relation is constitutive and non-detachable: **"There is no provision in existence to separate units of nature from Omnipresence"** (JV p. 18). Saturation names the **first ontological relation** — between the medium O and every unit — distinct from unit-to-unit relationships in R (D3; [What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §§1.2–1.3). Through saturation each unit has **inherent energy** due to being saturated (SB p. 69); uniform energy at O and unit-activity manifest together — mutual dependence for manifestation, not one-way physical supply (SB pp. 49, 62). Saturation is not physical extraction or depletion of O.

**A2 (Energisation and regulation).** Inherent energy and regulatory order in a unit are **of** the saturated unit because of A1 — read from surrounded, submerged, and soaked co-location (SB p. 57), not piped in from outside. The texts also state: "At the fundamental level, every entity is protected, regulated, and energised by Omnipotence" (JV p. 82); "Omnipotence is mediative, therefore the nature saturated in it is regulated and conserved. The nucleus within every atom is the mediative activity, whereby the atom's generative-degenerative activities and relative powers are regulated and conserved" (MVD p. 26). Permeative, transparent *gyan* as *satta* grounds inherent orderliness in every saturated unit as intelligibility-ground, not cognition by Omnipresence (MVD p. 11); at constitutional completeness (*gathanpurnata*), stable atom-configuration expresses ever-present *gyan* as active sentience (*chaitanya*) — the Saturation-Reflector threshold ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §§1.3, 6.6).

**A3 (Conservation / stability of existence).** Existence is **beginless** and stable: "Existence neither increases nor decreases" (JV p. 127); "existence is stable, the development and awakening are definite, and all the laws are natural and inherent to being and abiding" (MVD p. 5). What exists is only transformed; units compose, decompose, and develop — never created from absolute non-existence (*abhava*) or annihilated ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §1.10).
