...
Compound assemblies inherit a new sig(·) at each tier (D8); the four-aspect template iterates with every genuine new unit ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §1.5).
...
2. **Law-as-regulation:** regulation becomes evident as law; every unit has provision to recognise others **based on law** (SB p. 57) — **universal across all orders** ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §§1.4.1–1.4.2).
...
Above D2b, the knowledge order adds **justice** (D7): the complete operation recognise → fulfil → evaluate → mutual satisfaction — not a member of *V*. Ontological prose: [The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §1.4.2.

Orderliness (*vyavastha*) at the order level is **self-regulation** (*swatah-saspurt*): inherent in co-existing orders, not dispensed by *O* acting as governor ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §1.3.1). Full exposition: §§1.3.1–1.4.2.
...
Only compound-mode composition creates a new tier of the hierarchy; mixture and large assemblies alone do not substitute for order transition — composition is not development (SB pp. 75–76; [The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §1.5). **Development Progression** (*vikas-kram*) in the atom is the canonical compound path to constitutional completeness (*gathanpurnata*) — hungry and overfull atoms bonding until a sentient threshold is reached (MVD p. 8; SB pp. 55, 59). **Awakening Progression** (*jagriti-kram*) runs in *jeevan* already constitutionally complete toward activity and conduct completeness (MVD pp. 13–14, 27) — a distinct progression, not to be conflated with κ at the material tier ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §§1.5, 1.8–1.9).
