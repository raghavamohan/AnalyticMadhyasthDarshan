...
- [*The Ontology of Coexistence*](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) — ontological exposition: coexistence, saturation, **regulation ladder** (§§1.7, 1.10.1, 1.13), **law vs justice** (§1.10.1), *jeevan* structure and inward regulation (§§1.9, 1.10.2), *kosha* mapping (§§1.9–1.10), unit signature, unit relationships, **six-fold value taxonomy** (§1.6), fulfilment by order (§1.6.1), *niyati-kram* and *niyati-vidhi* (§§1.5, 1.7), four orders and planes, capacity triad, composition ladder, four progressions (§1.10), six *drishti* (§1.10.1), conservation (§1.12), four human goals and *akhand samaj* (§1.13), Saturation-Reflector Model (§§1.2, 1.10, 6.6); *sapëkshata* deferred to [Knowledge, Knower, and Known](../Knowledge-Knower-And-Known/Knowledge-Knower-And-Known.pdf) §1.4.1
