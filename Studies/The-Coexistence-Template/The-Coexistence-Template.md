...
**Edited on:** July 3, 2026, 7:41 AM IST
**Status:** Released
...
6. Every unit **recognises** its relationships and **fulfils** them through **capacity** (*kshamata*), **ability** (*yogyata*), and **receptivity** (*patrata*) at the level of its order. Fulfilment executes through the unit's activity itself — an inseparable run of **effort, motion, and result** (*shram–gati–parinam*); what the relationship's other party receives is the result end of that run. The content delivered in fulfilment is **value** (*mulya*) — essentiality (*maulikta*): the unit's participation-as-usefulness in mutuality.
...
**D5a (Fulfilment capacity).** Fulfilment is modulated by the **intellectual means** (*bauddhik sadhan*): **capacity** (*kshamata*), **ability** (*yogyata*), and **receptivity** (*patrata*) (MVD p. 62). Write **cap(u) = ⟨ksh, yog, pat⟩**. φ is realised at the level cap(u) permits — not by receptivity alone. In the material order, **ascending** (*agreshan*) is balance and receptivity gained while converting capacity and ability into effort (*shram*); **frustration** (*kshobh*) is the shortcoming in that conversion — "incompleteness of receptivity" (MVD p. 79). In the knowledge order, cap(u) for worldview arises from environment, study, and prior *sanskar* (MVD p. 134); extent of receptivity constitutes qualification (*arhta*), which yields perspective (*drishti*) and worldview (*darshan*) (MVD p. 142). Attaining suitable cap(u) for realisation of pre-existing coexistence is the pinnacle of awakening (MVD p. 302). The conversion this clause describes is the first arrow of the activity triad (D5b): cap(u) gates the passage into *shram*, and *kshobh* is defined precisely there as a run stalled before its result. See [The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §§1.4, 1.9.

**D5b (Activity triad).** Every unit's activity (D1) carries an inseparable triad — **effort** (*shram*), **motion** (*gati*), and **result** (*parinam*): "every activity has an inseparable presence of effort, motion, and result" (SB p. 71); MVD opens with the same triad as the constitution of activity (MVD p. 11). The triad is the intra-unit grammar that the template's relational operations presuppose. cap(u) guards its first arrow: D5a's ascending (*agreshan*) is capacity and ability converting into *shram*, and frustration (*kshobh*) is now definable precisely — a run that stalls between effort and result. Fulfilment φ (D5) names the value-delivering *parinam* of a completed run: what the relationship's other party receives, while the run itself is internal to the unit. Each moment of the triad has completeness as its goal:
...
In the sentient atom the three completeness stages (D11) are the triad's moments fulfilled: "Conduct completeness is in the form of destination of motion. Activity completeness is in the form of restfulness of effort. Constitutional completeness (the jeevan atom) is in the form of immortality of result" (SB p. 58). *Kaal* (time) is the duration of a run — the temporal reading is developed in [Nature of Time](../Nature-Of-Time/Nature-Of-Time.pdf) §1.1 and not formalised here.
...
The three stages are the fulfilled moments of the activity triad (D5b): constitutional completeness as immortality of result, activity completeness as restfulness of effort, conduct completeness as destination of motion (SB p. 58). T1 is irreversible at the atomic level (SB p. 92); T2 and T3 are awakening milestones within constitutionally complete *jeevan* in the knowledge order. Plane membership for humans can change with study and realization; the sentience threshold at the pranic→animal junction itself does not lapse (SB p. 55). At T3, conduct completeness carries **evidence** (*pramanikta*) — benevolence others can recognize, not private conviction alone ([The Ontology of Coexistence](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §1.10).
...
| Activity triad (D5b) | definite runs; excitation still complementary | definite runs | definite runs | runs route through understanding; stalls (*kshobh*) and delusion-driven misdirection possible |
...
### Activity triad beneath fulfilment

The informal reading — and this template until D5b was added — compressed each unit's activity into its endpoint: φ as delivered value. The texts keep the whole run in view: every activity is an inseparable presence of effort, motion, and result (SB p. 71), each moment goal-directed toward completeness (SB p. 58). Restoring the run pays in three places. Frustration (*kshobh*) becomes a located failure — a run stalled between effort and result — rather than an unanalysed shortfall; the D11 completeness stages recover their engine, since the texts index them to the triad's three moments; and the natural/excited distinction (D9) acquires process content — the excited state is effort not terminating in a stabilising result. The triad is intra-unit grammar, so it does not disturb the template's relational clauses; it names what those clauses presuppose whenever a unit acts at all.
...
6. **Independence of the clauses is asserted, not proven.** Nothing here shows that D1–D13 and L1–L7 are mutually irreducible — that no definition or law is derivable from the others. The remedy is an independence audit (a derivation or a countermodel per clause), together with a classification of each named operator as a conservative name or a substantive axiom; [*Category Theory Explained*](../Category-Theory-Explained/Category-Theory-Explained.pdf) §6.16.4 states that programme, prompted by the topos-theoretic formalisation compared in §7. D5b, added under that discipline as a substantive clause warranted by SB pp. 58, 71 and MVD p. 11, falls within the audit's scope like every other clause.
...
- **JV** — Nagraj, A. [*Jeevan Vidya: An Introduction*](../References/Madhyasth-Darshan/JV-Jeevan-Vidya-An-Introduction.pdf) (*jv-parichaya*). English translation, version 3.0. Cited: order conformity and definite conduct (pp. 48, 113); protected, regulated, energised at fundamental level (p. 82). Page numbers refer to this edition.
- **MVD** — Nagraj, A. [*Madhyasth Darshan (Manav Vyavahar Darshan)*](../References/Madhyasth-Darshan/MVD-Madhyasth-Darshan-Coexistentialism.pdf). English version 4.0. Cited: Realisation Knowledge and Effort–Motion–Result (p. 11); evidence chain and "Believe what is known" (p. 12); mediative Omnipotence, regulated conserved nature, mediative nucleus (p. 26); composite atoms, mixture and compound (p. 42); hungry/overfull atoms (p. 8); relationship vs association, *sadhan*, capacity–ability–receptivity (pp. 61–62); ascending/frustration (p. 79); Development and Awakening Progression (pp. 13–14, 27); inward regulation of *jeevan* energies, *atma* as mediative regulator (pp. 77, 277); knowledge unfolding by awakened humans (pp. 115–116, 289); realisation in coexistence (p. 116); *patrata*–*drishti*–*darshan* and cap(u) for worldview (pp. 134, 142, 302); samadhi-samyama warrant (p. 7). Page numbers refer to this edition; chapter numbers given where the edition marks them.
- **SB** — Nagraj, A. [*Samadhanatmak Bhautikvad* (Resolution Centred Materialism)](../References/Madhyasth-Darshan/SB-Samadhanatmak-Bhautikvad.pdf). English translation by Rakesh Gupta. Also at https://www.youtube.com/playlist?list=PL69PCoz1OQW0dhshZ0Xv3KtZ7ajJOIpgv (bilingual Hindi and English). Cited: natural and excited state (p. 14); essentiality as value (p. 50); regulation as law, mutual recognition provision (p. 57); effort–motion–result and the completeness reading of the triad (pp. 58, 71); planes and completeness transitions (pp. 51–52, 92); constitutional completeness (pp. 55, 59); law of orderliness with *ness* and order conformance regimes (p. 236). Page numbers refer to this edition.
