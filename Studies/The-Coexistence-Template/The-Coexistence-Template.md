...
Only compound-mode composition creates a new tier of the hierarchy. **Development Progression** (*vikas-kram*) in the atom is the canonical compound path to constitutional completeness (*gathanpurnata*) — hungry and overfull atoms bonding until a sentient threshold is reached (MVD p. 8; SB pp. 55, 59). **Awakening Progression** (*jagriti-kram*) runs in *jeevan* already constitutionally complete toward activity and conduct completeness (MVD pp. 13–14, 27) — a distinct progression, not to be conflated with κ at the material tier ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §§1.5, 1.8–1.9).
...
**A2 (Energisation and regulation).** Inherent energy and regulatory order in a unit are **of** the saturated unit because of A1 — read from surrounded, submerged, and soaked co-location (SB p. 57), not piped in from outside. The texts also state: "At the fundamental level, every entity is protected, regulated, and energised by Omnipotence" (JV p. 82); "Omnipotence is mediative, therefore the nature saturated in it is regulated and conserved. The nucleus within every atom is the mediative activity, whereby the atom's generative-degenerative activities and relative powers are regulated and conserved" (MVD p. 26). Permeative, transparent *gyan* grounds inherent orderliness in every saturated unit (MVD p. 11); at constitutional completeness (*gathanpurnata*), stable atom-configuration expresses ever-present *gyan* as active sentience — the Saturation-Reflector threshold ([What Is Existence?](../What-Is-Existence/What-Is-Existence.pdf) §§1.3, 6.6).
