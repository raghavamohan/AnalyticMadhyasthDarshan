...
A durable organisation thus needs a **shared cause** (why we exist), **shared goal** (what we are for), and **shared programme** (how we live it daily) — the very condition the texts state for deliberate, knowledge-order assemblies (MVD, p. 55). The binding is not contract or command but duty and dedication: "The fulfilment of sociality is through duty and dedication ... Otherwise, its decline occurs" (MVD, Ch. 4). The glue is **trust**:
...
3. **Evidence in behaviour.** The decisive test is conduct: fulfilment of values in relationships, right-use of resources, production beyond need. An understanding that changes nothing in behaviour is, on this view, not yet understanding. This is the template's **self-evidencing closure**: realisation counts as complete knowledge only when it is evidenced in conduct and made transmissible, never as private conviction alone (MVD, p. 12; [*The Ontology of Coexistence*](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) §1.11.2).
...
- [*The Ontology of Coexistence*](../The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) — the ontological base: units, saturation, the four orders, regulation and law, the justice cycle, and societal fulfilment outcomes. Cited: §§1.1, 1.5–1.6, 1.8, 1.11.2, 1.13–1.15; and §2, §5.7 for the Advaita comparison.
