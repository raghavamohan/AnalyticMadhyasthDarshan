...
| [Why-Humans-Are-Not-Just-Material.pdf](../Studies/Why-Humans-Are-Not-Just-Material/Why-Humans-Are-Not-Just-Material.pdf) | MVD, SB, JV; Advaita (BU, TU, MU, CU, KU, BG, BSB, VC, DDV); science and modern philosophy (26 entries: 3 existing reference archives, 23 external; neural intervention, covert consciousness, sleep, infant and animal research, and arguments about experience; [external sources](NOT-DOWNLOADED.md#human-sentience-and-consciousness--external-only)) |
