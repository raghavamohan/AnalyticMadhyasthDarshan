...
| [The-Epistemology-of-Coexistence.pdf](../Studies/The-Epistemology-of-Coexistence/The-Epistemology-of-Coexistence.pdf) | MVD, SB, JV, KD; YAT (external); Advaita (BG, BU, BSB, CU, DDV, MU, TU, VC in R2; VP external); modern science/philosophy (27 works, 8 local / 19 external) |
...
| [The-Ontology-of-Coexistence.pdf](../Studies/The-Ontology-of-Coexistence/The-Ontology-of-Coexistence.pdf) | MVD, SB, JV, AVD, KD; MAD, PS, YAT (external); Advaita (CU, TU, MU, BG, VC, DDV, BSB/BS); primary comparisons (Aquinas, Spinoza, Leibniz, Whitehead, Russell, Mach, Berkeley, Samkhya Karika); modern philosophy and science, including personal identity, cosmology, conservation, entropy, and consciousness research. The complete tag list is in [MANIFEST.md](MANIFEST.md); added external works and corrected primary-text locations are in [the ontology comparison inventory](NOT-DOWNLOADED.md#ontology-comparison--external-only). |
| [Why-Humans-Are-Not-Just-Material.pdf](../Studies/Why-Humans-Are-Not-Just-Material/Why-Humans-Are-Not-Just-Material.pdf) | MVD, SB, JV; Advaita (BU, TU, MU, CU, KU, BG, BSB, VC, DDV); science and modern philosophy (28 entries: 3 existing reference archives, 25 external; neural intervention, covert consciousness, sleep, infant and animal research, shared-resource governance, and arguments about experience; [external sources](NOT-DOWNLOADED.md#human-sentience-and-consciousness--external-only)) |
...
| **MAD** | [Manav Abhyas Darshan — Hindi reader](https://db.madhyasth.org/books/read/144/) | External primary text; cited by displayed page in the 222-page native reader. No local mirror; see [NOT-DOWNLOADED.md](NOT-DOWNLOADED.md). |
| **PS** | [Paribhasha Samhita — official publications](https://originals.madhyasth.org/granth/published) · [source collection](https://u.pcloud.link/publink/show?code=kZ6Gm05ZfUbbDBW8fKmKB9ejvrO6cSRnRRH7) | External Hindi primary text; third edition 2012, printed 14 January 2016. File `15_paribhasha_sanhita_2015_ocr.pdf`, 234 pages; printed page + 8 = PDF position. No repository mirror; see [NOT-DOWNLOADED.md](NOT-DOWNLOADED.md). |
| **YAT** | [Yatharthata, Vastavikta, Satyata](https://originals.madhyasth.org/avdharna/yatharth) | Official Hindi excerpt compilation attributed on the page to *Paribhasha Sanhita* and other writings; cited by heading in The-Epistemology-of-Coexistence and The-Ontology-of-Coexistence. External webpage, with no local mirror; see [NOT-DOWNLOADED.md](NOT-DOWNLOADED.md). |
