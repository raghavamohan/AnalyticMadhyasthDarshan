...
Consistency pass 2026-07-10: ***क्षमता / योग्यता / पात्रता* triad = "capacity, ability, and receptivity"** (MD-Mapping/MVD), replacing mixed "fitness/competence/merit" and "worthiness" in the general triad (foreword + KD 1–2). ***पात्रता* = "worthiness"** is kept only for the KD 3.10 compassion/grace/mercy technical contrast.
