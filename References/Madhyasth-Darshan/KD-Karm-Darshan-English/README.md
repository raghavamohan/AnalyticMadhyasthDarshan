...
| 3.9–3.10 Measure; property, essential nature, dharma | 88–102 |
...
**Source-image review ledger.** `KD-Source-Image-Review-Ledger.md` records the pages compared sentence by sentence with rendered Hindi source images and the scope boundary of that review. The latest high-density pass covered the measure, property, strength–power, projection–reflection, electricity, distance, and time passages, and restored the realisation-based faculty sequence on printed p.63. The ledger deliberately distinguishes the corpus-wide editorial pass from direct second-review coverage of individual source pages.
...
**Additional terminology decisions (2026-08-23).** मात्रा is **measure**, while राशि remains **quantity** and मात्रात्मक remains **quantitative**. आवेश / आवेशित are **excitation / excited**; the battery passage on KD p.124 retains **charge / charged** because the Hindi source itself uses the loanword चार्ज. अनुभूति is **experiencing**, distinct from अनुभव = **realisation**: अनुभूति belongs to the lower-faculty / *chitta* level, while अनुभव is established in *atma*. अर्थ is rendered contextually as **wealth**, **resources**, or **meaning**. **Lust** is acceptable for an unambiguous काम usage, but every current KD occurrence is within the classical moksha–dharma–kama–artha life-aim listing, where that wording would be too narrow; those occurrences therefore remain ***kama*** under the conflict rule. विन्यास and the कासा / आकूति / मेधा triad remain unresolved, as does the unglossed ता-त्रय; their current transliterations or contextual glosses are retained without treating them as precedents.
...
Chapter 1 (Karma) carries several additional contextual decisions. ***संस्कार* remains transliterated as "*sanskar*"**, distinct from ***संस्कृति* = "culture"***; ***अभीष्ट* = "desire"**; ***साध्य* = "aim"**; ***कायिक* = "physical"**; and ***कृत, कारित, अनुमोदित* = "done, caused, intended"**. ***अनुभूति* = "experiencing"** remains distinct from ***अनुभव* = "realisation"**; contextual ***अर्थ* = "wealth/resources/meaning"**; and the classical life-aim usage of काम remains ***kama*** because "lust" would be narrower there. The कासा / आकूति / मेधा renderings remain deferred. See `KD-Glossary-Additions.md` for the full reasoning on each.
