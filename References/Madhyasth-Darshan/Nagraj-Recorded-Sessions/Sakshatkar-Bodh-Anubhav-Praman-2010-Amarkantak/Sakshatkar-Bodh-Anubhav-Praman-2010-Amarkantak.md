...
| 18:20–44:32 | Batched pipeline, VAD-segmented | Longer merged segments. **Measured 2026-08-02 to drop ~17% of words**, biased toward the emphasis-flanked statements that carry doctrine — VAD cuts at pauses. A sequential re-run of this span is in progress; treat conclusions drawn from it as provisional until replaced |
