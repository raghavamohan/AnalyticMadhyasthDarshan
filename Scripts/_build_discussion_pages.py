...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .discuss-toolbar-feedback {{
    font-size: 12px;
    font-weight: 600;
    white-space: nowrap;
  }}
  .discuss-toolbar-download {{
    min-width: 0;
    text-align: right;
  }}
  ...
  .discuss-toolbar-link {{
    color: #1a5276;
    text-decoration: none;
    font-weight: 600;
  }}
  .discuss-toolbar-link:hover {{ color: #13405c; }}
  .discuss-toolbar-link:focus-visible {{
    outline: 2px solid #1a5276;
    outline-offset: 2px;
  }}
  .discuss-toolbar-download::after {{
    content: " \\2193";
    font-weight: 700;
  }}
  .discuss-header-note {{
